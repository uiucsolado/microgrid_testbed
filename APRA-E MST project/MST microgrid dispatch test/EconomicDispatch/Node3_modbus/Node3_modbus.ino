...
OLocalVertex s = OLocalVertex(0x4151C692,3); //address and ID                                                                       //change2
...
byte mac[] = {0x90, 0xA2, 0xDA, 0x0E, 0x94, 0xB3 };                                                                                      //change1
IPAddress ip(192, 168, 2, 3); // What are these addresses                                                                                //change1
