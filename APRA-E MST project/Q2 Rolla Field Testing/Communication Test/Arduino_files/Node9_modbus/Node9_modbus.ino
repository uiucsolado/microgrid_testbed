...
//      int node9_ip = 69; //part of ip address for node 9 on the HIL side
      int node9_ip = 181; //part of ip address for node 9 on the HIL side
      Mb.Req(MB_FC_READ_REGISTERS,40083,4,0,node9_ip); //(MB_FC FC, word Ref - typhoon, word Count, word Pos -arduino, int nodeip)
      Mb.MbmRun();
      int x =  Mb.MbData[0];
      int y  = Mb.MbData[1];
