...
//      int node10_ip = 69; //part of ip address for node 9 on the HIL side
      int node10_ip = 181; //part of ip address for node 9 on the HIL side
      Mb.Req(MB_FC_READ_REGISTERS,40004,2,0,node10_ip); //(MB_FC FC, word Ref - typhoon, word Count, word Pos -arduino, int nodeip)
//      Mb.MbmRun();
      int x =  Mb.MbData[0];
      int y  = Mb.MbData[1];
//      int power = float(Mb.MbData[0])/float(Mb.MbData[1]);
...
//      Mb.Req(MB_FC_READ_REGISTERS,40232,5,0,node10_ip); //(MB_FC FC, word Ref - typhoon, word Count, word Pos -arduino, int nodeip)
//      Mb.MbmRun();
//      Serial.print("Power reduction settings: ");
//      Serial.print("WMaxLimPct is: ");
//      Serial.println(Mb.MbData[0]);
//      Serial.print("WMaxLimPct_WinTms is: ");
//      Serial.println(Mb.MbData[1]);
//      Serial.print("WMaxLimPct_RvrtTms is: ");
//      Serial.println(Mb.MbData[2]);
//      Serial.print("WMaxLimPct_RmpTms is: ");
//      Serial.println(Mb.MbData[3]);
//      Serial.print("WMaxLim_Ena is: ");
//      Serial.println(Mb.MbData[4]);
//      
//      Mb.MbData[0] = 50; Mb.MbData[1]=0;Mb.MbData[2]=0;Mb.MbData[3]=0;Mb.MbData[4] = 1;
//      Mb.Req(MB_FC_WRITE_MULTIPLE_REGISTERS,40232,5,0,node10_ip); //(MB_FC FC, word Ref - typhoon, word Count, word Pos - arduino, int nodeip)
//      Mb.MbmRun();
...
{
  int node10_ip = 70; //part of ip address for node 10 on the HIL side 
  Mb.Req(MB_FC_READ_INPUT_REGISTER,0,8,0,node10_ip); //(MB_FC FC, word Ref, word Count, word Pos, int nodeip)
  Mb.MbmRun();
}
