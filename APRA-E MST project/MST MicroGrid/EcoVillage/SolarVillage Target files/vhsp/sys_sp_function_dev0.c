...
void TimerCounterHandler_0_sys_sp_cpu_dev0() {
    ...
    _microgrid_inverter_vrms_vinst_va1__out = (HIL_InFloat(0xc80000 + 0x205));
    // Generated from the component: Microgrid.Measurement.Vrms.Vinst.Va1
    _microgrid_measurement_vrms_vinst_va1__out = (HIL_InFloat(0xc80000 + 0x207));
...
void TimerCounterHandler_1_sys_sp_cpu_dev0() {
    ...
    HIL_OutAO(0x4001, _microgrid_inverter_vrms_rms_calc_slow__var_rms);
    // Generated from the component: Microgrid.Inverter.Vrms.sys2
    // Generated from the component: Microgrid.Measurement.Vrms.rms
    HIL_OutAO(0x4002, _microgrid_measurement_vrms_rms_calc_slow__var_rms);
