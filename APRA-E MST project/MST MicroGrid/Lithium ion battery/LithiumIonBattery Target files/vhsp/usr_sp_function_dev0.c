...
double _microgrid_battery_gain1__out;
double _microgrid_battery_idc_ia1__out;
...
double _microgrid_battery_cq_lut__value;
double _microgrid_battery_cq_lut__lut_addrs[5] = { 278.15, 285.65, 293.15, 300.65, 308.15 };
...
void TimerCounterHandler_0_user_sp_cpu_dev0() {
    ...
    _microgrid_battery_c_function__Vdc = _microgrid_battery_c_function__Em_cell * 200.0;
    _microgrid_battery_c_function__SOC = _microgrid_battery_c_function__SOC + (_microgrid_battery_c_function__Idc / _microgrid_battery_c_function__Cq) * 2e-05 / 3600.0;
    _microgrid_battery_c_function__R0 = _microgrid_battery_c_function__R0_cell * 200.0;
    _microgrid_battery_c_function__R1 = _microgrid_battery_c_function__R1_cell * 200.0;
    _microgrid_battery_c_function__C1 = _microgrid_battery_c_function__C1_cell / 200.0;
