...
#define BASE32                             10000000  // base for transmitting decimals
#define BASE64                             1000000000  // base for transmitting decimals
...
class OAgent_ED {
	public:
        ...
        void _SendPacket(uint16_t recipientID, float* vars,uint16_t time);
        float* _getPacket();
