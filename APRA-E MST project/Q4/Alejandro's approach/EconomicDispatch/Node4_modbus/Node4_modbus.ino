...
OLocalVertex s = OLocalVertex(0x4151C48B,4); //address and ID                                                                       //change2
...
byte mac[] = {0x90, 0xA2, 0xDA, 0x0E, 0x94, 0xB4 };                                                                                      //change1
IPAddress ip(192, 168, 2, 4); // What are these addresses                                                                                //change1
