...
OLocalVertex s = OLocalVertex(0x4151C6AC,0,0,-1.5*base,0.5*base,5,base, node_id);
OGraph g = OGraph(&s);
...
boolean sent = false; //flag that rises once the node is ready to send information to the central computer
