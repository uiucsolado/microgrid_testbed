...
double _p_ref2_unit_delay1__out;
double _current_ref3_one__out = 100.0;
double _p_ref4_unit_delay1__out;
double _xi_d_ref__out;
double _pll_pll_pid_integrator2__out;
double _p_ref3_unit_delay1__out;
double _current_ref_limit_zero__out = 100.0;
double _p_ref4_regd_sys_modbus_device4_comp_holding_out__out[3];
...
double _p_ref2_regd_sys_modbus_device2_comp_holding_out__out[3];
double _pll1_pll_pid_integrator1__out;
double _p_ref1_unit_delay1__out;
...
double _p_ref3_regd_sys_modbus_device3_comp_holding_out__out[3];
double _pll3_pll_to_hz__out;
double _p_ref1_regd_sys_modbus_device1_comp_holding_out__out[3];
...
double _p_ref4_regd_sys_bus_split2__out2;
...
double _p_ref2_regd_sys_bus_split2__out2;
...
double _p_ref3_regd_sys_bus_split2__out2;
double _pll3_2pi__out;
double _p_ref1_regd_sys_bus_split3__out;
double _p_ref1_regd_sys_bus_split3__out1;
double _p_ref1_regd_sys_bus_split3__out2;
...
double _switch_in_5_minutes__var;
double _switch_in_5_minutes__step;
double _switch_in_5_minutes__in;


double _switch_in_5_minutes__out;
...
X_Int32 _p_ref1_regd_sys_c_function4__temp;
double _p_ref1_regd_sys_c_function4__high;
double _p_ref1_regd_sys_c_function4__low;


double _p_ref1_regd_sys_c_function4__regD;
...
double _p_ref4_regd_sys_c_function2__in;
double _p_ref4_regd_sys_c_function2__sign;


double _p_ref4_regd_sys_c_function2__out;
double _p_ref2_regd_sys_c_function2__in;
double _p_ref2_regd_sys_c_function2__sign;


double _p_ref2_regd_sys_c_function2__out;
double _p_ref3_regd_sys_c_function2__in;
double _p_ref3_regd_sys_c_function2__sign;


double _p_ref3_regd_sys_c_function2__out;
double _p_ref1_regd_sys_c_function2__in;
double _p_ref1_regd_sys_c_function2__sign;


double _p_ref1_regd_sys_c_function2__out;
...
double _p_ref4_regd_sys_gain1__out;
double _p_ref2_regd_sys_gain1__out;
double _p_ref3_regd_sys_gain1__out;
double _p_ref1_regd_sys_gain1__out;
...
double _p_ref4_limit_ramp_rate__var2;
double _p_ref4_limit_ramp_rate__t;
double _p_ref4_limit_ramp_rate__step;
double _p_ref4_limit_ramp_rate__in;
double _p_ref4_limit_ramp_rate__initial;
X_Int32 _p_ref4_limit_ramp_rate__regulate;


double _p_ref4_limit_ramp_rate__P_nom;
double _p_ref4_limit_ramp_rate__P_ref;
double _p_ref2_limit_ramp_rate__var;
double _p_ref2_limit_ramp_rate__var2;
double _p_ref2_limit_ramp_rate__t;
double _p_ref2_limit_ramp_rate__step;
double _p_ref2_limit_ramp_rate__in;
double _p_ref2_limit_ramp_rate__initial;
X_Int32 _p_ref2_limit_ramp_rate__regulate;


double _p_ref2_limit_ramp_rate__P_nom;
double _p_ref2_limit_ramp_rate__P_ref;
double _p_ref3_limit_ramp_rate__var;
double _p_ref3_limit_ramp_rate__var2;
double _p_ref3_limit_ramp_rate__t;
double _p_ref3_limit_ramp_rate__step;
double _p_ref3_limit_ramp_rate__in;
double _p_ref3_limit_ramp_rate__initial;
X_Int32 _p_ref3_limit_ramp_rate__regulate;


double _p_ref3_limit_ramp_rate__P_nom;
double _p_ref3_limit_ramp_rate__P_ref;
double _p_ref1_limit_ramp_rate__var;
double _p_ref1_limit_ramp_rate__var2;
double _p_ref1_limit_ramp_rate__t;
double _p_ref1_limit_ramp_rate__step;
double _p_ref1_limit_ramp_rate__in;
double _p_ref1_limit_ramp_rate__initial;
X_Int32 _p_ref1_limit_ramp_rate__regulate;


double _p_ref1_limit_ramp_rate__P_nom;
double _p_ref1_limit_ramp_rate__P_ref;
...
double _p_ref4_regd_sys_gain2__out;
double _p_ref4_sum9__out;
double _p_ref4_sum10__out;
...
double _p_ref2_sum9__out;
double _p_ref2_sum10__out;
double _p_ref2_regd_sys_gain2__out;
double _current_ref2_product3__out;
double _p_ref3_sum9__out;
double _current_ref2_product5__out;
double _p_ref3_regd_sys_gain2__out;
double _p_ref3_sum10__out;
double _p_ref1_sum10__out;
double _current_ref_product3__out;
double _current_ref_product5__out;
double _p_ref1_sum9__out;
double _p_ref1_regd_sys_gain2__out;
double _pll3_pll_pid_sum5__out;
double _pll2_pll_pid_sum5__out;
double _pll_pll_pid_sum5__out;
double _pll1_pll_pid_sum5__out;
X_Int32 _p_ref4_regd_sys_c_function5__temp;
double _p_ref4_regd_sys_c_function5__P_nom;


X_Int32 _p_ref4_regd_sys_c_function5__high;
X_Int32 _p_ref4_regd_sys_c_function5__low;
X_Int32 _p_ref4_regd_sys_c_function5__sign;
double _p_ref4_product2__out;
double _p_ref4_product1__out;
double _current_ref3_sum4__out;
double _current_ref3_sum3__out;
double _current_ref1_sum4__out;
double _current_ref1_sum3__out;
double _p_ref2_product2__out;
double _p_ref2_product1__out;
X_Int32 _p_ref2_regd_sys_c_function5__temp;
double _p_ref2_regd_sys_c_function5__P_nom;


X_Int32 _p_ref2_regd_sys_c_function5__high;
X_Int32 _p_ref2_regd_sys_c_function5__low;
X_Int32 _p_ref2_regd_sys_c_function5__sign;
double _current_ref2_sum3__out;
double _p_ref3_product2__out;
double _current_ref2_sum4__out;
X_Int32 _p_ref3_regd_sys_c_function5__temp;
double _p_ref3_regd_sys_c_function5__P_nom;


X_Int32 _p_ref3_regd_sys_c_function5__high;
X_Int32 _p_ref3_regd_sys_c_function5__low;
X_Int32 _p_ref3_regd_sys_c_function5__sign;
double _p_ref3_product1__out;
double _p_ref1_product1__out;
double _current_ref_sum3__out;
double _current_ref_sum4__out;
double _p_ref1_product2__out;
X_Int32 _p_ref1_regd_sys_c_function5__temp;
double _p_ref1_regd_sys_c_function5__P_nom;


X_Int32 _p_ref1_regd_sys_c_function5__high;
X_Int32 _p_ref1_regd_sys_c_function5__low;
X_Int32 _p_ref1_regd_sys_c_function5__sign;
...
X_Int32 _p_ref4_regd_sys_bus_join1__out[3];
double _p_ref4_signal_switch1__out;
...
double _p_ref2_signal_switch1__out;
X_Int32 _p_ref2_regd_sys_bus_join1__out[3];
double _current_ref2_product1__out;
double _current_ref2_product2__out;
X_Int32 _p_ref3_regd_sys_bus_join1__out[3];
double _p_ref3_signal_switch1__out;
double _current_ref_product1__out;
double _current_ref_product2__out;
double _p_ref1_signal_switch1__out;
X_Int32 _p_ref1_regd_sys_bus_join1__out[3];
...
X_UnInt32 _three_phase_inverter4_igbt_leg3_pwm_modulator__channels[1] = {3};
...
X_UnInt32 _three_phase_inverter4_igbt_leg2_pwm_modulator__channels[1] = {1};
...
X_UnInt32 _three_phase_inverter2_igbt_leg3_pwm_modulator__channels[1] = {5};
...
X_UnInt32 _three_phase_inverter2_igbt_leg2_pwm_modulator__channels[1] = {7};
...
X_UnInt32 _three_phase_inverter2_igbt_leg1_pwm_modulator__channels[1] = {4};
...
X_UnInt32 _three_phase_inverter3_igbt_leg1_pwm_modulator__channels[1] = {8};
...
X_UnInt32 _three_phase_inverter3_igbt_leg3_pwm_modulator__channels[1] = {10};
...
X_UnInt32 _three_phase_inverter3_igbt_leg2_pwm_modulator__channels[1] = {9};
...
X_UnInt32 _three_phase_inverter1_igbt_leg2_pwm_modulator__channels[1] = {0};
...
X_UnInt32 _three_phase_inverter1_igbt_leg3_pwm_modulator__channels[1] = {6};
...
X_UnInt32 _three_phase_inverter1_igbt_leg1_pwm_modulator__channels[1] = {11};
...
double _p_ref2_unit_delay1__state;
double _p_ref4_unit_delay1__state;
double _pll_pll_pid_integrator2__state;
double _p_ref3_unit_delay1__state;
...
double _p_ref1_unit_delay1__state;
...
void ReInit_user_sp_cpu_dev0() {
    ...
    _p_ref2_unit_delay1__state = 3750.0;
    _p_ref4_unit_delay1__state = 2500.0;
    _pll_pll_pid_integrator2__state = 0.0;
    _p_ref3_unit_delay1__state = 2500.0;
    ...
    _p_ref1_unit_delay1__state = 2500.0;
    ...
    _p_ref4_limit_ramp_rate__var2 = 2500;
    _p_ref4_limit_ramp_rate__t = 0;
    _p_ref4_limit_ramp_rate__step = 0;
    _p_ref2_limit_ramp_rate__var = 0;
    _p_ref2_limit_ramp_rate__var2 = 3750;
    _p_ref2_limit_ramp_rate__t = 0;
    _p_ref2_limit_ramp_rate__step = 0;
    _p_ref3_limit_ramp_rate__var = 0;
    _p_ref3_limit_ramp_rate__var2 = 2500;
    _p_ref3_limit_ramp_rate__t = 0;
    _p_ref3_limit_ramp_rate__step = 0;
    _p_ref1_limit_ramp_rate__var = 0;
    _p_ref1_limit_ramp_rate__var2 = 2500;
    _p_ref1_limit_ramp_rate__t = 0;
    _p_ref1_limit_ramp_rate__step = 0;
    ...
    XIo_OutInt32(0x550001b4, 0);
    XIo_OutInt32(0x550001d0, 0);
    XIo_OutInt32(0x55000198, 0);
    ...
    _three_phase_inverter4_igbt_leg3_pwm_modulator__update_mask = 8;
    ...
    _three_phase_inverter4_igbt_leg2_pwm_modulator__update_mask = 2;
    ...
    _three_phase_inverter2_igbt_leg3_pwm_modulator__update_mask = 32;
    ...
    _three_phase_inverter2_igbt_leg2_pwm_modulator__update_mask = 128;
    ...
    _three_phase_inverter2_igbt_leg1_pwm_modulator__update_mask = 16;
    ...
    _three_phase_inverter3_igbt_leg1_pwm_modulator__update_mask = 256;
    ...
    _three_phase_inverter3_igbt_leg3_pwm_modulator__update_mask = 1024;
    ...
    _three_phase_inverter3_igbt_leg2_pwm_modulator__update_mask = 512;
    ...
    _three_phase_inverter1_igbt_leg2_pwm_modulator__update_mask = 1;
    ...
    _three_phase_inverter1_igbt_leg3_pwm_modulator__update_mask = 64;
    ...
    _three_phase_inverter1_igbt_leg1_pwm_modulator__update_mask = 2048;
...
void TimerCounterHandler_0_user_sp_cpu_dev0() {
    ...
    _s_control_mode__out = XIo_InFloat(0x55000118);
    ...
    // Generated from the component: P_ref2.Unit Delay1
    _p_ref2_unit_delay1__out = _p_ref2_unit_delay1__state;
    // Generated from the component: Current_ref3.one
    // Generated from the component: P_ref4.Unit Delay1
    _p_ref4_unit_delay1__out = _p_ref4_unit_delay1__state;
    // Generated from the component: Xi_d_ref
    _xi_d_ref__out = XIo_InFloat(0x55000128);
    // Generated from the component: PLL.PLL.PID.Integrator2
    _pll_pll_pid_integrator2__out = _pll_pll_pid_integrator2__state;
    // Generated from the component: P_ref3.Unit Delay1
    _p_ref3_unit_delay1__out = _p_ref3_unit_delay1__state;
    ...
    _p_ref4_regd_sys_modbus_device4_comp_holding_out__out[0] = XIo_InFloat(0x5500017c);
    _p_ref4_regd_sys_modbus_device4_comp_holding_out__out[1] = XIo_InFloat(0x55000180);
    _p_ref4_regd_sys_modbus_device4_comp_holding_out__out[2] = XIo_InFloat(0x55000184);
    // Generated from the component: P_ref4.RegD_sys.ModBus Device4.comp_coil_out
    _p_ref4_regd_sys_modbus_device4_comp_coil_out__out = XIo_InFloat(0x55000178);
    // Generated from the component: P_ref1.RegD_sys.ModBus Device1.comp_coil_out
    _p_ref1_regd_sys_modbus_device1_comp_coil_out__out = XIo_InFloat(0x55000148);
    // Generated from the component: Q_ref2
    _q_ref2__out = XIo_InFloat(0x5500010c);
    ...
    _xi_d_ref1__out = XIo_InFloat(0x5500012c);
    ...
    _q_ref4__out = XIo_InFloat(0x55000114);
    // Generated from the component: S_control_mode4
    _s_control_mode4__out = XIo_InFloat(0x55000124);
    ...
    _s_control_mode1__out = XIo_InFloat(0x5500011c);
    ...
    _p_ref2_regd_sys_modbus_device2_comp_holding_out__out[0] = XIo_InFloat(0x5500015c);
    _p_ref2_regd_sys_modbus_device2_comp_holding_out__out[1] = XIo_InFloat(0x55000160);
    _p_ref2_regd_sys_modbus_device2_comp_holding_out__out[2] = XIo_InFloat(0x55000164);
    // Generated from the component: PLL1.PLL.PID.Integrator1
    _pll1_pll_pid_integrator1__out = _pll1_pll_pid_integrator1__state;
    // Generated from the component: P_ref1.Unit Delay1
    _p_ref1_unit_delay1__out = _p_ref1_unit_delay1__state;
    ...
    _p_ref3_regd_sys_modbus_device3_comp_holding_out__out[0] = XIo_InFloat(0x5500016c);
    _p_ref3_regd_sys_modbus_device3_comp_holding_out__out[1] = XIo_InFloat(0x55000170);
    _p_ref3_regd_sys_modbus_device3_comp_holding_out__out[2] = XIo_InFloat(0x55000174);
    ...
    _p_ref1_regd_sys_modbus_device1_comp_holding_out__out[0] = XIo_InFloat(0x5500014c);
    _p_ref1_regd_sys_modbus_device1_comp_holding_out__out[1] = XIo_InFloat(0x55000150);
    _p_ref1_regd_sys_modbus_device1_comp_holding_out__out[2] = XIo_InFloat(0x55000154);
    // Generated from the component: Xi_q_ref4
    _xi_q_ref4__out = XIo_InFloat(0x55000144);
    // Generated from the component: C3
    // Generated from the component: C2
    // Generated from the component: S_control_mode2
    _s_control_mode2__out = XIo_InFloat(0x55000120);
    ...
    _xi_q_ref__out = XIo_InFloat(0x55000138);
    ...
    _xi_d_ref4__out = XIo_InFloat(0x55000134);
    // Generated from the component: P_ref2.RegD_sys.ModBus Device2.comp_coil_out
    _p_ref2_regd_sys_modbus_device2_comp_coil_out__out = XIo_InFloat(0x55000158);
    // Generated from the component: Xi_q_ref1
    _xi_q_ref1__out = XIo_InFloat(0x5500013c);
    // Generated from the component: Constant6
    // Generated from the component: Xi_q_ref2
    _xi_q_ref2__out = XIo_InFloat(0x55000140);
    ...
    _q_ref1__out = XIo_InFloat(0x55000108);
    ...
    HIL_OutAO(0x4058, (float)_constant7__out);
    // Generated from the component: wt_pll2
    HIL_OutAO(0x4070, (float)_pll2_pll_unit_delay1__out);
    ...
    _p_ref4_regd_sys_bus_split2__out2 = _p_ref4_regd_sys_modbus_device4_comp_holding_out__out[2];
    ...
    XIo_OutFloat(0x550001c4, _p_ref3_regd_sys_constant3__out);
    ...
    XIo_OutFloat(0x550001a8, _p_ref2_regd_sys_constant3__out);
    // Generated from the component: P_ref2.RegD_sys.ModBus Device2.comp_coil_in
    XIo_OutFloat(0x550001a4, _p_ref2_regd_sys_constant4__out);
    // Generated from the component: wt_pll
    HIL_OutAO(0x406e, (float)_pll_pll_unit_delay1__out);
    ...
    HIL_OutAO(0x406f, (float)_pll1_pll_unit_delay1__out);
    ...
    _p_ref2_regd_sys_bus_split2__out2 = _p_ref2_regd_sys_modbus_device2_comp_holding_out__out[2];
    ...
    XIo_OutFloat(0x5500018c, _p_ref1_regd_sys_constant3__out);
    ...
    XIo_OutFloat(0x550001c0, _p_ref3_regd_sys_constant4__out);
    // Generated from the component: P_ref3.RegD_sys.Termination1
    // Generated from the component: P_ref3.RegD_sys.Probe3
    HIL_OutAO(0x4036, (float)_p_ref3_regd_sys_modbus_device3_comp_holding_out__out[0]);
    HIL_OutAO(0x4037, (float)_p_ref3_regd_sys_modbus_device3_comp_holding_out__out[1]);
    HIL_OutAO(0x4038, (float)_p_ref3_regd_sys_modbus_device3_comp_holding_out__out[2]);
    ...
    _p_ref3_regd_sys_bus_split2__out2 = _p_ref3_regd_sys_modbus_device3_comp_holding_out__out[2];
    // Generated from the component: PLL3.2pi
    _pll3_2pi__out = 6.28318530718 * _pll3_pll_to_hz__out;
    // Generated from the component: P_ref1.RegD_sys.Bus Split3
    _p_ref1_regd_sys_bus_split3__out = _p_ref1_regd_sys_modbus_device1_comp_holding_out__out[0];
    _p_ref1_regd_sys_bus_split3__out1 = _p_ref1_regd_sys_modbus_device1_comp_holding_out__out[1];
    _p_ref1_regd_sys_bus_split3__out2 = _p_ref1_regd_sys_modbus_device1_comp_holding_out__out[2];
    ...
    HIL_OutAO(0x4071, (float)_pll3_pll_unit_delay1__out);
    ...
    XIo_OutFloat(0x550001dc, _p_ref4_regd_sys_constant4__out);
    // Generated from the component: P_ref1.RegD_sys.ModBus Device1.comp_coil_in
    XIo_OutFloat(0x55000188, _p_ref1_regd_sys_constant4__out);
    ...
    XIo_OutFloat(0x550001e0, _p_ref4_regd_sys_constant3__out);
    ...
    HIL_OutAO(0x404c, (float)_s_meas3_power_meter1__apparent);
    // Generated from the component: Q4
    HIL_OutAO(0x4047, (float)_s_meas3_power_meter1__Qdc);
    // Generated from the component: S_meas3.Termination1
    // Generated from the component: P4
    HIL_OutAO(0x402f, (float)_s_meas3_power_meter1__Pdc);
    // Generated from the component: S_meas3.Termination2
    // Generated from the component: pf4
    HIL_OutAO(0x406c, (float)_s_meas3_power_meter1__k_factor);
    ...
    HIL_OutAO(0x4046, (float)_s_meas2_power_meter1__Qdc);
    // Generated from the component: S_meas2.Termination1
    // Generated from the component: P3
    HIL_OutAO(0x402e, (float)_s_meas2_power_meter1__Pdc);
    // Generated from the component: pf3
    HIL_OutAO(0x406b, (float)_s_meas2_power_meter1__k_factor);
    // Generated from the component: S3
    HIL_OutAO(0x404b, (float)_s_meas2_power_meter1__apparent);
    ...
    HIL_OutAO(0x4043, (float)_s_meas_power_meter1__Qdc);
    // Generated from the component: pf1
    HIL_OutAO(0x4069, (float)_s_meas_power_meter1__k_factor);
    // Generated from the component: S_meas.Termination2
    // Generated from the component: P1
    HIL_OutAO(0x402b, (float)_s_meas_power_meter1__Pdc);
    // Generated from the component: S_meas.Termination1
    // Generated from the component: S1
    HIL_OutAO(0x4049, (float)_s_meas_power_meter1__apparent);
    ...
    HIL_OutAO(0x4048, (float)_s_meas_1_power_meter1__Qdc);
    // Generated from the component: pf_bus
    HIL_OutAO(0x406d, (float)_s_meas_1_power_meter1__k_factor);
    // Generated from the component: P_bus
    HIL_OutAO(0x4030, (float)_s_meas_1_power_meter1__Pdc);
    ...
    HIL_OutAO(0x404d, (float)_s_meas_1_power_meter1__apparent);
    // Generated from the component: switch in 5 minutes
    _switch_in_5_minutes__in = _s_meas_1_power_meter1__Pdc;
    _switch_in_5_minutes__out = _switch_in_5_minutes__var;
    ...
    HIL_OutAO(0x404a, (float)_s_meas1_power_meter1__apparent);
    // Generated from the component: S_meas1.Termination2
    // Generated from the component: pf2
    HIL_OutAO(0x406a, (float)_s_meas1_power_meter1__k_factor);
    // Generated from the component: S_meas1.Termination1
    // Generated from the component: Q2
    HIL_OutAO(0x4045, (float)_s_meas1_power_meter1__Qdc);
    // Generated from the component: P2
    HIL_OutAO(0x402d, (float)_s_meas1_power_meter1__Pdc);
    ...
    HIL_OutAO(0x4044, (float)_power_meter1__Qdc);
    ...
    HIL_OutAO(0x402c, (float)_power_meter1__Pdc);
    // Generated from the component: PLL2.Termination3
    // Generated from the component: P_ref4.RegD_sys.C function3
    _p_ref4_regd_sys_c_function3__high = _p_ref4_regd_sys_bus_split2__out1;
    _p_ref4_regd_sys_c_function3__low = _p_ref4_regd_sys_bus_split2__out2;
    ...
    XIo_OutFloat(0x550001c8, _p_ref3_regd_sys_bus_join2__out[0]);
    XIo_OutFloat(0x550001cc, _p_ref3_regd_sys_bus_join2__out[1]);
    // Generated from the component: PLL.Termination3
    // Generated from the component: P_ref4.RegD_sys.ModBus Device4.comp_holding_in
    XIo_OutFloat(0x550001e4, _p_ref4_regd_sys_bus_join2__out[0]);
    XIo_OutFloat(0x550001e8, _p_ref4_regd_sys_bus_join2__out[1]);
    // Generated from the component: PLL1.Termination3
    // Generated from the component: P_ref2.RegD_sys.C function3
    _p_ref2_regd_sys_c_function3__high = _p_ref2_regd_sys_bus_split2__out1;
    _p_ref2_regd_sys_c_function3__low = _p_ref2_regd_sys_bus_split2__out2;
    ...
    XIo_OutFloat(0x550001ac, _p_ref2_regd_sys_bus_join2__out[0]);
    XIo_OutFloat(0x550001b0, _p_ref2_regd_sys_bus_join2__out[1]);
    // Generated from the component: P_ref3.RegD_sys.C function3
    _p_ref3_regd_sys_c_function3__high = _p_ref3_regd_sys_bus_split2__out1;
    _p_ref3_regd_sys_c_function3__low = _p_ref3_regd_sys_bus_split2__out2;
    ...
    // Generated from the component: P_ref1.RegD_sys.C function4
    _p_ref1_regd_sys_c_function4__high = _p_ref1_regd_sys_bus_split3__out1;
    _p_ref1_regd_sys_c_function4__low = _p_ref1_regd_sys_bus_split3__out2;
    _p_ref1_regd_sys_c_function4__temp = (((X_Int32)_p_ref1_regd_sys_c_function4__high << 16) & -65536) | ((X_Int32)_p_ref1_regd_sys_c_function4__low & 65535);
    if (_p_ref1_regd_sys_c_function4__temp < 1e7 && _p_ref1_regd_sys_c_function4__temp > -1e7)_p_ref1_regd_sys_c_function4__regD = _p_ref1_regd_sys_c_function4__temp;
    else if (_p_ref1_regd_sys_c_function4__temp == 1e7)_p_ref1_regd_sys_c_function4__regD = 1e7;
    else if (_p_ref1_regd_sys_c_function4__temp == -1e7)_p_ref1_regd_sys_c_function4__regD = -1e7;
    else if (_p_ref1_regd_sys_c_function4__temp > 1e7)_p_ref1_regd_sys_c_function4__regD = 2e7;
    else if (_p_ref1_regd_sys_c_function4__temp < -1e7)_p_ref1_regd_sys_c_function4__regD = -2e7;
    // Generated from the component: P_ref1.RegD_sys.ModBus Device1.comp_holding_in
    XIo_OutFloat(0x55000190, _p_ref1_regd_sys_bus_join2__out[0]);
    XIo_OutFloat(0x55000194, _p_ref1_regd_sys_bus_join2__out[1]);
    ...
    HIL_OutAO(0x4068, (float)_current_abc_to_dq3_abc_to_dq1_alpha_beta_to_dq__q);
    ...
    HIL_OutAO(0x4064, (float)_current_abc_to_dq3_abc_to_dq1_alpha_beta_to_dq__d);
    ...
    HIL_OutAO(0x4067, (float)_current_abc_to_dq2_abc_to_dq1_alpha_beta_to_dq__q);
    ...
    HIL_OutAO(0x4063, (float)_current_abc_to_dq2_abc_to_dq1_alpha_beta_to_dq__d);
    ...
    HIL_OutAO(0x4065, (float)_current_abc_to_dq_abc_to_dq1_alpha_beta_to_dq__q);
    // Generated from the component: id
    HIL_OutAO(0x4061, (float)_current_abc_to_dq_abc_to_dq1_alpha_beta_to_dq__d);
    ...
    HIL_OutAO(0x403e, (float)_trigonometric_function2__out);
    // Generated from the component: Nominal Output
    HIL_OutAO(0x402a, (float)_switch_in_5_minutes__out);
    ...
    HIL_OutAO(0x4066, (float)_current_abc_to_dq1_abc_to_dq1_alpha_beta_to_dq__q);
    ...
    HIL_OutAO(0x4062, (float)_current_abc_to_dq1_abc_to_dq1_alpha_beta_to_dq__d);
    ...
    HIL_OutAO(0x403d, (float)_trigonometric_function1__out);
    // Generated from the component: P_ref4.RegD_sys.C function2
    _p_ref4_regd_sys_c_function2__in = _p_ref4_regd_sys_c_function3__regD;
    _p_ref4_regd_sys_c_function2__sign = _p_ref4_regd_sys_bus_split2__out;
    _p_ref4_regd_sys_c_function2__out = _p_ref4_regd_sys_c_function2__in * ((-2 * _p_ref4_regd_sys_c_function2__sign) + 1);
    // Generated from the component: P_ref2.RegD_sys.C function2
    _p_ref2_regd_sys_c_function2__in = _p_ref2_regd_sys_c_function3__regD;
    _p_ref2_regd_sys_c_function2__sign = _p_ref2_regd_sys_bus_split2__out;
    _p_ref2_regd_sys_c_function2__out = _p_ref2_regd_sys_c_function2__in * ((-2 * _p_ref2_regd_sys_c_function2__sign) + 1);
    // Generated from the component: P_ref3.RegD_sys.C function2
    _p_ref3_regd_sys_c_function2__in = _p_ref3_regd_sys_c_function3__regD;
    _p_ref3_regd_sys_c_function2__sign = _p_ref3_regd_sys_bus_split2__out;
    _p_ref3_regd_sys_c_function2__out = _p_ref3_regd_sys_c_function2__in * ((-2 * _p_ref3_regd_sys_c_function2__sign) + 1);
    // Generated from the component: P_ref1.RegD_sys.C function2
    _p_ref1_regd_sys_c_function2__in = _p_ref1_regd_sys_c_function4__regD;
    _p_ref1_regd_sys_c_function2__sign = _p_ref1_regd_sys_bus_split3__out;
    _p_ref1_regd_sys_c_function2__out = _p_ref1_regd_sys_c_function2__in * ((-2 * _p_ref1_regd_sys_c_function2__sign) + 1);
    ...
    // Generated from the component: P_ref4.RegD_sys.Gain1
    _p_ref4_regd_sys_gain1__out = 1e-05 * _p_ref4_regd_sys_c_function2__out;
    // Generated from the component: P_ref2.RegD_sys.Gain1
    _p_ref2_regd_sys_gain1__out = 1e-05 * _p_ref2_regd_sys_c_function2__out;
    // Generated from the component: P_ref3.RegD_sys.Gain1
    _p_ref3_regd_sys_gain1__out = 1e-05 * _p_ref3_regd_sys_c_function2__out;
    // Generated from the component: P_ref3.RegD_sys.Regulation Data
    HIL_OutAO(0x4039, (float)_p_ref3_regd_sys_c_function2__out);
    // Generated from the component: P_ref1.RegD_sys.Gain1
    _p_ref1_regd_sys_gain1__out = 1e-05 * _p_ref1_regd_sys_c_function2__out;
    // Generated from the component: P_ref1.RegD_sys.regD
    HIL_OutAO(0x4032, (float)_p_ref1_regd_sys_c_function2__out);
    ...
    _p_ref1_hold_after_regulation__regulate = _p_ref1_regd_sys_gain1__out;
    _p_ref1_hold_after_regulation__out = _p_ref1_hold_after_regulation__var;
    // Generated from the component: P_ref1.RegD_act1
    HIL_OutAO(0x4031, (float)_p_ref1_regd_sys_gain1__out);
    ...
    _p_ref4_limit_ramp_rate__in = _p_ref4_unit_delay1__out;
    _p_ref4_limit_ramp_rate__initial = _p_ref4_gain1__out;
    _p_ref4_limit_ramp_rate__regulate = _p_ref4_hold_after_regulation__out;
    _p_ref4_limit_ramp_rate__P_ref = _p_ref4_limit_ramp_rate__var;
    _p_ref4_limit_ramp_rate__P_nom = _p_ref4_limit_ramp_rate__var2;
    // Generated from the component: P_ref2.limit ramp rate
    _p_ref2_limit_ramp_rate__in = _p_ref2_unit_delay1__out;
    _p_ref2_limit_ramp_rate__initial = _p_ref2_gain1__out;
    _p_ref2_limit_ramp_rate__regulate = _p_ref2_hold_after_regulation__out;
    _p_ref2_limit_ramp_rate__P_ref = _p_ref2_limit_ramp_rate__var;
    _p_ref2_limit_ramp_rate__P_nom = _p_ref2_limit_ramp_rate__var2;
    // Generated from the component: P_ref3.limit ramp rate
    _p_ref3_limit_ramp_rate__in = _p_ref3_unit_delay1__out;
    _p_ref3_limit_ramp_rate__initial = _p_ref3_gain1__out;
    _p_ref3_limit_ramp_rate__regulate = _p_ref3_hold_after_regulation__out;
    _p_ref3_limit_ramp_rate__P_ref = _p_ref3_limit_ramp_rate__var;
    _p_ref3_limit_ramp_rate__P_nom = _p_ref3_limit_ramp_rate__var2;
    // Generated from the component: P_ref1.limit ramp rate
    _p_ref1_limit_ramp_rate__in = _p_ref1_unit_delay1__out;
    _p_ref1_limit_ramp_rate__initial = _p_ref1_gain1__out;
    _p_ref1_limit_ramp_rate__regulate = _p_ref1_hold_after_regulation__out;
    _p_ref1_limit_ramp_rate__P_ref = _p_ref1_limit_ramp_rate__var;
    _p_ref1_limit_ramp_rate__P_nom = _p_ref1_limit_ramp_rate__var2;
    ...
    // Generated from the component: P_ref4.RegD_sys.Gain2
    _p_ref4_regd_sys_gain2__out = 10.0 * _p_ref4_limit_ramp_rate__P_nom;
    // Generated from the component: P_ref4.Sum9
    _p_ref4_sum9__out =  - _p_ref4_capacity_min__out + _p_ref4_limit_ramp_rate__P_nom;
    // Generated from the component: Current_ref3.Pref_probe
    HIL_OutAO(0x4021, (float)_p_ref4_limit_ramp_rate__P_ref);
    // Generated from the component: P_ref4.Sum10
    _p_ref4_sum10__out = _p_ref4_capacity_max__out - _p_ref4_limit_ramp_rate__P_nom;
    // Generated from the component: Current_ref3.Product5
    _current_ref3_product5__out = (_p_ref4_limit_ramp_rate__P_ref * _pll3_pll_abc_to_dq_lpf_d__out);
    // Generated from the component: Current_ref3.Product3
    _current_ref3_product3__out = (_pll3_pll_abc_to_dq_lpf_q__out * _p_ref4_limit_ramp_rate__P_ref);
    // Generated from the component: Pref4
    HIL_OutAO(0x4042, (float)_p_ref4_limit_ramp_rate__P_ref);
    // Generated from the component: Current_ref1.Product5
    _current_ref1_product5__out = (_p_ref2_limit_ramp_rate__P_ref * _pll1_pll_abc_to_dq_lpf_d__out);
    // Generated from the component: Current_ref1.Product3
    _current_ref1_product3__out = (_pll1_pll_abc_to_dq_lpf_q__out * _p_ref2_limit_ramp_rate__P_ref);
    // Generated from the component: P_ref2.Sum9
    _p_ref2_sum9__out =  - _p_ref2_capacity_min__out + _p_ref2_limit_ramp_rate__P_nom;
    // Generated from the component: Pref2
    HIL_OutAO(0x4040, (float)_p_ref2_limit_ramp_rate__P_ref);
    // Generated from the component: Current_ref1.Pref_probe
    HIL_OutAO(0x401b, (float)_p_ref2_limit_ramp_rate__P_ref);
    // Generated from the component: P_ref2.Sum10
    _p_ref2_sum10__out = _p_ref2_capacity_max__out - _p_ref2_limit_ramp_rate__P_nom;
    // Generated from the component: P_ref2.RegD_sys.Gain2
    _p_ref2_regd_sys_gain2__out = 10.0 * _p_ref2_limit_ramp_rate__P_nom;
    // Generated from the component: Pref3
    HIL_OutAO(0x4041, (float)_p_ref3_limit_ramp_rate__P_ref);
    // Generated from the component: Current_ref2.Product3
    _current_ref2_product3__out = (_pll2_pll_abc_to_dq_lpf_q__out * _p_ref3_limit_ramp_rate__P_ref);
    // Generated from the component: P_ref3.Sum9
    _p_ref3_sum9__out =  - _p_ref3_capacity_min__out + _p_ref3_limit_ramp_rate__P_nom;
    // Generated from the component: Current_ref2.Product5
    _current_ref2_product5__out = (_p_ref3_limit_ramp_rate__P_ref * _pll2_pll_abc_to_dq_lpf_d__out);
    // Generated from the component: Current_ref2.Pref_probe
    HIL_OutAO(0x401e, (float)_p_ref3_limit_ramp_rate__P_ref);
    // Generated from the component: P_ref3.RegD_sys.Gain2
    _p_ref3_regd_sys_gain2__out = 10.0 * _p_ref3_limit_ramp_rate__P_nom;
    // Generated from the component: P_ref3.Sum10
    _p_ref3_sum10__out = _p_ref3_capacity_max__out - _p_ref3_limit_ramp_rate__P_nom;
    // Generated from the component: P_ref1.Sum10
    _p_ref1_sum10__out = _p_ref1_capacity_max__out - _p_ref1_limit_ramp_rate__P_nom;
    // Generated from the component: Pref1
    HIL_OutAO(0x403f, (float)_p_ref1_limit_ramp_rate__P_ref);
    // Generated from the component: Current_ref.Product3
    _current_ref_product3__out = (_pll_pll_abc_to_dq_lpf_q__out * _p_ref1_limit_ramp_rate__P_ref);
    // Generated from the component: Current_ref.Pref_probe
    HIL_OutAO(0x4018, (float)_p_ref1_limit_ramp_rate__P_ref);
    // Generated from the component: Current_ref.Product5
    _current_ref_product5__out = (_p_ref1_limit_ramp_rate__P_ref * _pll_pll_abc_to_dq_lpf_d__out);
    // Generated from the component: P_ref1.Sum9
    _p_ref1_sum9__out =  - _p_ref1_capacity_min__out + _p_ref1_limit_ramp_rate__P_nom;
    // Generated from the component: P_ref1.RegD_sys.Gain2
    _p_ref1_regd_sys_gain2__out = 10.0 * _p_ref1_limit_ramp_rate__P_nom;
    ...
    // Generated from the component: P_ref4.RegD_sys.C function5
    _p_ref4_regd_sys_c_function5__P_nom = _p_ref4_regd_sys_gain2__out;
    if (_p_ref4_regd_sys_c_function5__P_nom < 0)_p_ref4_regd_sys_c_function5__sign = 1;
    else _p_ref4_regd_sys_c_function5__sign = 0;
    _p_ref4_regd_sys_c_function5__high = (((X_Int32)_p_ref4_regd_sys_c_function5__temp >> 16) & (0x0000FFFF));
    _p_ref4_regd_sys_c_function5__low = (((X_Int32)_p_ref4_regd_sys_c_function5__temp) & (0x0000FFFF));
    // Generated from the component: P_ref4.Product2
    _p_ref4_product2__out = (_p_ref4_regd_sys_gain1__out * _p_ref4_sum9__out);
    // Generated from the component: P_ref4.Product1
    _p_ref4_product1__out = (_p_ref4_sum10__out * _p_ref4_regd_sys_gain1__out);
    ...
    // Generated from the component: P_ref2.Product2
    _p_ref2_product2__out = (_p_ref2_regd_sys_gain1__out * _p_ref2_sum9__out);
    // Generated from the component: P_ref2.Product1
    _p_ref2_product1__out = (_p_ref2_sum10__out * _p_ref2_regd_sys_gain1__out);
    // Generated from the component: P_ref2.RegD_sys.C function5
    _p_ref2_regd_sys_c_function5__P_nom = _p_ref2_regd_sys_gain2__out;
    if (_p_ref2_regd_sys_c_function5__P_nom < 0)_p_ref2_regd_sys_c_function5__sign = 1;
    else _p_ref2_regd_sys_c_function5__sign = 0;
    _p_ref2_regd_sys_c_function5__high = (((X_Int32)_p_ref2_regd_sys_c_function5__temp >> 16) & (0x0000FFFF));
    _p_ref2_regd_sys_c_function5__low = (((X_Int32)_p_ref2_regd_sys_c_function5__temp) & (0x0000FFFF));
    ...
    // Generated from the component: P_ref3.Product2
    _p_ref3_product2__out = (_p_ref3_regd_sys_gain1__out * _p_ref3_sum9__out);
    ...
    // Generated from the component: P_ref3.RegD_sys.C function5
    _p_ref3_regd_sys_c_function5__P_nom = _p_ref3_regd_sys_gain2__out;
    if (_p_ref3_regd_sys_c_function5__P_nom < 0)_p_ref3_regd_sys_c_function5__sign = 1;
    else _p_ref3_regd_sys_c_function5__sign = 0;
    _p_ref3_regd_sys_c_function5__high = (((X_Int32)_p_ref3_regd_sys_c_function5__temp >> 16) & (0x0000FFFF));
    _p_ref3_regd_sys_c_function5__low = (((X_Int32)_p_ref3_regd_sys_c_function5__temp) & (0x0000FFFF));
    // Generated from the component: P_ref3.Product1
    _p_ref3_product1__out = (_p_ref3_sum10__out * _p_ref3_regd_sys_gain1__out);
    // Generated from the component: P_ref1.Product1
    _p_ref1_product1__out = (_p_ref1_sum10__out * _p_ref1_regd_sys_gain1__out);
    ...
    // Generated from the component: P_ref1.Product2
    _p_ref1_product2__out = (_p_ref1_regd_sys_gain1__out * _p_ref1_sum9__out);
    // Generated from the component: P_ref1.RegD_sys.C function5
    _p_ref1_regd_sys_c_function5__P_nom = _p_ref1_regd_sys_gain2__out;
    if (_p_ref1_regd_sys_c_function5__P_nom < 0)_p_ref1_regd_sys_c_function5__sign = 1;
    else _p_ref1_regd_sys_c_function5__sign = 0;
    _p_ref1_regd_sys_c_function5__high = (((X_Int32)_p_ref1_regd_sys_c_function5__temp >> 16) & (0x0000FFFF));
    _p_ref1_regd_sys_c_function5__low = (((X_Int32)_p_ref1_regd_sys_c_function5__temp) & (0x0000FFFF));
    ...
    _p_ref4_regd_sys_bus_join1__out[0] = _p_ref4_regd_sys_c_function5__high;
    _p_ref4_regd_sys_bus_join1__out[1] = _p_ref4_regd_sys_c_function5__low;
    _p_ref4_regd_sys_bus_join1__out[2] = _p_ref4_regd_sys_c_function5__sign;
    // Generated from the component: P_ref4.Signal switch1
    _p_ref4_signal_switch1__out = (_p_ref4_regd_sys_gain1__out < 0.0f) ? _p_ref4_product2__out : _p_ref4_product1__out;
    ...
    // Generated from the component: P_ref2.Signal switch1
    _p_ref2_signal_switch1__out = (_p_ref2_regd_sys_gain1__out < 0.0f) ? _p_ref2_product2__out : _p_ref2_product1__out;
    // Generated from the component: P_ref2.RegD_sys.Bus Join1
    _p_ref2_regd_sys_bus_join1__out[0] = _p_ref2_regd_sys_c_function5__high;
    _p_ref2_regd_sys_bus_join1__out[1] = _p_ref2_regd_sys_c_function5__low;
    _p_ref2_regd_sys_bus_join1__out[2] = _p_ref2_regd_sys_c_function5__sign;
    ...
    _p_ref3_regd_sys_bus_join1__out[0] = _p_ref3_regd_sys_c_function5__high;
    _p_ref3_regd_sys_bus_join1__out[1] = _p_ref3_regd_sys_c_function5__low;
    _p_ref3_regd_sys_bus_join1__out[2] = _p_ref3_regd_sys_c_function5__sign;
    // Generated from the component: P_ref3.Signal switch1
    _p_ref3_signal_switch1__out = (_p_ref3_regd_sys_gain1__out < 0.0f) ? _p_ref3_product2__out : _p_ref3_product1__out;
    ...
    // Generated from the component: P_ref1.Signal switch1
    _p_ref1_signal_switch1__out = (_p_ref1_regd_sys_gain1__out < 0.0f) ? _p_ref1_product2__out : _p_ref1_product1__out;
    // Generated from the component: P_ref1.RegD_sys.Bus Join1
    _p_ref1_regd_sys_bus_join1__out[0] = _p_ref1_regd_sys_c_function5__high;
    _p_ref1_regd_sys_bus_join1__out[1] = _p_ref1_regd_sys_c_function5__low;
    _p_ref1_regd_sys_bus_join1__out[2] = _p_ref1_regd_sys_c_function5__sign;
    ...
    XIo_OutInt32(0x550001ec, _p_ref4_regd_sys_bus_join1__out[0]);
    XIo_OutInt32(0x550001f0, _p_ref4_regd_sys_bus_join1__out[1]);
    XIo_OutInt32(0x550001f4, _p_ref4_regd_sys_bus_join1__out[2]);
    // Generated from the component: P_ref4.Sum7
    _p_ref4_sum7__out = _p_ref4_signal_switch1__out + _p_ref4_limit_ramp_rate__P_nom;
    ...
    _p_ref2_sum7__out = _p_ref2_signal_switch1__out + _p_ref2_limit_ramp_rate__P_nom;
    // Generated from the component: P_ref2.RegD_sys.ModBus Device2.comp_reg_in
    XIo_OutInt32(0x550001b4, _p_ref2_regd_sys_bus_join1__out[0]);
    XIo_OutInt32(0x550001b8, _p_ref2_regd_sys_bus_join1__out[1]);
    XIo_OutInt32(0x550001bc, _p_ref2_regd_sys_bus_join1__out[2]);
    ...
    XIo_OutInt32(0x550001d0, _p_ref3_regd_sys_bus_join1__out[0]);
    XIo_OutInt32(0x550001d4, _p_ref3_regd_sys_bus_join1__out[1]);
    XIo_OutInt32(0x550001d8, _p_ref3_regd_sys_bus_join1__out[2]);
    // Generated from the component: P_ref3.Sum7
    _p_ref3_sum7__out = _p_ref3_signal_switch1__out + _p_ref3_limit_ramp_rate__P_nom;
    ...
    _p_ref1_sum7__out = _p_ref1_signal_switch1__out + _p_ref1_limit_ramp_rate__P_nom;
    // Generated from the component: P_ref1.RegD_sys.ModBus Device1.comp_reg_in
    XIo_OutInt32(0x55000198, _p_ref1_regd_sys_bus_join1__out[0]);
    XIo_OutInt32(0x5500019c, _p_ref1_regd_sys_bus_join1__out[1]);
    XIo_OutInt32(0x550001a0, _p_ref1_regd_sys_bus_join1__out[2]);
    ...
    HIL_OutAO(0x405c, (float)_signal_switch8__out);
    ...
    HIL_OutAO(0x4060, (float)_signal_switch7__out);
    // Generated from the component: Xi_d_ref_res1
    HIL_OutAO(0x405a, (float)_signal_switch4__out);
    ...
    HIL_OutAO(0x405e, (float)_signal_switch3__out);
    ...
    HIL_OutAO(0x405f, (float)_signal_switch5__out);
    ...
    HIL_OutAO(0x405b, (float)_signal_switch6__out);
    // Generated from the component: Xi_q_ref_res
    HIL_OutAO(0x405d, (float)_signal_switch2__out);
    ...
    HIL_OutAO(0x4059, (float)_signal_switch1__out);
    ...
    HIL_OutAO(0x4051, (float)_subsystem4_sum3__out);
    // Generated from the component: Uq4
    HIL_OutAO(0x4055, (float)_subsystem4_sum7__out);
    ...
    HIL_OutAO(0x404f, (float)_subsystem2_sum3__out);
    ...
    HIL_OutAO(0x4053, (float)_subsystem2_sum7__out);
    // Generated from the component: Uq2
    HIL_OutAO(0x4054, (float)_subsystem3_sum7__out);
    // Generated from the component: Ud2
    HIL_OutAO(0x4050, (float)_subsystem3_sum3__out);
    ...
    HIL_OutAO(0x4052, (float)_subsystem1_sum7__out);
    ...
    HIL_OutAO(0x404e, (float)_subsystem1_sum3__out);
    ...
    // Generated from the component: P_ref2.Unit Delay1
    _p_ref2_unit_delay1__state = _p_ref2_sum7__out;
    // Generated from the component: P_ref4.Unit Delay1
    _p_ref4_unit_delay1__state = _p_ref4_sum7__out;
    // Generated from the component: PLL.PLL.PID.Integrator2
    _pll_pll_pid_integrator2__state += _pll_pll_pid_gain1__out * 0.0002;
    // Generated from the component: P_ref3.Unit Delay1
    _p_ref3_unit_delay1__state = _p_ref3_sum7__out;
    // Generated from the component: P_ref4.RegD_sys.ModBus Device4.comp_holding_out
    // Generated from the component: P_ref4.RegD_sys.ModBus Device4.comp_coil_out
    // Generated from the component: P_ref1.RegD_sys.ModBus Device1.comp_coil_out
    // Generated from the component: PLL3.PLL.PID.Integrator1
    ...
    // Generated from the component: P_ref1.Unit Delay1
    _p_ref1_unit_delay1__state = _p_ref1_sum7__out;
    // Generated from the component: P_ref3.RegD_sys.ModBus Device3.comp_coil_out
    // Generated from the component: P_ref3.RegD_sys.ModBus Device3.comp_holding_out
    // Generated from the component: P_ref1.RegD_sys.ModBus Device1.comp_holding_out
    // Generated from the component: PLL1.PLL.PID.Integrator2
    ...
    // Generated from the component: P_ref4.RegD_sys.ModBus Device4.comp_discrete_in
    // Generated from the component: switch in 5 minutes
    if ((_switch_in_5_minutes__step >= (60 * 5 / 0.0002)) || (_switch_in_5_minutes__step == 0)) {
        _switch_in_5_minutes__step = 0;
        _switch_in_5_minutes__var = _switch_in_5_minutes__in;
    }
    if (_switch_in_5_minutes__step < (5 / 0.0002))_switch_in_5_minutes__var = _switch_in_5_minutes__in;
    _switch_in_5_minutes__step += 1;
    // Generated from the component: P_ref4.RegD_sys.C function3
    // Generated from the component: P_ref3.RegD_sys.ModBus Device3.comp_holding_in
    // Generated from the component: P_ref4.RegD_sys.ModBus Device4.comp_holding_in
    // Generated from the component: P_ref2.RegD_sys.C function3
    ...
    _p_ref4_limit_ramp_rate__step += 1;
    if (_p_ref4_limit_ramp_rate__step >= (60 * 5 / 0.0002)) {
        _p_ref4_limit_ramp_rate__step = 0;
        _p_ref4_limit_ramp_rate__var2 = _p_ref4_limit_ramp_rate__in;
    }
    // Generated from the component: P_ref2.limit ramp rate
    ...
    _p_ref2_limit_ramp_rate__step += 1;
    if (_p_ref2_limit_ramp_rate__step >= (60 * 5 / 0.0002)) {
        _p_ref2_limit_ramp_rate__step = 0;
        _p_ref2_limit_ramp_rate__var2 = _p_ref2_limit_ramp_rate__in;
    }
    // Generated from the component: P_ref3.limit ramp rate
    ...
    _p_ref3_limit_ramp_rate__step += 1;
    if (_p_ref3_limit_ramp_rate__step >= (60 * 5 / 0.0002)) {
        _p_ref3_limit_ramp_rate__step = 0;
        _p_ref3_limit_ramp_rate__var2 = _p_ref3_limit_ramp_rate__in;
    }
    // Generated from the component: P_ref1.limit ramp rate
    ...
    _p_ref1_limit_ramp_rate__step += 1;
    if (_p_ref1_limit_ramp_rate__step >= (60 * 5 / 0.0002)) {
        _p_ref1_limit_ramp_rate__step = 0;
        _p_ref1_limit_ramp_rate__var2 = _p_ref1_limit_ramp_rate__in;
    }
    // Generated from the component: P_ref4.RegD_sys.C function5
    if (_p_ref4_regd_sys_c_function5__P_nom < 0)_p_ref4_regd_sys_c_function5__temp = _p_ref4_regd_sys_c_function5__P_nom * -1;
    else _p_ref4_regd_sys_c_function5__temp = _p_ref4_regd_sys_c_function5__P_nom;
    // Generated from the component: P_ref2.RegD_sys.C function5
    if (_p_ref2_regd_sys_c_function5__P_nom < 0)_p_ref2_regd_sys_c_function5__temp = _p_ref2_regd_sys_c_function5__P_nom * -1;
    else _p_ref2_regd_sys_c_function5__temp = _p_ref2_regd_sys_c_function5__P_nom;
    // Generated from the component: P_ref3.RegD_sys.C function5
    if (_p_ref3_regd_sys_c_function5__P_nom < 0)_p_ref3_regd_sys_c_function5__temp = _p_ref3_regd_sys_c_function5__P_nom * -1;
    else _p_ref3_regd_sys_c_function5__temp = _p_ref3_regd_sys_c_function5__P_nom;
    // Generated from the component: P_ref1.RegD_sys.C function5
    if (_p_ref1_regd_sys_c_function5__P_nom < 0)_p_ref1_regd_sys_c_function5__temp = _p_ref1_regd_sys_c_function5__P_nom * -1;
    else _p_ref1_regd_sys_c_function5__temp = _p_ref1_regd_sys_c_function5__P_nom;
    // Generated from the component: PLL3.PLL.integrator
    // Generated from the component: PLL3.PLL.Rate Limiter1
    ...
    if (!_subsystem4_pid_controller1__av_active) {
        _subsystem4_pid_controller1__integrator_state += 2.0 * _subsystem4_sum1__out * 0.0002;
    }
    // Generated from the component: Subsystem4.PID controller2
    if (!_subsystem4_pid_controller2__av_active) {
        _subsystem4_pid_controller2__integrator_state += 2.0 * _subsystem4_sum2__out * 0.0002;
    }
    // Generated from the component: Subsystem2.PID controller1
    if (!_subsystem2_pid_controller1__av_active) {
        _subsystem2_pid_controller1__integrator_state += 2.0 * _subsystem2_sum1__out * 0.0002;
    }
    // Generated from the component: Subsystem2.PID controller2
    if (!_subsystem2_pid_controller2__av_active) {
        _subsystem2_pid_controller2__integrator_state += 2.0 * _subsystem2_sum2__out * 0.0002;
    }
    // Generated from the component: Subsystem3.PID controller2
    if (!_subsystem3_pid_controller2__av_active) {
        _subsystem3_pid_controller2__integrator_state += 2.0 * _subsystem3_sum2__out * 0.0002;
    }
    // Generated from the component: Subsystem3.PID controller1
    if (!_subsystem3_pid_controller1__av_active) {
        _subsystem3_pid_controller1__integrator_state += 2.0 * _subsystem3_sum1__out * 0.0002;
    }
    // Generated from the component: Subsystem1.PID controller2
    if (!_subsystem1_pid_controller2__av_active) {
        _subsystem1_pid_controller2__integrator_state += 2.0 * _subsystem1_sum2__out * 0.0002;
    }
    // Generated from the component: Subsystem1.PID controller3
    _subsystem1_pid_controller3__integrator_state += 2.0 * _subsystem1_sum8__out * 0.0002;
