...
void TimerCounterHandler_0_sys_sp_cpu_dev0() {
    ...
    _igc_rms2_iinst_ia1__out = HIL_InAO(0x11e);
    // Generated from the component: Vab_rms2.Vinst.Va1
    _vab_rms2_vinst_va1__out = HIL_InAO(0x117);
    // Generated from the component: Vbc_rms2.Vinst.Va1
    _vbc_rms2_vinst_va1__out = HIL_InAO(0x119);
    // Generated from the component: Igb_rms2.Iinst.Ia1
    _igb_rms2_iinst_ia1__out = HIL_InAO(0x11d);
    // Generated from the component: Iga_rms2.Iinst.Ia1
    _iga_rms2_iinst_ia1__out = HIL_InAO(0x11c);
    ...
    _va_rms1_vinst_va1__out = HIL_InAO(0x21b);
    ...
    _va_rms_vinst_va1__out = HIL_InAO(0x31b);
    // Generated from the component: Igb_rms.Iinst.Ia1
    _igb_rms_iinst_ia1__out = HIL_InAO(0x32c);
    // Generated from the component: Iga_rms.Iinst.Ia1
    _iga_rms_iinst_ia1__out = HIL_InAO(0x32b);
    // Generated from the component: Igc_rms.Iinst.Ia1
    _igc_rms_iinst_ia1__out = HIL_InAO(0x32d);
    // Generated from the component: Vbc_rms.Vinst.Va1
    _vbc_rms_vinst_va1__out = HIL_InAO(0x320);
