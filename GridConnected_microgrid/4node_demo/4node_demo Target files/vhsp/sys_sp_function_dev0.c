...
float _va_rms1_vinst_va1__out;
float _va_rms_vinst_va1__out;
...
float _va_rms1_rms_calc_slow__var_rms;
...
float _va_rms1_rms_calc_fast__var_eff_s;
X_UnInt32 _va_rms1_rms_calc_fast__period;
X_UnInt8 _va_rms1_rms_calc_fast__var_zc;
float _va_rms1_rms_calc_fast__var_filt_old;
float _igb_rms2_rms_calc_slow__var_rms;
float _va_rms_rms_calc_slow__var_rms;
...
float _va_rms_rms_calc_fast__var_eff_s;
X_UnInt32 _va_rms_rms_calc_fast__period;
X_UnInt8 _va_rms_rms_calc_fast__var_zc;
float _va_rms_rms_calc_fast__var_filt_old;
...
float _va_rms_rt2_output__out =  0.0;
...
float _va_rms1_rt1_output__out =  0.0;
...
float _va_rms_rt1_output__out =  0.0;
...
float _va_rms1_rt2_output__out =  0.0;
...
float _va_rms1_rms_calc_fast__v_sq_sum_state;
X_UnInt32 _va_rms1_rms_calc_fast__pc_cnt_1_state;
float _va_rms1_rms_calc_fast__var_filt;
...
float _va_rms_rms_calc_fast__v_sq_sum_state;
X_UnInt32 _va_rms_rms_calc_fast__pc_cnt_1_state;
float _va_rms_rms_calc_fast__var_filt;
...
void ReInit_sys_sp_cpu_dev0() {
    ...
    _va_rms1_rms_calc_fast__var_eff_s = 0;
    _va_rms1_rms_calc_fast__period = 0;
    _va_rms1_rms_calc_fast__var_filt = 0.0f;
    _va_rms1_rms_calc_fast__v_sq_sum_state = 0.0f;
    _va_rms1_rms_calc_fast__pc_cnt_1_state = 0;
    ...
    _va_rms_rms_calc_fast__var_eff_s = 0;
    _va_rms_rms_calc_fast__period = 0;
    _va_rms_rms_calc_fast__var_filt = 0.0f;
    _va_rms_rms_calc_fast__v_sq_sum_state = 0.0f;
    _va_rms_rms_calc_fast__pc_cnt_1_state = 0;
...
void TimerCounterHandler_0_sys_sp_cpu_dev0() {
    ...
    _vbc_rms_vinst_va1__out = HIL_InAO(0x220);

    // Generated from the component: Vbc_rms2.Vinst.Va1
    _vbc_rms2_vinst_va1__out = HIL_InAO(0x319);

    // Generated from the component: Iga_rms.Iinst.Ia1
    _iga_rms_iinst_ia1__out = HIL_InAO(0x22b);

    // Generated from the component: Igb_rms1.Iinst.Ia1
    _igb_rms1_iinst_ia1__out = HIL_InAO(0x12c);
    ...
    _igb_rms_iinst_ia1__out = HIL_InAO(0x22c);
    ...
    _vab_rms2_vinst_va1__out = HIL_InAO(0x317);

    // Generated from the component: Igc_rms.Iinst.Ia1
    _igc_rms_iinst_ia1__out = HIL_InAO(0x22d);

    // Generated from the component: Igc_rms1.Iinst.Ia1
    _igc_rms1_iinst_ia1__out = HIL_InAO(0x12d);

    // Generated from the component: Vbc_rms1.Vinst.Va1
    _vbc_rms1_vinst_va1__out = HIL_InAO(0x120);

    // Generated from the component: Va_rms1.Vinst.Va1
    _va_rms1_vinst_va1__out = HIL_InAO(0x11b);

    // Generated from the component: Va_rms.Vinst.Va1
    _va_rms_vinst_va1__out = HIL_InAO(0x21b);
    ...
    _igc_rms2_iinst_ia1__out = HIL_InAO(0x31e);

    // Generated from the component: Igb_rms2.Iinst.Ia1
    _igb_rms2_iinst_ia1__out = HIL_InAO(0x31d);

    // Generated from the component: Iga_rms1.Iinst.Ia1
    _iga_rms1_iinst_ia1__out = HIL_InAO(0x12b);
    ...
    _iga_rms2_iinst_ia1__out = HIL_InAO(0x31c);
    ...
    // Generated from the component: Va_rms1.rms_calc_fast
    _va_rms1_rms_calc_fast__v_sq_sum_state = _va_rms1_rms_calc_fast__v_sq_sum_state + _va_rms1_vinst_va1__out * _va_rms1_vinst_va1__out;
    _va_rms1_rms_calc_fast__var_filt_old = _va_rms1_rms_calc_fast__var_filt;
    _va_rms1_rms_calc_fast__var_filt = (_va_rms1_rms_calc_fast__var_filt_old * 0.909 + _va_rms1_vinst_va1__out * 0.0909);
    if((_va_rms1_rms_calc_fast__var_filt >= 0.0f) && (_va_rms1_rms_calc_fast__var_filt_old < 0.0f)) {
        _va_rms1_rms_calc_fast__var_zc = 1;
    }
    else {
        _va_rms1_rms_calc_fast__var_zc = 0;
    }
    //square sum and period update on signal zero cross
    if ((_va_rms1_rms_calc_fast__var_zc == 1) || (5000 == _va_rms1_rms_calc_fast__pc_cnt_1_state)) {
        _va_rms1_rms_calc_fast__var_eff_s = _va_rms1_rms_calc_fast__v_sq_sum_state;
        _va_rms1_rms_calc_fast__period = (float)_va_rms1_rms_calc_fast__pc_cnt_1_state;
        _va_rms1_rms_calc_fast__v_sq_sum_state = 0.0f;
    }

    // Generated from the component: Va_rms1.rt2.Input
    _va_rms1_rt2_output__out = _va_rms1_rms_calc_fast__period;
    // Generated from the component: Igc_rms.sys1

    // Generated from the component: Va_rms1.rt1.Input
    _va_rms1_rt1_output__out = _va_rms1_rms_calc_fast__var_eff_s;
    ...
    // Generated from the component: Va_rms.rms_calc_fast
    _va_rms_rms_calc_fast__v_sq_sum_state = _va_rms_rms_calc_fast__v_sq_sum_state + _va_rms_vinst_va1__out * _va_rms_vinst_va1__out;
    _va_rms_rms_calc_fast__var_filt_old = _va_rms_rms_calc_fast__var_filt;
    _va_rms_rms_calc_fast__var_filt = (_va_rms_rms_calc_fast__var_filt_old * 0.909 + _va_rms_vinst_va1__out * 0.0909);
    if((_va_rms_rms_calc_fast__var_filt >= 0.0f) && (_va_rms_rms_calc_fast__var_filt_old < 0.0f)) {
        _va_rms_rms_calc_fast__var_zc = 1;
    }
    else {
        _va_rms_rms_calc_fast__var_zc = 0;
    }
    //square sum and period update on signal zero cross
    if ((_va_rms_rms_calc_fast__var_zc == 1) || (5000 == _va_rms_rms_calc_fast__pc_cnt_1_state)) {
        _va_rms_rms_calc_fast__var_eff_s = _va_rms_rms_calc_fast__v_sq_sum_state;
        _va_rms_rms_calc_fast__period = (float)_va_rms_rms_calc_fast__pc_cnt_1_state;
        _va_rms_rms_calc_fast__v_sq_sum_state = 0.0f;
    }

    // Generated from the component: Va_rms.rt1.Input
    _va_rms_rt1_output__out = _va_rms_rms_calc_fast__var_eff_s;
    ...
    // Generated from the component: Va_rms.sys1
    ...
    // Generated from the component: Va_rms1.sys1
    ...
    // Generated from the component: Va_rms.rt2.Input
    _va_rms_rt2_output__out = _va_rms_rms_calc_fast__period;
    // Generated from the component: Igc_rms.t1


    // Generated from the component: Va_rms1.t1
    ...
    // Generated from the component: Va_rms.t1
    ...
    _va_rms1_rms_calc_fast__pc_cnt_1_state ++;
    ...
    _va_rms_rms_calc_fast__pc_cnt_1_state ++;
...
void TimerCounterHandler_1_sys_sp_cpu_dev0() {
    ...
    // Generated from the component: Va_rms.rt2.Output
    ...
    // Generated from the component: Va_rms1.rt1.Output
    ...
    // Generated from the component: Va_rms.rt1.Output
    ...
    // Generated from the component: Va_rms1.rt2.Output
    ...
    HIL_OutAO(0x200d, _igc_rms3_rms_calc_slow__var_rms);
    ...
    HIL_OutAO(0x200b, _igc_rms1_rms_calc_slow__var_rms);

    // Generated from the component: Va_rms1.rms_calc_slow
    if(_va_rms1_rt2_output__out > 0.0f) {
        _va_rms1_rms_calc_slow__var_rms = sqrtf(_va_rms1_rt1_output__out / _va_rms1_rt2_output__out);
    }
    else {
        _va_rms1_rms_calc_slow__var_rms = 0.0f;
    }

    // Generated from the component: Va_rms1.cpu_trans.Input
    XIo_OutFloat(0x55000104, _va_rms1_rms_calc_slow__var_rms);
    ...
    HIL_OutAO(0x2011, _vab_rms3_rms_calc_slow__var_rms);
    ...
    // Generated from the component: Va_rms.rms_calc_slow
    if(_va_rms_rt2_output__out > 0.0f) {
        _va_rms_rms_calc_slow__var_rms = sqrtf(_va_rms_rt1_output__out / _va_rms_rt2_output__out);
    }
    else {
        _va_rms_rms_calc_slow__var_rms = 0.0f;
    }

    // Generated from the component: Va_rms.sys2
    ...
    HIL_OutAO(0x2006, _igb_rms_rms_calc_slow__var_rms);
    ...
    HIL_OutAO(0x2013, _vbc_rms1_rms_calc_slow__var_rms);
    ...
    HIL_OutAO(0x200a, _igc_rms_rms_calc_slow__var_rms);
    ...
    HIL_OutAO(0x2009, _igb_rms3_rms_calc_slow__var_rms);
    ...
    HIL_OutAO(0x2012, _vbc_rms_rms_calc_slow__var_rms);
    ...
    HIL_OutAO(0x2014, _vbc_rms2_rms_calc_slow__var_rms);

    // Generated from the component: Igb_rms3.sys2

    // Generated from the component: Va_rms1.rms
    HIL_OutAO(0x200f, _va_rms1_rms_calc_slow__var_rms);

    // Generated from the component: Ground1.rms
    HIL_OutAO(0x2000, _ground1_rms_calc_slow__var_rms);

    // Generated from the component: Iga_rms2.rms
    HIL_OutAO(0x2004, _iga_rms2_rms_calc_slow__var_rms);
    ...
    HIL_OutAO(0x2003, _iga_rms1_rms_calc_slow__var_rms);

    // Generated from the component: Iga_rms.rms
    HIL_OutAO(0x2002, _iga_rms_rms_calc_slow__var_rms);
    ...
    HIL_OutAO(0x200c, _igc_rms2_rms_calc_slow__var_rms);

    // Generated from the component: Igb_rms1.rms
    HIL_OutAO(0x2007, _igb_rms1_rms_calc_slow__var_rms);

    // Generated from the component: Vbc_rms3.rms
    HIL_OutAO(0x2015, _vbc_rms3_rms_calc_slow__var_rms);

    // Generated from the component: Va_rms.cpu_trans.Input
    XIo_OutFloat(0x55000100, _va_rms_rms_calc_slow__var_rms);

    // Generated from the component: Vab_rms2.rms
    HIL_OutAO(0x2010, _vab_rms2_rms_calc_slow__var_rms);

    // Generated from the component: Va_rms1.sys2

    // Generated from the component: Ground2.rms
    HIL_OutAO(0x2001, _ground2_rms_calc_slow__var_rms);

    // Generated from the component: Vbc_rms3.sys2

    // Generated from the component: Vbc_rms2.sys2

    // Generated from the component: Va_rms.rms
    HIL_OutAO(0x200e, _va_rms_rms_calc_slow__var_rms);

    // Generated from the component: Iga_rms3.rms
    HIL_OutAO(0x2005, _iga_rms3_rms_calc_slow__var_rms);

    // Generated from the component: Igb_rms2.rms
    HIL_OutAO(0x2008, _igb_rms2_rms_calc_slow__var_rms);
