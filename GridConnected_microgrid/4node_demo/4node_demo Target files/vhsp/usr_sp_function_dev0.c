...
X_UnInt32 _three_phase_inverter4_igbt_leg1_pwm_modulator__channels[1] = {4};
...
X_UnInt32 _three_phase_inverter3_igbt_leg2_pwm_modulator__channels[1] = {2};
...
X_UnInt32 _three_phase_inverter1_igbt_leg1_pwm_modulator__channels[1] = {8};
...
X_UnInt32 _three_phase_inverter1_igbt_leg3_pwm_modulator__channels[1] = {10};
...
X_UnInt32 _three_phase_inverter2_igbt_leg3_pwm_modulator__channels[1] = {7};
...
X_UnInt32 _three_phase_inverter3_igbt_leg1_pwm_modulator__channels[1] = {11};
...
X_UnInt32 _three_phase_inverter2_igbt_leg2_pwm_modulator__channels[1] = {3};
...
float _led_14__tmp;
float _led_9__tmp;
X_UnInt32 _three_phase_inverter4_igbt_leg2_pwm_modulator__channels[1] = {9};
...
void ReInit_user_sp_cpu_dev0() {
    ...
    _three_phase_inverter4_igbt_leg1_pwm_modulator__update_mask = 16;
    ...
    _three_phase_inverter3_igbt_leg2_pwm_modulator__update_mask = 4;
    ...
    _three_phase_inverter1_igbt_leg1_pwm_modulator__update_mask = 256;
    ...
    _three_phase_inverter1_igbt_leg3_pwm_modulator__update_mask = 1024;
    ...
    _three_phase_inverter2_igbt_leg3_pwm_modulator__update_mask = 128;
    ...
    _three_phase_inverter3_igbt_leg1_pwm_modulator__update_mask = 2048;
    ...
    _three_phase_inverter2_igbt_leg2_pwm_modulator__update_mask = 8;
    ...
    _three_phase_inverter4_igbt_leg2_pwm_modulator__update_mask = 512;
...
void TimerCounterHandler_1_user_sp_cpu_dev0() {
    ...
    _xi_c1_ia2__out = HIL_InAO(0x133);
    ...
    _xi_c2_ia2__out = HIL_InAO(0x324);
    ...
    _vdc_2_va1__out = HIL_InAO(0x118);
    ...
    _xi_a2_ia2__out = HIL_InAO(0x320);
    ...
    _eb2_va2__out = HIL_InAO(0x312);

    // Generated from the component: Xi_b1.Ia2
    _xi_b1_ia2__out = HIL_InAO(0x131);
    ...
    _s_meas2_power_meter1__P = _s_meas2_power_meter1__v_alpha * _s_meas2_power_meter1__i_alpha + _s_meas2_power_meter1__v_beta * _s_meas2_power_meter1__i_beta;
    ...
    _s_meas2_power_meter1__Pac = _s_meas2_power_meter1__P - _s_meas2_power_meter1__Pdc;
    _s_meas2_power_meter1__Qac = _s_meas2_power_meter1__Q - _s_meas2_power_meter1__Qdc;
    ...
    _s_meas_power_meter1__P = _s_meas_power_meter1__v_alpha * _s_meas_power_meter1__i_alpha + _s_meas_power_meter1__v_beta * _s_meas_power_meter1__i_beta;
    ...
    _s_meas_power_meter1__Pac = _s_meas_power_meter1__P - _s_meas_power_meter1__Pdc;
    _s_meas_power_meter1__Qac = _s_meas_power_meter1__Q - _s_meas_power_meter1__Qdc;
    ...
    _power_meter1__P = _power_meter1__v_alpha * _power_meter1__i_alpha + _power_meter1__v_beta * _power_meter1__i_beta;
    ...
    _power_meter1__Pac = _power_meter1__P - _power_meter1__Pdc;
    _power_meter1__Qac = _power_meter1__Q - _power_meter1__Qdc;
    ...
    _s_meas_1_power_meter1__P = _s_meas_1_power_meter1__v_alpha * _s_meas_1_power_meter1__i_alpha + _s_meas_1_power_meter1__v_beta * _s_meas_1_power_meter1__i_beta;
    ...
    _s_meas_1_power_meter1__Pac = _s_meas_1_power_meter1__P - _s_meas_1_power_meter1__Pdc;
    _s_meas_1_power_meter1__Qac = _s_meas_1_power_meter1__Q - _s_meas_1_power_meter1__Qdc;
    ...
    _s_meas1_power_meter1__P = _s_meas1_power_meter1__v_alpha * _s_meas1_power_meter1__i_alpha + _s_meas1_power_meter1__v_beta * _s_meas1_power_meter1__i_beta;
    ...
    _s_meas1_power_meter1__Pac = _s_meas1_power_meter1__P - _s_meas1_power_meter1__Pdc;
    _s_meas1_power_meter1__Qac = _s_meas1_power_meter1__Q - _s_meas1_power_meter1__Qdc;
    ...
    _s_meas3_power_meter1__P = _s_meas3_power_meter1__v_alpha * _s_meas3_power_meter1__i_alpha + _s_meas3_power_meter1__v_beta * _s_meas3_power_meter1__i_beta;
    ...
    _s_meas3_power_meter1__Pac = _s_meas3_power_meter1__P - _s_meas3_power_meter1__Pdc;
    _s_meas3_power_meter1__Qac = _s_meas3_power_meter1__Q - _s_meas3_power_meter1__Qdc;
