...
long capacity_max = 7000;  //DER capacity_max limit
long capacity_min = 500;  //DER capacity_min limit
...
OLocalVertex s = OLocalVertex(0x4174F186,0,iP_nom*base,-2.1667*base,0.1667*base,2,base,2);  //#NODE
...
void sendConsensusResults()
{
  ...
  Mb.Req(MB_FC_WRITE_MULTIPLE_REGISTERS,0,3,0,node2_ip); //(MB_FC FC, word Ref - typhoon, word Count, word Pos - arduino, int nodeip) //#NODE
  Mb.MbmRun();
...
void receiveTyphoonData()
{
  ...
  Mb.Req(MB_FC_READ_INPUT_REGISTER,0,3,0,node2_ip); //(MB_FC FC, word Ref - typhoon, word Count, word Pos -arduino, int nodeip) //#NODE
  Mb.MbmRun();
}
