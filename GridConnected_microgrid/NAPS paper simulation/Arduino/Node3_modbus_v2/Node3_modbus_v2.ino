...
OLocalVertex s = OLocalVertex(0x4151C692,0,capacity*base,-1.5*base,0.5*base,2,base, node_id);
OGraph g = OGraph(&s);
...
void sendConsensusResults()
{
  ...
  ref = 20;                                //starting address of node 2 registers is 10
  ...
  int node3_ip = 43; //part of ip address for node 1 on the HIL side
  Mb.Build(fc,Ref_high,Ref_low,Count_high,Count_low,Pos_high,Pos_low,node3_ip);
  Mb.MbmRun();
