...
double _p_ref4_capacity2__out = 1000.0;
...
double _modbus_device5_comp_coil_out__out;
double _s_control_mode__out;
double _c1__out = 1.0;
X_UnInt32 _square_wave_source20__out;
X_UnInt32 _square_wave_source19__out;
double _vab_rms1_cpu_trans_output__out;
double _dq_to_abc3_o_ref__out = 0.0;
double _p_ref3_regd_sys_modbus_device_comp_holding_out__out[2];
double _current_ref1_limit_zero__out = 100.0;
double _modbus_device5_comp_holding_out__out;
...
double _p_ref3_capacity1__out = 35000.0;
double _p_ref3_capacity2__out = 1000.0;
double _current_ref3_one__out = 100.0;
double _dq_to_abc2_o_ref__out = 0.0;
double _p_ref4_regd_sys_modbus_device_comp_coil_out__out;
double _p_ref1_regd_sys_modbus_device_comp_holding_out__out[2];
double _pll3_pll_pid_integrator1__out;
double _p_ref2_capacity1__out = 35000.0;
...
double _constant3__out = 5000.0;
double _pll3_pll_to_hz__out;
double _p_ref1_regd_sys_modbus_device_comp_coil_out__out;
double _s_control_mode1__out;
double _xi_q_ref1__out;
double _vab_rms_cpu_trans_output__out;
double _current_ref_one__out = 100.0;
double _p_ref4_regd_sys_modbus_device_comp_holding_out__out[2];
double _pref_in__out;
double _p_ref2_regd_sys_modbus_device_comp_holding_out__out[2];
...
double _p_ref2_capacity2__out = 1000.0;
...
double _p_ref4_capacity1__out = 35000.0;
...
float _led_19__tmp;
float _led_12__tmp;
double _p_ref3_regd_sys_bus_split1__out;
double _p_ref3_regd_sys_bus_split1__out1;
...
float _led_4__tmp;
double _p_ref1_regd_sys_bus_split1__out;
double _p_ref1_regd_sys_bus_split1__out1;
double _p_ref2_sum4__out;
float _led_15__tmp;
double _product1__out;
double _pll2_pll_sin__out;
double _p_ref3_sum6__out;
double _p_ref3_sum4__out;
double _pll3_2pi__out;
double _p_ref4_regd_sys_bus_split1__out;
double _p_ref4_regd_sys_bus_split1__out1;
double _p_ref2_regd_sys_bus_split1__out;
double _p_ref2_regd_sys_bus_split1__out1;
float _led_13__tmp;
double _p_ref4_regd_sys_bus_join1__out[2];
float _led_7__tmp;
double _p_ref4_regd_sys_bus_join2__out[2];
double _p_ref2_sum6__out;
float _led_20__tmp;
...
double _sum2__out;
double _sum1__out;
X_Int32 _p_ref3_regd_sys_c_function1__temp;
double _p_ref3_regd_sys_c_function1__high;
double _p_ref3_regd_sys_c_function1__low;


X_Int32 _p_ref3_regd_sys_c_function1__regD;
X_Int32 _p_ref1_regd_sys_c_function1__temp;
double _p_ref1_regd_sys_c_function1__high;
double _p_ref1_regd_sys_c_function1__low;


X_Int32 _p_ref1_regd_sys_c_function1__regD;
X_Int32 _p_ref4_regd_sys_c_function1__temp;
double _p_ref4_regd_sys_c_function1__high;
double _p_ref4_regd_sys_c_function1__low;


X_Int32 _p_ref4_regd_sys_c_function1__regD;
X_Int32 _p_ref2_regd_sys_c_function1__temp;
double _p_ref2_regd_sys_c_function1__high;
double _p_ref2_regd_sys_c_function1__low;


X_Int32 _p_ref2_regd_sys_c_function1__regD;
...
double _p_ref3_node_3_c_function1__regd_old;
double _p_ref3_node_3_c_function1__timer;
double _p_ref3_node_3_c_function1__step;
double _p_ref3_node_3_c_function1__regd;


double _p_ref3_node_3_c_function1__set_regd;
double _p_ref1_node_3_c_function1__regd_old;
double _p_ref1_node_3_c_function1__timer;
double _p_ref1_node_3_c_function1__step;
double _p_ref1_node_3_c_function1__regd;


double _p_ref1_node_3_c_function1__set_regd;
double _p_ref4_node_3_c_function1__regd_old;
double _p_ref4_node_3_c_function1__timer;
double _p_ref4_node_3_c_function1__step;
double _p_ref4_node_3_c_function1__regd;


double _p_ref4_node_3_c_function1__set_regd;
double _p_ref2_node_3_c_function1__regd_old;
double _p_ref2_node_3_c_function1__timer;
double _p_ref2_node_3_c_function1__step;
double _p_ref2_node_3_c_function1__regd;


double _p_ref2_node_3_c_function1__set_regd;
...
X_UnInt32 _three_phase_inverter1_igbt_leg1_pwm_modulator__channels[1] = {3};
...
X_UnInt32 _three_phase_inverter1_igbt_leg3_pwm_modulator__channels[1] = {8};
...
X_UnInt32 _three_phase_inverter3_igbt_leg2_pwm_modulator__channels[1] = {11};
...
X_UnInt32 _three_phase_inverter3_igbt_leg3_pwm_modulator__channels[1] = {5};
...
X_UnInt32 _three_phase_inverter3_igbt_leg1_pwm_modulator__channels[1] = {6};
...
X_UnInt32 _three_phase_inverter4_igbt_leg3_pwm_modulator__channels[1] = {10};
...
X_UnInt32 _three_phase_inverter4_igbt_leg1_pwm_modulator__channels[1] = {9};
...
X_UnInt32 _three_phase_inverter4_igbt_leg2_pwm_modulator__channels[1] = {2};
...
X_UnInt32 _three_phase_inverter2_igbt_leg3_pwm_modulator__channels[1] = {4};
...
X_UnInt32 _subsystem1_pid_controller1__av_active;
...
void ReInit_user_sp_cpu_dev0() {
    ...
    _p_ref3_node_3_c_function1__regd_old = 0;
    _p_ref3_node_3_c_function1__timer = 0;
    _p_ref3_node_3_c_function1__step = 30 / 0.0002;
    HIL_OutAO(0x4031, 0.0f);
    HIL_OutAO(0x4035, 0.0f);
    _p_ref1_node_3_c_function1__regd_old = 0;
    _p_ref1_node_3_c_function1__timer = 0;
    _p_ref1_node_3_c_function1__step = 30 / 0.0002;
    _p_ref4_node_3_c_function1__regd_old = 0;
    _p_ref4_node_3_c_function1__timer = 0;
    _p_ref4_node_3_c_function1__step = 30 / 0.0002;
    HIL_OutAO(0x4047, 0.0f);
    HIL_OutAO(0x4043, 0.0f);
    HIL_OutAO(0x4037, 0.0f);
    _p_ref2_node_3_c_function1__regd_old = 0;
    _p_ref2_node_3_c_function1__timer = 0;
    _p_ref2_node_3_c_function1__step = 30 / 0.0002;
    ...
    _three_phase_inverter1_igbt_leg1_pwm_modulator__update_mask = 8;
    ...
    _three_phase_inverter1_igbt_leg3_pwm_modulator__update_mask = 256;
    ...
    _three_phase_inverter3_igbt_leg2_pwm_modulator__update_mask = 2048;
    ...
    _three_phase_inverter3_igbt_leg3_pwm_modulator__update_mask = 32;
    ...
    _three_phase_inverter3_igbt_leg1_pwm_modulator__update_mask = 64;
    ...
    _three_phase_inverter4_igbt_leg3_pwm_modulator__update_mask = 1024;
    ...
    _three_phase_inverter4_igbt_leg1_pwm_modulator__update_mask = 512;
    ...
    _three_phase_inverter4_igbt_leg2_pwm_modulator__update_mask = 4;
    ...
    _three_phase_inverter2_igbt_leg3_pwm_modulator__update_mask = 16;
...
void TimerCounterHandler_0_user_sp_cpu_dev0() {
    ...
    // Generated from the component: ModBus Device5.comp_coil_in
    ...
    HIL_OutAO(0x4070, (float)_input_register_ip__out);
    // Generated from the component: ModBus Device5.comp_reg_in
    ...
    // Generated from the component: ModBus Device5.comp_discrete_in
...
void TimerCounterHandler_1_user_sp_cpu_dev0() {
    ...
    // Generated from the component: P_ref4.capacity2
    ...
    // Generated from the component: ModBus Device5.comp_coil_out
    _modbus_device5_comp_coil_out__out = XIo_InFloat(0x55000150);
    // Generated from the component: S_control_mode
    _s_control_mode__out = XIo_InFloat(0x55000120);
    // Generated from the component: C1
    // Generated from the component: Vab_rms1.cpu_trans.Output
    _vab_rms1_cpu_trans_output__out = XIo_InFloat(0x55000104);
    // Generated from the component: dq to abc3.o_ref
    // Generated from the component: P_ref3.RegD_sys.ModBus Device.comp_holding_out
    _p_ref3_regd_sys_modbus_device_comp_holding_out__out[0] = XIo_InFloat(0x55000174);
    _p_ref3_regd_sys_modbus_device_comp_holding_out__out[1] = XIo_InFloat(0x55000178);
    // Generated from the component: Current_ref1.Limit_zero
    // Generated from the component: ModBus Device5.comp_holding_out
    _modbus_device5_comp_holding_out__out = XIo_InFloat(0x55000154);
    ...
    // Generated from the component: P_ref2.RegD_sys.ModBus Device.comp_coil_out
    _p_ref2_regd_sys_modbus_device_comp_coil_out__out = XIo_InFloat(0x55000164);
    // Generated from the component: P_ref3.RegD_sys.Constant3
    // Generated from the component: P_ref3.RegD_sys.Constant2
    // Generated from the component: P_ref1.capacity2
    // Generated from the component: P_ref1.RegD_sys.Constant3
    // Generated from the component: P_ref3.RegD_sys.ModBus Device.comp_coil_out
    _p_ref3_regd_sys_modbus_device_comp_coil_out__out = XIo_InFloat(0x55000170);
    ...
    // Generated from the component: P_ref3.capacity1
    // Generated from the component: P_ref3.capacity2
    // Generated from the component: Current_ref3.one
    // Generated from the component: dq to abc2.o_ref
    // Generated from the component: P_ref4.RegD_sys.ModBus Device.comp_coil_out
    _p_ref4_regd_sys_modbus_device_comp_coil_out__out = XIo_InFloat(0x5500017c);
    // Generated from the component: P_ref1.RegD_sys.ModBus Device.comp_holding_out
    _p_ref1_regd_sys_modbus_device_comp_holding_out__out[0] = XIo_InFloat(0x5500015c);
    _p_ref1_regd_sys_modbus_device_comp_holding_out__out[1] = XIo_InFloat(0x55000160);
    // Generated from the component: PLL3.PLL.PID.Integrator1
    _pll3_pll_pid_integrator1__out = _pll3_pll_pid_integrator1__state;
    // Generated from the component: P_ref2.capacity1
    ...
    // Generated from the component: P_ref1.RegD_sys.ModBus Device.comp_coil_out
    _p_ref1_regd_sys_modbus_device_comp_coil_out__out = XIo_InFloat(0x55000158);
    ...
    // Generated from the component: Vab_rms.cpu_trans.Output
    _vab_rms_cpu_trans_output__out = XIo_InFloat(0x55000100);
    // Generated from the component: Current_ref.one
    // Generated from the component: P_ref4.RegD_sys.ModBus Device.comp_holding_out
    _p_ref4_regd_sys_modbus_device_comp_holding_out__out[0] = XIo_InFloat(0x55000180);
    _p_ref4_regd_sys_modbus_device_comp_holding_out__out[1] = XIo_InFloat(0x55000184);
    // Generated from the component: Pref_in
    _pref_in__out = XIo_InFloat(0x5500010c);
    // Generated from the component: P_ref2.RegD_sys.ModBus Device.comp_holding_out
    _p_ref2_regd_sys_modbus_device_comp_holding_out__out[0] = XIo_InFloat(0x55000168);
    _p_ref2_regd_sys_modbus_device_comp_holding_out__out[1] = XIo_InFloat(0x5500016c);
    ...
    // Generated from the component: P_ref2.capacity2
    ...
    // Generated from the component: P_ref4.capacity1
    ...
    HIL_OutAO(0x4082, (float)_pll3_pll_unit_delay1__out);
    ...
    // Generated from the component: P_ref2.RegD_sys.ModBus Device.comp_discrete_in
    XIo_OutFloat(0x550001b8, _p_ref2_regd_sys_constant3__out);
    // Generated from the component: Bus Split5
    _bus_split5__out = _modbus_device5_comp_coil_out__out;
    // Generated from the component: coil_out
    HIL_OutAO(0x406f, (float)_modbus_device5_comp_coil_out__out);
    // Generated from the component: P_ref3.RegD_sys.Bus Split1
    _p_ref3_regd_sys_bus_split1__out = _p_ref3_regd_sys_modbus_device_comp_holding_out__out[0];
    _p_ref3_regd_sys_bus_split1__out1 = _p_ref3_regd_sys_modbus_device_comp_holding_out__out[1];
    // Generated from the component: holding_out1
    HIL_OutAO(0x4071, (float)_modbus_device5_comp_holding_out__out);
    // Generated from the component: PLL2.2pi
    _pll2_2pi__out = 6.28318530718 * _pll2_pll_to_hz__out;
    // Generated from the component: P_ref4.RegD_sys.ModBus Device.comp_coil_in
    XIo_OutFloat(0x550001e4, _p_ref4_regd_sys_constant4__out);
    // Generated from the component: wt_pll
    HIL_OutAO(0x407f, (float)_pll_pll_unit_delay1__out);
    ...
    // Generated from the component: Termination7
    // Generated from the component: V3
    HIL_OutAO(0x4066, (float)_constant7__out);
    // Generated from the component: wt_pll1
    HIL_OutAO(0x4080, (float)_pll1_pll_unit_delay1__out);
    ...
    // Generated from the component: P_ref3.RegD_sys.ModBus Device.comp_discrete_in
    ...
    // Generated from the component: P_ref1.RegD_sys.ModBus Device.comp_discrete_in
    XIo_OutFloat(0x550001a0, _p_ref1_regd_sys_constant3__out);
    // Generated from the component: P_ref3.RegD_sys.Termination1
    // Generated from the component: P_ref4.Sum6
    _p_ref4_sum6__out =  - _p_ref4_capacity2__out + _constant4__out;
    ...
    // Generated from the component: P_ref2.RegD_sys.ModBus Device.comp_coil_in
    ...
    // Generated from the component: P_ref1.RegD_sys.Bus Split1
    _p_ref1_regd_sys_bus_split1__out = _p_ref1_regd_sys_modbus_device_comp_holding_out__out[0];
    _p_ref1_regd_sys_bus_split1__out1 = _p_ref1_regd_sys_modbus_device_comp_holding_out__out[1];
    // Generated from the component: P_ref2.Sum4
    _p_ref2_sum4__out =  - _constant2__out + _p_ref2_capacity1__out;
    // Generated from the component: Product1
    _product1__out = (_vab_rms1_cpu_trans_output__out) * 1.0 / (_constant5__out);
    ...
    HIL_OutAO(0x4081, (float)_pll2_pll_unit_delay1__out);
    // Generated from the component: P_ref1.RegD_sys.ModBus Device.comp_coil_in
    XIo_OutFloat(0x5500019c, _p_ref1_regd_sys_constant4__out);
    // Generated from the component: P_ref3.Sum6
    _p_ref3_sum6__out =  - _p_ref3_capacity2__out + _constant3__out;
    // Generated from the component: P_ref3.Sum4
    _p_ref3_sum4__out =  - _constant3__out + _p_ref3_capacity1__out;
    ...
    // Generated from the component: P_ref4.RegD_sys.Bus Split1
    _p_ref4_regd_sys_bus_split1__out = _p_ref4_regd_sys_modbus_device_comp_holding_out__out[0];
    _p_ref4_regd_sys_bus_split1__out1 = _p_ref4_regd_sys_modbus_device_comp_holding_out__out[1];
    // Generated from the component: Termination1
    // Generated from the component: Pref_out
    HIL_OutAO(0x404e, (float)_pref_in__out);
    // Generated from the component: P_ref2.RegD_sys.Bus Split1
    _p_ref2_regd_sys_bus_split1__out = _p_ref2_regd_sys_modbus_device_comp_holding_out__out[0];
    _p_ref2_regd_sys_bus_split1__out1 = _p_ref2_regd_sys_modbus_device_comp_holding_out__out[1];
    ...
    // Generated from the component: P_ref2.Sum6
    _p_ref2_sum6__out =  - _p_ref2_capacity2__out + _constant2__out;
    // Generated from the component: P_ref3.RegD_sys.ModBus Device.comp_coil_in
    XIo_OutFloat(0x550001cc, _p_ref3_regd_sys_constant4__out);
    // Generated from the component: Product2
    _product2__out = (_vab_rms_cpu_trans_output__out) * 1.0 / (_constant6__out);
    // Generated from the component: P_ref4.RegD_sys.ModBus Device.comp_discrete_in
    XIo_OutFloat(0x550001e8, _p_ref4_regd_sys_constant3__out);
    // Generated from the component: P_ref4.Sum4
    _p_ref4_sum4__out =  - _constant4__out + _p_ref4_capacity1__out;
    ...
    HIL_OutAO(0x407d, (float)_s_meas3_power_meter1__k_factor);
    // Generated from the component: Q4
    HIL_OutAO(0x4054, (float)_s_meas3_power_meter1__Qdc);
    // Generated from the component: S4
    HIL_OutAO(0x4059, (float)_s_meas3_power_meter1__apparent);
    ...
    HIL_OutAO(0x4052, (float)_s_meas1_power_meter1__Qdc);
    // Generated from the component: S_meas1.Termination1
    // Generated from the component: S2
    HIL_OutAO(0x4057, (float)_s_meas1_power_meter1__apparent);
    // Generated from the component: pf2
    HIL_OutAO(0x407b, (float)_s_meas1_power_meter1__k_factor);
    ...
    HIL_OutAO(0x4051, (float)_power_meter1__Qdc);
    ...
    HIL_OutAO(0x407a, (float)_s_meas_power_meter1__k_factor);
    // Generated from the component: Q1
    HIL_OutAO(0x4050, (float)_s_meas_power_meter1__Qdc);
    // Generated from the component: S1
    HIL_OutAO(0x4056, (float)_s_meas_power_meter1__apparent);
    ...
    HIL_OutAO(0x407e, (float)_s_meas_1_power_meter1__k_factor);
    ...
    HIL_OutAO(0x4055, (float)_s_meas_1_power_meter1__Qdc);
    ...
    HIL_OutAO(0x405a, (float)_s_meas_1_power_meter1__apparent);
    ...
    HIL_OutAO(0x4058, (float)_s_meas2_power_meter1__apparent);
    // Generated from the component: S_meas2.Termination2
    // Generated from the component: pf3
    HIL_OutAO(0x407c, (float)_s_meas2_power_meter1__k_factor);
    // Generated from the component: Q3
    HIL_OutAO(0x4053, (float)_s_meas2_power_meter1__Qdc);
    ...
    // Generated from the component: P_ref2.RegD_sys.ModBus Device.comp_reg_in
    XIo_OutFloat(0x550001c4, _p_ref2_regd_sys_bus_join1__out[0]);
    XIo_OutFloat(0x550001c8, _p_ref2_regd_sys_bus_join1__out[1]);
    // Generated from the component: P_ref2.RegD_sys.ModBus Device.comp_holding_in
    ...
    // Generated from the component: P_ref3.RegD_sys.C function1
    _p_ref3_regd_sys_c_function1__high = _p_ref3_regd_sys_bus_split1__out;
    _p_ref3_regd_sys_c_function1__low = _p_ref3_regd_sys_bus_split1__out1;
    _p_ref3_regd_sys_c_function1__temp = (((X_Int32)_p_ref3_regd_sys_c_function1__high << 16) & -65536) | ((X_Int32)_p_ref3_regd_sys_c_function1__low & 65535);
    if (_p_ref3_regd_sys_c_function1__temp < 1e7 && _p_ref3_regd_sys_c_function1__temp > -1e7)_p_ref3_regd_sys_c_function1__regD = _p_ref3_regd_sys_c_function1__temp;
    else if (_p_ref3_regd_sys_c_function1__temp == 1e7)_p_ref3_regd_sys_c_function1__regD = 1e7;
    else if (_p_ref3_regd_sys_c_function1__temp == -1e7)_p_ref3_regd_sys_c_function1__regD = -1e7;
    else if (_p_ref3_regd_sys_c_function1__temp > 1e7)_p_ref3_regd_sys_c_function1__regD = 2e7;
    else if (_p_ref3_regd_sys_c_function1__temp < -1e7)_p_ref3_regd_sys_c_function1__regD = -2e7;
    // Generated from the component: P_ref3.RegD_sys.output_register 2
    HIL_OutAO(0x4040, (float)_p_ref3_regd_sys_bus_split1__out1);
    // Generated from the component: P_ref3.RegD_sys.output_register 1
    HIL_OutAO(0x403f, (float)_p_ref3_regd_sys_bus_split1__out);
    // Generated from the component: PLL.Termination3
    // Generated from the component: PLL1.Termination3
    // Generated from the component: P_ref3.RegD_sys.ModBus Device.comp_holding_in
    XIo_OutFloat(0x550001d4, _p_ref3_regd_sys_bus_join2__out[0]);
    XIo_OutFloat(0x550001d8, _p_ref3_regd_sys_bus_join2__out[1]);
    // Generated from the component: P_ref3.RegD_sys.ModBus Device.comp_reg_in
    XIo_OutFloat(0x550001dc, _p_ref3_regd_sys_bus_join1__out[0]);
    XIo_OutFloat(0x550001e0, _p_ref3_regd_sys_bus_join1__out[1]);
    // Generated from the component: P_ref1.RegD_sys.ModBus Device.comp_reg_in
    XIo_OutFloat(0x550001ac, _p_ref1_regd_sys_bus_join1__out[0]);
    XIo_OutFloat(0x550001b0, _p_ref1_regd_sys_bus_join1__out[1]);
    // Generated from the component: P_ref1.RegD_sys.ModBus Device.comp_holding_in
    XIo_OutFloat(0x550001a4, _p_ref1_regd_sys_bus_join2__out[0]);
    XIo_OutFloat(0x550001a8, _p_ref1_regd_sys_bus_join2__out[1]);
    // Generated from the component: P_ref1.RegD_sys.output_register 1
    HIL_OutAO(0x4033, (float)_p_ref1_regd_sys_bus_split1__out);
    // Generated from the component: P_ref1.RegD_sys.C function1
    _p_ref1_regd_sys_c_function1__high = _p_ref1_regd_sys_bus_split1__out;
    _p_ref1_regd_sys_c_function1__low = _p_ref1_regd_sys_bus_split1__out1;
    _p_ref1_regd_sys_c_function1__temp = (((X_Int32)_p_ref1_regd_sys_c_function1__high << 16) & -65536) | ((X_Int32)_p_ref1_regd_sys_c_function1__low & 65535);
    if (_p_ref1_regd_sys_c_function1__temp < 1e7 && _p_ref1_regd_sys_c_function1__temp > -1e7)_p_ref1_regd_sys_c_function1__regD = _p_ref1_regd_sys_c_function1__temp;
    else if (_p_ref1_regd_sys_c_function1__temp == 1e7)_p_ref1_regd_sys_c_function1__regD = 1e7;
    else if (_p_ref1_regd_sys_c_function1__temp == -1e7)_p_ref1_regd_sys_c_function1__regD = -1e7;
    else if (_p_ref1_regd_sys_c_function1__temp > 1e7)_p_ref1_regd_sys_c_function1__regD = 2e7;
    else if (_p_ref1_regd_sys_c_function1__temp < -1e7)_p_ref1_regd_sys_c_function1__regD = -2e7;
    // Generated from the component: P_ref1.RegD_sys.output_register 2
    HIL_OutAO(0x4034, (float)_p_ref1_regd_sys_bus_split1__out1);
    // Generated from the component: V1
    HIL_OutAO(0x4064, (float)_product1__out);
    // Generated from the component: PLL2.Termination3
    // Generated from the component: P_ref4.RegD_sys.output_register 2
    HIL_OutAO(0x4046, (float)_p_ref4_regd_sys_bus_split1__out1);
    // Generated from the component: P_ref4.RegD_sys.output_register 1
    HIL_OutAO(0x4045, (float)_p_ref4_regd_sys_bus_split1__out);
    // Generated from the component: P_ref4.RegD_sys.C function1
    _p_ref4_regd_sys_c_function1__high = _p_ref4_regd_sys_bus_split1__out;
    _p_ref4_regd_sys_c_function1__low = _p_ref4_regd_sys_bus_split1__out1;
    _p_ref4_regd_sys_c_function1__temp = (((X_Int32)_p_ref4_regd_sys_c_function1__high << 16) & -65536) | ((X_Int32)_p_ref4_regd_sys_c_function1__low & 65535);
    if (_p_ref4_regd_sys_c_function1__temp < 1e7 && _p_ref4_regd_sys_c_function1__temp > -1e7)_p_ref4_regd_sys_c_function1__regD = _p_ref4_regd_sys_c_function1__temp;
    else if (_p_ref4_regd_sys_c_function1__temp == 1e7)_p_ref4_regd_sys_c_function1__regD = 1e7;
    else if (_p_ref4_regd_sys_c_function1__temp == -1e7)_p_ref4_regd_sys_c_function1__regD = -1e7;
    else if (_p_ref4_regd_sys_c_function1__temp > 1e7)_p_ref4_regd_sys_c_function1__regD = 2e7;
    else if (_p_ref4_regd_sys_c_function1__temp < -1e7)_p_ref4_regd_sys_c_function1__regD = -2e7;
    // Generated from the component: P_ref2.RegD_sys.output_register 1
    HIL_OutAO(0x4039, (float)_p_ref2_regd_sys_bus_split1__out);
    // Generated from the component: P_ref2.RegD_sys.output_register 2
    HIL_OutAO(0x403a, (float)_p_ref2_regd_sys_bus_split1__out1);
    // Generated from the component: P_ref2.RegD_sys.C function1
    _p_ref2_regd_sys_c_function1__high = _p_ref2_regd_sys_bus_split1__out;
    _p_ref2_regd_sys_c_function1__low = _p_ref2_regd_sys_bus_split1__out1;
    _p_ref2_regd_sys_c_function1__temp = (((X_Int32)_p_ref2_regd_sys_c_function1__high << 16) & -65536) | ((X_Int32)_p_ref2_regd_sys_c_function1__low & 65535);
    if (_p_ref2_regd_sys_c_function1__temp < 1e7 && _p_ref2_regd_sys_c_function1__temp > -1e7)_p_ref2_regd_sys_c_function1__regD = _p_ref2_regd_sys_c_function1__temp;
    else if (_p_ref2_regd_sys_c_function1__temp == 1e7)_p_ref2_regd_sys_c_function1__regD = 1e7;
    else if (_p_ref2_regd_sys_c_function1__temp == -1e7)_p_ref2_regd_sys_c_function1__regD = -1e7;
    else if (_p_ref2_regd_sys_c_function1__temp > 1e7)_p_ref2_regd_sys_c_function1__regD = 2e7;
    else if (_p_ref2_regd_sys_c_function1__temp < -1e7)_p_ref2_regd_sys_c_function1__regD = -2e7;
    // Generated from the component: P_ref4.RegD_sys.ModBus Device.comp_reg_in
    XIo_OutFloat(0x550001f4, _p_ref4_regd_sys_bus_join1__out[0]);
    XIo_OutFloat(0x550001f8, _p_ref4_regd_sys_bus_join1__out[1]);
    // Generated from the component: P_ref4.RegD_sys.ModBus Device.comp_holding_in
    ...
    HIL_OutAO(0x4065, (float)_product2__out);
    // Generated from the component: iq4
    HIL_OutAO(0x4079, (float)_current_abc_to_dq3_abc_to_dq1_alpha_beta_to_dq__q);
    ...
    HIL_OutAO(0x4075, (float)_current_abc_to_dq3_abc_to_dq1_alpha_beta_to_dq__d);
    ...
    HIL_OutAO(0x4073, (float)_current_abc_to_dq1_abc_to_dq1_alpha_beta_to_dq__d);
    // Generated from the component: iq1
    HIL_OutAO(0x4077, (float)_current_abc_to_dq1_abc_to_dq1_alpha_beta_to_dq__q);
    ...
    HIL_OutAO(0x4048, (float)_trigonometric_function1__out);
    // Generated from the component: iq
    HIL_OutAO(0x4076, (float)_current_abc_to_dq_abc_to_dq1_alpha_beta_to_dq__q);
    ...
    HIL_OutAO(0x4072, (float)_current_abc_to_dq_abc_to_dq1_alpha_beta_to_dq__d);
    ...
    HIL_OutAO(0x4049, (float)_trigonometric_function2__out);
    // Generated from the component: ModBus Device5.comp_holding_in
    XIo_OutFloat(0x55000190, _bus_join5__out[0]);
    XIo_OutFloat(0x55000194, _bus_join5__out[1]);
    // Generated from the component: iq2
    HIL_OutAO(0x4078, (float)_current_abc_to_dq2_abc_to_dq1_alpha_beta_to_dq__q);
    ...
    HIL_OutAO(0x4074, (float)_current_abc_to_dq2_abc_to_dq1_alpha_beta_to_dq__d);
    ...
    HIL_OutAO(0x405b, (float)_sum2__out);
    // Generated from the component: Ptotal
    HIL_OutAO(0x404f, (float)_sum1__out);
    // Generated from the component: P_ref3.RegD_sys.Product2
    _p_ref3_regd_sys_product2__out = (_p_ref3_regd_sys_c_function1__regD) * 1.0 / (_p_ref3_regd_sys_constant7__out);
    // Generated from the component: P_ref3.RegD_sys.Regulation Data
    HIL_OutAO(0x403e, (float)_p_ref3_regd_sys_c_function1__regD);
    // Generated from the component: P_ref1.RegD_sys.Product2
    _p_ref1_regd_sys_product2__out = (_p_ref1_regd_sys_c_function1__regD) * 1.0 / (_p_ref1_regd_sys_constant7__out);
    // Generated from the component: P_ref1.RegD_sys.Regulation Data
    HIL_OutAO(0x4032, (float)_p_ref1_regd_sys_c_function1__regD);
    // Generated from the component: P_ref4.RegD_sys.Product2
    _p_ref4_regd_sys_product2__out = (_p_ref4_regd_sys_c_function1__regD) * 1.0 / (_p_ref4_regd_sys_constant7__out);
    // Generated from the component: P_ref4.RegD_sys.Regulation Data
    HIL_OutAO(0x4044, (float)_p_ref4_regd_sys_c_function1__regD);
    // Generated from the component: P_ref2.RegD_sys.Regulation Data
    HIL_OutAO(0x4038, (float)_p_ref2_regd_sys_c_function1__regD);
    // Generated from the component: P_ref2.RegD_sys.Product2
    _p_ref2_regd_sys_product2__out = (_p_ref2_regd_sys_c_function1__regD) * 1.0 / (_p_ref2_regd_sys_constant7__out);
    ...
    HIL_OutAO(0x403d, (float)_p_ref3_regd_sys_product2__out);
    // Generated from the component: P_ref3.RegD_sys.regD
    HIL_OutAO(0x4041, (float)_p_ref3_regd_sys_product2__out);
    // Generated from the component: P_ref3.Node_3_C_Function1
    _p_ref3_node_3_c_function1__regd = _p_ref3_regd_sys_product2__out;
    if (fmod(_p_ref3_node_3_c_function1__timer, _p_ref3_node_3_c_function1__step) == 0) {
        _p_ref3_node_3_c_function1__timer = 0;
        if (_p_ref3_node_3_c_function1__regd_old == _p_ref3_node_3_c_function1__regd)_p_ref3_node_3_c_function1__set_regd = 0;
        else _p_ref3_node_3_c_function1__set_regd = _p_ref3_node_3_c_function1__regd;
        _p_ref3_node_3_c_function1__regd_old = _p_ref3_node_3_c_function1__regd;
    }
    else _p_ref3_node_3_c_function1__set_regd = _p_ref3_node_3_c_function1__regd;
    // Generated from the component: P_ref1.RegD_act1
    HIL_OutAO(0x4031, (float)_p_ref1_regd_sys_product2__out);
    // Generated from the component: P_ref1.RegD_sys.regD
    HIL_OutAO(0x4035, (float)_p_ref1_regd_sys_product2__out);
    // Generated from the component: P_ref1.Node_3_C_Function1
    _p_ref1_node_3_c_function1__regd = _p_ref1_regd_sys_product2__out;
    if (fmod(_p_ref1_node_3_c_function1__timer, _p_ref1_node_3_c_function1__step) == 0) {
        _p_ref1_node_3_c_function1__timer = 0;
        if (_p_ref1_node_3_c_function1__regd_old == _p_ref1_node_3_c_function1__regd)_p_ref1_node_3_c_function1__set_regd = 0;
        else _p_ref1_node_3_c_function1__set_regd = _p_ref1_node_3_c_function1__regd;
        _p_ref1_node_3_c_function1__regd_old = _p_ref1_node_3_c_function1__regd;
    }
    else _p_ref1_node_3_c_function1__set_regd = _p_ref1_node_3_c_function1__regd;
    // Generated from the component: P_ref4.Node_3_C_Function1
    _p_ref4_node_3_c_function1__regd = _p_ref4_regd_sys_product2__out;
    if (fmod(_p_ref4_node_3_c_function1__timer, _p_ref4_node_3_c_function1__step) == 0) {
        _p_ref4_node_3_c_function1__timer = 0;
        if (_p_ref4_node_3_c_function1__regd_old == _p_ref4_node_3_c_function1__regd)_p_ref4_node_3_c_function1__set_regd = 0;
        else _p_ref4_node_3_c_function1__set_regd = _p_ref4_node_3_c_function1__regd;
        _p_ref4_node_3_c_function1__regd_old = _p_ref4_node_3_c_function1__regd;
    }
    else _p_ref4_node_3_c_function1__set_regd = _p_ref4_node_3_c_function1__regd;
    // Generated from the component: P_ref4.RegD_sys.regD
    HIL_OutAO(0x4047, (float)_p_ref4_regd_sys_product2__out);
    ...
    HIL_OutAO(0x4037, (float)_p_ref2_regd_sys_product2__out);
    // Generated from the component: P_ref2.Node_3_C_Function1
    _p_ref2_node_3_c_function1__regd = _p_ref2_regd_sys_product2__out;
    if (fmod(_p_ref2_node_3_c_function1__timer, _p_ref2_node_3_c_function1__step) == 0) {
        _p_ref2_node_3_c_function1__timer = 0;
        if (_p_ref2_node_3_c_function1__regd_old == _p_ref2_node_3_c_function1__regd)_p_ref2_node_3_c_function1__set_regd = 0;
        else _p_ref2_node_3_c_function1__set_regd = _p_ref2_node_3_c_function1__regd;
        _p_ref2_node_3_c_function1__regd_old = _p_ref2_node_3_c_function1__regd;
    }
    else _p_ref2_node_3_c_function1__set_regd = _p_ref2_node_3_c_function1__regd;
    // Generated from the component: P_ref2.RegD_sys.regD
    HIL_OutAO(0x403b, (float)_p_ref2_regd_sys_product2__out);
    ...
    _p_ref3_product3__out = (_p_ref3_node_3_c_function1__set_regd * _p_ref3_sum4__out);
    // Generated from the component: P_ref3.Product2
    _p_ref3_product2__out = (_p_ref3_node_3_c_function1__set_regd * _p_ref3_sum6__out);
    // Generated from the component: P_ref3.RegD_3
    HIL_OutAO(0x403c, (float)_p_ref3_node_3_c_function1__set_regd);
    // Generated from the component: P_ref1.Product3
    _p_ref1_product3__out = (_p_ref1_capacity2__out * _p_ref1_node_3_c_function1__set_regd);
    // Generated from the component: P_ref1.RegD_3
    HIL_OutAO(0x4030, (float)_p_ref1_node_3_c_function1__set_regd);
    // Generated from the component: P_ref4.Product3
    _p_ref4_product3__out = (_p_ref4_node_3_c_function1__set_regd * _p_ref4_sum4__out);
    // Generated from the component: P_ref4.RegD_3
    HIL_OutAO(0x4042, (float)_p_ref4_node_3_c_function1__set_regd);
    // Generated from the component: P_ref4.Product2
    _p_ref4_product2__out = (_p_ref4_node_3_c_function1__set_regd * _p_ref4_sum6__out);
    // Generated from the component: P_ref2.Product3
    _p_ref2_product3__out = (_p_ref2_node_3_c_function1__set_regd * _p_ref2_sum4__out);
    // Generated from the component: P_ref2.RegD_3
    HIL_OutAO(0x4036, (float)_p_ref2_node_3_c_function1__set_regd);
    // Generated from the component: P_ref2.Product2
    _p_ref2_product2__out = (_p_ref2_node_3_c_function1__set_regd * _p_ref2_sum6__out);
    ...
    _p_ref3_signal_switch1__out = (_p_ref3_node_3_c_function1__set_regd < 0.0f) ? _p_ref3_product2__out : _p_ref3_product3__out;
    // Generated from the component: Current_ref.Product3
    _current_ref_product3__out = (_pll_pll_abc_to_dq_lpf_q__out * _p_ref1_product3__out);
    // Generated from the component: Current_ref.Pref_probe
    HIL_OutAO(0x4018, (float)_p_ref1_product3__out);
    // Generated from the component: Pref1
    HIL_OutAO(0x404a, (float)_p_ref1_product3__out);
    // Generated from the component: Current_ref.Product5
    _current_ref_product5__out = (_p_ref1_product3__out * _pll_pll_abc_to_dq_lpf_d__out);
    // Generated from the component: P_ref4.Signal switch1
    _p_ref4_signal_switch1__out = (_p_ref4_node_3_c_function1__set_regd < 0.0f) ? _p_ref4_product2__out : _p_ref4_product3__out;
    // Generated from the component: P_ref2.Signal switch1
    _p_ref2_signal_switch1__out = (_p_ref2_node_3_c_function1__set_regd < 0.0f) ? _p_ref2_product2__out : _p_ref2_product3__out;
    ...
    // Generated from the component: P_ref3.Sum5
    _p_ref3_sum5__out = _constant3__out + _p_ref3_signal_switch1__out;
    ...
    // Generated from the component: P_ref4.Sum5
    _p_ref4_sum5__out = _constant4__out + _p_ref4_signal_switch1__out;
    // Generated from the component: P_ref2.Sum5
    _p_ref2_sum5__out = _constant2__out + _p_ref2_signal_switch1__out;
    ...
    // Generated from the component: Current_ref3.Mathematical function1
    _current_ref3_mathematical_function1__out = sqrt(_current_ref3_signal_switch1__out);
    ...
    // Generated from the component: Current_ref1.Mathematical function1
    _current_ref1_mathematical_function1__out = sqrt(_current_ref1_signal_switch1__out);
    ...
    // Generated from the component: Current_ref2.Mathematical function1
    _current_ref2_mathematical_function1__out = sqrt(_current_ref2_signal_switch1__out);
    ...
    HIL_OutAO(0x404c, (float)_p_ref3_sum5__out);
    // Generated from the component: Current_ref2.Pref_probe
    HIL_OutAO(0x401e, (float)_p_ref3_sum5__out);
    // Generated from the component: Current_ref2.Product3
    _current_ref2_product3__out = (_pll2_pll_abc_to_dq_lpf_q__out * _p_ref3_sum5__out);
    // Generated from the component: Current_ref2.Product5
    _current_ref2_product5__out = (_p_ref3_sum5__out * _pll2_pll_abc_to_dq_lpf_d__out);
    ...
    _current_ref3_product3__out = (_pll3_pll_abc_to_dq_lpf_q__out * _p_ref4_sum5__out);
    // Generated from the component: Current_ref3.Product5
    _current_ref3_product5__out = (_p_ref4_sum5__out * _pll3_pll_abc_to_dq_lpf_d__out);
    // Generated from the component: Current_ref3.Pref_probe
    HIL_OutAO(0x4021, (float)_p_ref4_sum5__out);
    // Generated from the component: Pref4
    HIL_OutAO(0x404d, (float)_p_ref4_sum5__out);
    // Generated from the component: Pref2
    HIL_OutAO(0x404b, (float)_p_ref2_sum5__out);
    // Generated from the component: Current_ref1.Pref_probe
    HIL_OutAO(0x401b, (float)_p_ref2_sum5__out);
    // Generated from the component: Current_ref1.Product3
    _current_ref1_product3__out = (_pll1_pll_abc_to_dq_lpf_q__out * _p_ref2_sum5__out);
    // Generated from the component: Current_ref1.Product5
    _current_ref1_product5__out = (_p_ref2_sum5__out * _pll1_pll_abc_to_dq_lpf_d__out);
    ...
    HIL_OutAO(0x406b, (float)_signal_switch2__out);
    // Generated from the component: Subsystem1.Sum1
    _subsystem1_sum1__out =  - _current_abc_to_dq_abc_to_dq1_alpha_beta_to_dq__d + _signal_switch1__out;
    // Generated from the component: Xi_d_ref_res
    HIL_OutAO(0x4067, (float)_signal_switch1__out);
    ...
    _subsystem1_pid_controller1__pi_reg_out_int = _subsystem1_pid_controller1__integrator_state + 0.015 * _subsystem1_sum1__out;
    if (_subsystem1_pid_controller1__pi_reg_out_int < -1.0) {
        _subsystem1_pid_controller1__out = -1.0;
        _subsystem1_pid_controller1__av_active = 1;
    } else if (_subsystem1_pid_controller1__pi_reg_out_int > 1.0) {
        _subsystem1_pid_controller1__out = 1.0;
        _subsystem1_pid_controller1__av_active = 1;
    } else {
        _subsystem1_pid_controller1__out = _subsystem1_pid_controller1__pi_reg_out_int;
        _subsystem1_pid_controller1__av_active = 0;
    }
    ...
    HIL_OutAO(0x406d, (float)_signal_switch5__out);
    ...
    HIL_OutAO(0x4069, (float)_signal_switch6__out);
    ...
    _subsystem1_sum3__out = _subsystem1_pid_controller1__out + _subsystem1_product3__out;
    // Generated from the component: Xi_q_ref_res4
    HIL_OutAO(0x406e, (float)_signal_switch7__out);
    ...
    HIL_OutAO(0x406a, (float)_signal_switch8__out);
    ...
    HIL_OutAO(0x406c, (float)_signal_switch3__out);
    // Generated from the component: Xi_d_ref_res1
    HIL_OutAO(0x4068, (float)_signal_switch4__out);
    ...
    HIL_OutAO(0x4060, (float)_subsystem1_sum7__out);
    ...
    HIL_OutAO(0x405c, (float)_subsystem1_sum3__out);
    ...
    HIL_OutAO(0x4062, (float)_subsystem3_sum7__out);
    // Generated from the component: Ud2
    HIL_OutAO(0x405e, (float)_subsystem3_sum3__out);
    ...
    HIL_OutAO(0x4063, (float)_subsystem4_sum7__out);
    ...
    HIL_OutAO(0x405f, (float)_subsystem4_sum3__out);
    // Generated from the component: Uq1
    HIL_OutAO(0x4061, (float)_subsystem2_sum7__out);
    ...
    HIL_OutAO(0x405d, (float)_subsystem2_sum3__out);
    ...
    // Generated from the component: PLL2.PLL.normalize
    // Generated from the component: P_ref3.Node_3_C_Function1
    _p_ref3_node_3_c_function1__timer += 1;
    // Generated from the component: P_ref1.Node_3_C_Function1
    _p_ref1_node_3_c_function1__timer += 1;
    // Generated from the component: P_ref4.Node_3_C_Function1
    _p_ref4_node_3_c_function1__timer += 1;
    // Generated from the component: P_ref2.Node_3_C_Function1
    _p_ref2_node_3_c_function1__timer += 1;
    // Generated from the component: Current_ref3.Comparator1
    if (_squared_vt3_sum3__out < _current_ref3_limit_zero__out) {
    ...
    if (!_subsystem1_pid_controller2__av_active) {
        _subsystem1_pid_controller2__integrator_state += 1.0 * _subsystem1_sum2__out * 0.0002;
    }
    // Generated from the component: Subsystem1.PID controller1
    if (!_subsystem1_pid_controller1__av_active) {
        _subsystem1_pid_controller1__integrator_state += 1.0 * _subsystem1_sum1__out * 0.0002;
    }
    // Generated from the component: Subsystem3.PID controller2
    if (!_subsystem3_pid_controller2__av_active) {
        _subsystem3_pid_controller2__integrator_state += 1.0 * _subsystem3_sum2__out * 0.0002;
    }
    // Generated from the component: Subsystem3.PID controller1
    if (!_subsystem3_pid_controller1__av_active) {
        _subsystem3_pid_controller1__integrator_state += 1.0 * _subsystem3_sum1__out * 0.0002;
    }
    // Generated from the component: Subsystem4.PID controller2
    if (!_subsystem4_pid_controller2__av_active) {
        _subsystem4_pid_controller2__integrator_state += 1.0 * _subsystem4_sum2__out * 0.0002;
    }
    // Generated from the component: Subsystem4.PID controller1
    if (!_subsystem4_pid_controller1__av_active) {
        _subsystem4_pid_controller1__integrator_state += 1.0 * _subsystem4_sum1__out * 0.0002;
    }
    // Generated from the component: Subsystem2.PID controller2
    if (!_subsystem2_pid_controller2__av_active) {
        _subsystem2_pid_controller2__integrator_state += 1.0 * _subsystem2_sum2__out * 0.0002;
    }
    // Generated from the component: Subsystem2.PID controller1
    if (!_subsystem2_pid_controller1__av_active) {
        _subsystem2_pid_controller1__integrator_state += 1.0 * _subsystem2_sum1__out * 0.0002;
    }
    //@cmp.update.block.end
}
// ----------------------------------------------------------------------------------------  //-----------------------------------------------------------------------------------------