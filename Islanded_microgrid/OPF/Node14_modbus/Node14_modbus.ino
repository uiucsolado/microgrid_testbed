...
OLocalVertex s = OLocalVertex(0x415DB664,0,0.0479*D_base,-1.5*base,0.5*base,5,D_base,14);
//OLocalVertex s = OLocalVertex(0x415DB664,0,0,-1.5*base,0.5*base,5,D_base,14);
OGraph g = OGraph(&s);
