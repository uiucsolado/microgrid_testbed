...
OLocalVertex s = OLocalVertex(0x4151C688,0,0.0679*D_base,-1.5*base,0.5*base,4,D_base,5);  //#NODE
//OLocalVertex s = OLocalVertex(0x4151C688,0,1*D_base,-2.1667*base,0.1667*base,5,D_base); //changed Dout to 1, OLocalVertex(0x404980AE,-0.1*base,0.05*base,-2.1667*base,0.1667*base,1,base); //SN The Xbee address  needs to be changed here right? Also  figure out how to assign the 
