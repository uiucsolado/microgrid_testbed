...
OLocalVertex s = OLocalVertex(0x415DB673,0,0.0479*D_base,-1.5*base,0.5*base,5,D_base,15);
//OLocalVertex s = OLocalVertex(0x415DB673,0,0,-1.5*base,0.5*base,5,D_base,15);
OGraph g = OGraph(&s);
