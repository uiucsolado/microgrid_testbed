...
void loop() {
  ...
  else 
  {
    if(a.isSynced())
    {
     ...
     // deltaQ = a.voltageControl_dist(v_error0,1,5,0.5,q_level0,0.707,-0.707,-0.225736,0.333333,50,200,3,0.001);
//voltageControl(deltaV,Vref,secPercentage,p,q_level0,qtop,qbottom,S,alphaVC,iterations,period,diameter,epsilon ) 
      ...
      //f_error1 = a.fairsplitRatioConsensus_RSL(f_error0,D,10,500);
