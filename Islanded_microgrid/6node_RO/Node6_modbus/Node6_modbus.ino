...
OLocalVertex s = OLocalVertex(0x4151C6AB,0,0.0479*D_base,-1.5*base,0.5*base,5,D_base,6);
//OLocalVertex s = OLocalVertex(0x4151C6AB,0,0,-1.5*base,0.5*base,5,D_base);
OGraph g = OGraph(&s);
...
void setup()  {
 ...
 //g.addInNeighbor(0x4151C6AB); // node 6
  ...
  //g.addInNeighbor(0x415DB681); // node 16
  ...
  if(de == false) {
   Serial.println("Still trying to sync");
    ...
    if(a.isSynced()) {
      ...
      //a.nonleaderFairSplitRatioConsensus(D_base,6);
