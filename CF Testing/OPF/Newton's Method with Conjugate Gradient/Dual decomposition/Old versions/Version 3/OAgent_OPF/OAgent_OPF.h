...
class OAgent_OPF {
	public:
        ...
        float RunRatioConsensus(uint16_t nodeID,float *mu,float *nu,uint8_t iterations,uint8_t *neighbors,int num_neighbors,bool self_flags[NUM_REMOTE_VERTICES],bool neighbor_flags[NUM_REMOTE_VERTICES],float old_data[NUM_REMOTE_VERTICES],uint8_t task);
        ...
        void _SendToChild(uint16_t recipientID, bool flag_OPF, float num1, float num2, float num3, float num4, uint8_t task);
        void _SendToParent(uint16_t recipientID, bool flag_OPF, float num1, float num2, float num3, float num4, uint8_t task);
        void _CG_RC_SendPacket(float mu, float nu, uint8_t k, uint8_t task);
