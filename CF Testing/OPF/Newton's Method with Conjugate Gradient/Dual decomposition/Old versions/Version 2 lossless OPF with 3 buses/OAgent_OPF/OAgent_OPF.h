...
class OAgent_OPF {
	public:
        ...
        void _SendToChild(uint16_t recipientID, bool flag_OPF, float data,uint8_t task);
        void _SendToParent(uint16_t recipientID, bool flag_OPF, float data, uint8_t task);
