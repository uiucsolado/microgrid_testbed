...
#define BASE                             10000000000000  // base for transmitting decimals
...
class OAgent_OPF {
	public:
        ...
        void setup_Newton_method_opf(float *N_T,float *buf2,float *Hessian_lambda,float *tmp,float *g);
        ...
        void _sender_helper(float x,uint8_t* sign_y,uint64_t* y);
        void _SendToChild(uint16_t recipientID, float num1, float num2, float num3, float num4, uint8_t task);
        void _SendToParent(uint16_t recipientID, float num1, float num2, float num3, float num4, uint8_t task);
        void _CG_RC_SendPacket(float mu, float nu);
        double* _CG_RC_ReceivePacket();
        double* _getPacketFromChild();
        double* _getPacketFromParent();
