...
#define NUM_IN_NEIGHBORS 5         //maximum allowed number of neighbors (does not include itself)
//#define NULL 0
...
class OLocalVertex : public OVertex {
    public:
        ...
        inline float getMaxActivePower() { return _Pmax; }
        inline float getMinActivePower() { return _Pmin; }
        inline float getMaxReactivePower() { return _Qmax; }
        inline float getMinReactivePower() { return _Qmin; }
        inline float getMaxVoltage() { return _Vmax; }
        inline float getMinVoltage() { return _Vmin; }
        ...
        inline void setMaxActivePower(float Pmax) {_Pmax = Pmax; }
        inline void setMaxReactivePower(float Qmax) {_Qmax = Qmax; }
        inline void setMinActivePower(float Pmin) {_Pmin = Pmin; }
        inline void setMinReactivePower(float Qmin) {_Qmin = Qmin; }
        inline void setMaxVoltage(float Vmax) {_Vmax = Vmax; }
        inline void setMinVoltage(float Vmin) {_Vmin = Vmin; }
	...
	protected:
        ...
        float _Pmax; //per-unit active power demand
        float _Pmin; //per-unit reactive power demand
        float _Qmax; //per-unit active power demand
        float _Qmin; //per-unit reactive power demand
        float _Vmax; //per-unit active power demand
        float _Vmin; //per-unit reactive power demand
