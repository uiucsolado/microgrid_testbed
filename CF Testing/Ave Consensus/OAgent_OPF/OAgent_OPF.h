...
class OAgent_OPF {
	public:
        ...
        void _SendToParent(uint16_t recipientID, bool flag_OPF, float* vars, float* grad);
        ...
        uint16_t _convert2uint16_(float x, float base);
        uint32_t _convert2uint32_(float x, float base);
        uint8_t _convert2uint8_(float x, float base);
