...
float _pv_grid_following_inverter__averaged__vrms_vinst_va1__out;
...
float _pv_grid_following_inverter__averaged__vrms_rms_calc_fast__var_eff_s;
X_UnInt32 _pv_grid_following_inverter__averaged__vrms_rms_calc_fast__period;
float _pv_grid_following_inverter__averaged__vrms_rms_calc_slow__var_rms;
...
float _pv_grid_following_inverter__averaged__vrms_rt1_output__out =  0.0;

float _pv_grid_following_inverter__averaged__vrms_rt2_output__out =  0.0;
...
float _pv_grid_following_inverter__averaged__vrms_rms_calc_fast__v_sq_sum_state;
X_UnInt32 _pv_grid_following_inverter__averaged__vrms_rms_calc_fast__pc_cnt_1_state;
float _pv_grid_following_inverter__averaged__vrms_rms_calc_fast__var_filt;
...
void ReInit_sys_sp_cpu_dev0() {
    ...
    _pv_grid_following_inverter__averaged__vrms_rt1_output__out =  0.0;
    _pv_grid_following_inverter__averaged__vrms_rt2_output__out =  0.0;
    ...
    _pv_grid_following_inverter__averaged__vrms_rms_calc_fast__var_eff_s = 0;
    _pv_grid_following_inverter__averaged__vrms_rms_calc_fast__period = 0;
    _pv_grid_following_inverter__averaged__vrms_rms_calc_fast__var_filt = 0.0f;
    _pv_grid_following_inverter__averaged__vrms_rms_calc_fast__v_sq_sum_state = 0.0f;
    _pv_grid_following_inverter__averaged__vrms_rms_calc_fast__pc_cnt_1_state = 0;
...
void TimerCounterHandler_0_sys_sp_cpu_dev0() {
    ...
    _ess_grid_forming_inverter__averaged__vrms_vinst_va1__out = (HIL_InFloat(0xc80000 + 0x20));
    // Generated from the component: PV.Grid following inverter (averaged).Vrms.Vinst.Va1
    _pv_grid_following_inverter__averaged__vrms_vinst_va1__out = (HIL_InFloat(0xc80000 + 0x33));
    // Generated from the component: Vrms_ess.Vinst.Va1
    _vrms_ess_vinst_va1__out = (HIL_InFloat(0xc80000 + 0x37));
    // Generated from the component: Vrms_grid.Vinst.Va1
    _vrms_grid_vinst_va1__out = (HIL_InFloat(0xc80000 + 0x38));
    // Generated from the component: Vrms_pv.Vinst.Va1
    _vrms_pv_vinst_va1__out = (HIL_InFloat(0xc80000 + 0x39));
    ...
    // Generated from the component: PV.Grid following inverter (averaged).Vrms.rms_calc_fast
    _pv_grid_following_inverter__averaged__vrms_rms_calc_fast__v_sq_sum_state = _pv_grid_following_inverter__averaged__vrms_rms_calc_fast__v_sq_sum_state + _pv_grid_following_inverter__averaged__vrms_vinst_va1__out * _pv_grid_following_inverter__averaged__vrms_vinst_va1__out;
    //square sum and period update on period end
    if (333 == _pv_grid_following_inverter__averaged__vrms_rms_calc_fast__pc_cnt_1_state) {
        _pv_grid_following_inverter__averaged__vrms_rms_calc_fast__var_eff_s = _pv_grid_following_inverter__averaged__vrms_rms_calc_fast__v_sq_sum_state;
        _pv_grid_following_inverter__averaged__vrms_rms_calc_fast__period = (float)333;
        _pv_grid_following_inverter__averaged__vrms_rms_calc_fast__v_sq_sum_state = 0.0f;
    }
    // Generated from the component: PV.Grid following inverter (averaged).Vrms.sys1
    ...
    // Generated from the component: PV.Grid following inverter (averaged).Vrms.rt1.Input
    _pv_grid_following_inverter__averaged__vrms_rt1_output__out = _pv_grid_following_inverter__averaged__vrms_rms_calc_fast__var_eff_s;
    // Generated from the component: PV.Grid following inverter (averaged).Vrms.rt2.Input
    _pv_grid_following_inverter__averaged__vrms_rt2_output__out = _pv_grid_following_inverter__averaged__vrms_rms_calc_fast__period;
    // Generated from the component: PV.Grid following inverter (averaged).Vrms.t1
    ...
    _pv_grid_following_inverter__averaged__vrms_rms_calc_fast__pc_cnt_1_state ++;
    // Generated from the component: Vrms_ess.rms_calc_fast
    if ((_vrms_ess_rms_calc_fast__var_zc == 1) || (10000 == _vrms_ess_rms_calc_fast__pc_cnt_1_state)) {
        _vrms_ess_rms_calc_fast__pc_cnt_1_state = 0;
    }
...
void TimerCounterHandler_1_sys_sp_cpu_dev0() {
    ...
    // Generated from the component: PV.Grid following inverter (averaged).Vrms.rt1.Output
    // Generated from the component: PV.Grid following inverter (averaged).Vrms.rt2.Output
    ...
    // Generated from the component: PV.Grid following inverter (averaged).Vrms.rms_calc_slow
    if(_pv_grid_following_inverter__averaged__vrms_rt2_output__out > 0.0f) {
        _pv_grid_following_inverter__averaged__vrms_rms_calc_slow__var_rms = sqrtf(_pv_grid_following_inverter__averaged__vrms_rt1_output__out / _pv_grid_following_inverter__averaged__vrms_rt2_output__out);
    }
    else {
        _pv_grid_following_inverter__averaged__vrms_rms_calc_slow__var_rms = 0.0f;
    }
    ...
    // Generated from the component: PV.Grid following inverter (averaged).Vrms.cpu_trans.Input
    XIo_OutFloat(0x55000100, _pv_grid_following_inverter__averaged__vrms_rms_calc_slow__var_rms);
    // Generated from the component: PV.Grid following inverter (averaged).Vrms.rms
    HIL_OutAO(0x4001, _pv_grid_following_inverter__averaged__vrms_rms_calc_slow__var_rms);
    // Generated from the component: PV.Grid following inverter (averaged).Vrms.sys2
