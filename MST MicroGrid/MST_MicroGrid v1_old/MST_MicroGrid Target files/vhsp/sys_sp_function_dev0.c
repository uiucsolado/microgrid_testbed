...
//@cmp.var.start
// variables
float _pv_pv_plant__switching_1_vrms1_vinst_va1__out;
float _vrms_grid_vinst_va1__out;
float _vrms_pv_vinst_va1__out;
float _pv_pv_plant__switching_1_vrms1_rms_calc_fast__var_eff_s;
X_UnInt32 _pv_pv_plant__switching_1_vrms1_rms_calc_fast__period;
X_UnInt8 _pv_pv_plant__switching_1_vrms1_rms_calc_fast__var_zc;
float _pv_pv_plant__switching_1_vrms1_rms_calc_fast__var_filt_old;
float _pv_pv_plant__switching_1_vrms1_rms_calc_slow__var_rms;
...
//@cmp.svar.start
// state variables
float _pv_pv_plant__switching_1_vrms1_rt1_output__out =  0.0;

float _pv_pv_plant__switching_1_vrms1_rt2_output__out =  0.0;
...
float _pv_pv_plant__switching_1_vrms1_rms_calc_fast__v_sq_sum_state;
X_UnInt32 _pv_pv_plant__switching_1_vrms1_rms_calc_fast__pc_cnt_1_state;
float _pv_pv_plant__switching_1_vrms1_rms_calc_fast__var_filt;
...
void ReInit_sys_sp_cpu_dev0() {
    ...
    _pv_pv_plant__switching_1_vrms1_rt1_output__out =  0.0;
    _pv_pv_plant__switching_1_vrms1_rt2_output__out =  0.0;
    _vrms_grid_rt1_output__out =  0.0;
    _vrms_grid_rt2_output__out =  0.0;
    _vrms_pv_rt1_output__out =  0.0;
    _vrms_pv_rt2_output__out =  0.0;
    _pv_pv_plant__switching_1_vrms1_rms_calc_fast__var_eff_s = 0;
    _pv_pv_plant__switching_1_vrms1_rms_calc_fast__period = 0;
    _pv_pv_plant__switching_1_vrms1_rms_calc_fast__var_filt = 0.0f;
    _pv_pv_plant__switching_1_vrms1_rms_calc_fast__v_sq_sum_state = 0.0f;
    _pv_pv_plant__switching_1_vrms1_rms_calc_fast__pc_cnt_1_state = 0;
...
void TimerCounterHandler_0_sys_sp_cpu_dev0() {
    ...
    //////////////////////////////////////////////////////////////////////////
    //@cmp.out.block.start
    // Generated from the component: PV.PV Plant (Switching)1.Vrms1.Vinst.Va1
    _pv_pv_plant__switching_1_vrms1_vinst_va1__out = (HIL_InFloat(0xc80000 + 0x20b));
    // Generated from the component: Vrms_grid.Vinst.Va1
    _vrms_grid_vinst_va1__out = (HIL_InFloat(0xc80000 + 0x4));
    // Generated from the component: Vrms_pv.Vinst.Va1
    _vrms_pv_vinst_va1__out = (HIL_InFloat(0xc80000 + 0x5));
    // Generated from the component: PV.PV Plant (Switching)1.Vrms1.rms_calc_fast
    _pv_pv_plant__switching_1_vrms1_rms_calc_fast__v_sq_sum_state = _pv_pv_plant__switching_1_vrms1_rms_calc_fast__v_sq_sum_state + _pv_pv_plant__switching_1_vrms1_vinst_va1__out * _pv_pv_plant__switching_1_vrms1_vinst_va1__out;
    _pv_pv_plant__switching_1_vrms1_rms_calc_fast__var_filt_old = _pv_pv_plant__switching_1_vrms1_rms_calc_fast__var_filt;
    _pv_pv_plant__switching_1_vrms1_rms_calc_fast__var_filt = (_pv_pv_plant__switching_1_vrms1_rms_calc_fast__var_filt_old * 0.909 + _pv_pv_plant__switching_1_vrms1_vinst_va1__out * 0.0909);
    if((_pv_pv_plant__switching_1_vrms1_rms_calc_fast__var_filt >= 0.0f) && (_pv_pv_plant__switching_1_vrms1_rms_calc_fast__var_filt_old < 0.0f)) {
        _pv_pv_plant__switching_1_vrms1_rms_calc_fast__var_zc = 1;
    }
    else {
        _pv_pv_plant__switching_1_vrms1_rms_calc_fast__var_zc = 0;
    }
    //square sum and period update on signal zero cross
    if ((_pv_pv_plant__switching_1_vrms1_rms_calc_fast__var_zc == 1) || (10000 == _pv_pv_plant__switching_1_vrms1_rms_calc_fast__pc_cnt_1_state)) {
        _pv_pv_plant__switching_1_vrms1_rms_calc_fast__var_eff_s = _pv_pv_plant__switching_1_vrms1_rms_calc_fast__v_sq_sum_state;
        _pv_pv_plant__switching_1_vrms1_rms_calc_fast__period = (float)_pv_pv_plant__switching_1_vrms1_rms_calc_fast__pc_cnt_1_state;
        _pv_pv_plant__switching_1_vrms1_rms_calc_fast__v_sq_sum_state = 0.0f;
    }
    // Generated from the component: PV.PV Plant (Switching)1.Vrms1.sys1
    ...
    // Generated from the component: PV.PV Plant (Switching)1.Vrms1.rt1.Input
    _pv_pv_plant__switching_1_vrms1_rt1_output__out = _pv_pv_plant__switching_1_vrms1_rms_calc_fast__var_eff_s;
    // Generated from the component: PV.PV Plant (Switching)1.Vrms1.rt2.Input
    _pv_pv_plant__switching_1_vrms1_rt2_output__out = _pv_pv_plant__switching_1_vrms1_rms_calc_fast__period;
    // Generated from the component: PV.PV Plant (Switching)1.Vrms1.t1
    ...
    _pv_pv_plant__switching_1_vrms1_rms_calc_fast__pc_cnt_1_state ++;
    // Generated from the component: Vrms_grid.rms_calc_fast
    if ((_vrms_grid_rms_calc_fast__var_zc == 1) || (10000 == _vrms_grid_rms_calc_fast__pc_cnt_1_state)) {
        _vrms_grid_rms_calc_fast__pc_cnt_1_state = 0;
    }
...
void TimerCounterHandler_1_sys_sp_cpu_dev0() {
    ...
    //////////////////////////////////////////////////////////////////////////
    //@cmp.out.block.start
    // Generated from the component: PV.PV Plant (Switching)1.Vrms1.rt1.Output
    // Generated from the component: PV.PV Plant (Switching)1.Vrms1.rt2.Output
    ...
    // Generated from the component: PV.PV Plant (Switching)1.Vrms1.rms_calc_slow
    if(_pv_pv_plant__switching_1_vrms1_rt2_output__out > 0.0f) {
        _pv_pv_plant__switching_1_vrms1_rms_calc_slow__var_rms = sqrtf(_pv_pv_plant__switching_1_vrms1_rt1_output__out / _pv_pv_plant__switching_1_vrms1_rt2_output__out);
    }
    else {
        _pv_pv_plant__switching_1_vrms1_rms_calc_slow__var_rms = 0.0f;
    }
    ...
    // Generated from the component: PV.PV Plant (Switching)1.Vrms1.cpu_trans.Input
    XIo_OutFloat(0x55000100, _pv_pv_plant__switching_1_vrms1_rms_calc_slow__var_rms);
    // Generated from the component: PV.PV Plant (Switching)1.Vrms1.rms
    HIL_OutAO(0x4000, _pv_pv_plant__switching_1_vrms1_rms_calc_slow__var_rms);
    // Generated from the component: PV.PV Plant (Switching)1.Vrms1.sys2
    // Generated from the component: Vrms_grid.rms
    HIL_OutAO(0x4001, _vrms_grid_rms_calc_slow__var_rms);
    // Generated from the component: Vrms_grid.sys2
    // Generated from the component: Vrms_pv.rms
    HIL_OutAO(0x4002, _vrms_pv_rms_calc_slow__var_rms);
