...
double _microgrid_ess_idc_ia1__out;
double _microgrid_ess_lead_acid_abs1__out;
double _microgrid_ess_lead_acid_abs2__out;
double _microgrid_ess_lead_acid_abs3__out;
double _microgrid_ess_lead_acid_constant1__out = 55.0;
double _microgrid_ess_lead_acid_constant2__out = 0.9;
double _microgrid_ess_lead_acid_constant3__out = 0.86;
double _microgrid_ess_lead_acid_constant4__out = 1.3;
double _microgrid_ess_lead_acid_constant5__out = 1.5;
double _microgrid_ess_lead_acid_constant6__out = 1.0;
double _microgrid_ess_lead_acid_constant7__out = 1.2;
double _microgrid_ess_lead_acid_constant8__out = 1.0;
double _microgrid_ess_lead_acid_constant9__out = 0.0;
double _microgrid_ess_lead_acid_unit_delay1__out;
double _microgrid_ess_lead_acid_unit_delay2__out;
...
double _microgrid_pv_constant14__out = 30.0;
...
double _microgrid_ess_lpf_dc1__out;
double _microgrid_ess_lpf_dc1__b_coeff[2] = {0.003131753958361405, 0.003131753958361294};
double _microgrid_ess_lpf_dc1__a_coeff[2] = {1.0, -0.9937364920832772};
double _microgrid_ess_lpf_dc1__a_sum;
double _microgrid_ess_lpf_dc1__b_sum;
double _microgrid_ess_lpf_dc1__delay_line_in;
X_UnInt32 _microgrid_ess_lpf_dc1__i;
double _microgrid_ess_lead_acid_product1__out;
double _microgrid_ess_lead_acid_mathematical_function2__out;
double _microgrid_ess_lead_acid_mathematical_function3__out;
double _microgrid_ess_lead_acid_comparator1__out;
double _microgrid_ess_lead_acid_abs4__out;
double _microgrid_ess_lead_acid_c_function1__Ibat;
double _microgrid_ess_lead_acid_c_function1__SOC;


double _microgrid_ess_lead_acid_c_function1__out;
double _microgrid_ess_lead_acid_sum1__out;
double _microgrid_ess_product1__out;
...
double _microgrid_ess_lead_acid_mathematical_function1__out;
double _microgrid_ess_lead_acid_c_function2__Idc;
double _microgrid_ess_lead_acid_c_function2__Vbtt;
X_Int32 _microgrid_ess_lead_acid_c_function2__charge;


double _microgrid_ess_lead_acid_c_function2__Ibat;
float _microgrid_ess_lead_acid_charging__tmp;
double _microgrid_ess_lead_acid_mathematical_function4__out;
double _microgrid_ess_lead_acid_mathematical_function6__out;
double _microgrid_ess_lead_acid_abs5__out;
...
double _microgrid_ess_lead_acid_lpf_dc__out;
double _microgrid_ess_lead_acid_lpf_dc__b_coeff[2] = {0.003131753958361405, 0.003131753958361294};
double _microgrid_ess_lead_acid_lpf_dc__a_coeff[2] = {1.0, -0.9937364920832772};
double _microgrid_ess_lead_acid_lpf_dc__a_sum;
double _microgrid_ess_lead_acid_lpf_dc__b_sum;
double _microgrid_ess_lead_acid_lpf_dc__delay_line_in;
X_UnInt32 _microgrid_ess_lead_acid_lpf_dc__i;
double _microgrid_ess_lead_acid_sum2__out;
double _microgrid_ess_lead_acid_mathematical_function5__out;
...
double _microgrid_ess_lead_acid_bus_join1__out[6];
...
double _microgrid_ess_lead_acid_c_function__Cbat;
double _microgrid_ess_lead_acid_c_function__Vbat;
double _microgrid_ess_lead_acid_c_function__Ceff;
double _microgrid_ess_lead_acid_c_function__Ibat;
X_Int32 _microgrid_ess_lead_acid_c_function__charge;
double _microgrid_ess_lead_acid_c_function__x[6];


double _microgrid_ess_lead_acid_c_function__SOC;
double _microgrid_ess_lead_acid_c_function__Vbtt;
double _microgrid_ess_lead_acid_c_function__Vdc;
...
double _microgrid_ess_lpf_dc2__out;
double _microgrid_ess_lpf_dc2__b_coeff[2] = {0.003131753958361405, 0.003131753958361294};
double _microgrid_ess_lpf_dc2__a_coeff[2] = {1.0, -0.9937364920832772};
double _microgrid_ess_lpf_dc2__a_sum;
double _microgrid_ess_lpf_dc2__b_sum;
double _microgrid_ess_lpf_dc2__delay_line_in;
X_UnInt32 _microgrid_ess_lpf_dc2__i;
double _microgrid_ess_lead_acid_lpf_dc1__out;
double _microgrid_ess_lead_acid_lpf_dc1__b_coeff[2] = {0.003131753958361405, 0.003131753958361294};
double _microgrid_ess_lead_acid_lpf_dc1__a_coeff[2] = {1.0, -0.9937364920832772};
double _microgrid_ess_lead_acid_lpf_dc1__a_sum;
double _microgrid_ess_lead_acid_lpf_dc1__b_sum;
double _microgrid_ess_lead_acid_lpf_dc1__delay_line_in;
X_UnInt32 _microgrid_ess_lead_acid_lpf_dc1__i;
...
double _microgrid_pv_c_function1__SI;
double _microgrid_pv_c_function1__Tamb;
...
//@cmp.svar.start
// state variables
double _microgrid_ess_lead_acid_unit_delay1__state;
double _microgrid_ess_lead_acid_unit_delay2__state;
double _microgrid_ess_rate_transition7_output__out =  1000.0;
...
double _microgrid_inverter_rate_transition7_output__out =  750.0;

double _microgrid_pv_rate_transition1_output__out =  0.0;
...
double _microgrid_ess_lpf_dc1__states[1];
double _microgrid_ess_lead_acid_comparator1__state;
...
double _microgrid_ess_lead_acid_lpf_dc__states[1];
double _microgrid_ess_lpf_dc2__states[1];
double _microgrid_ess_lead_acid_lpf_dc1__states[1];
...
void ReInit_user_sp_cpu_dev0() {
    ...
    _microgrid_ess_lead_acid_unit_delay1__state = 0.5;
    _microgrid_ess_lead_acid_unit_delay2__state = 0.5;
    _microgrid_ess_rate_transition7_output__out =  1000.0;
    ...
    _microgrid_inverter_rate_transition7_output__out =  750.0;
    _microgrid_pv_rate_transition1_output__out =  0.0;
    ...
    for (_microgrid_ess_lpf_dc1__i = 0; _microgrid_ess_lpf_dc1__i < 1; _microgrid_ess_lpf_dc1__i++) {
        _microgrid_ess_lpf_dc1__states[_microgrid_ess_lpf_dc1__i] = 0.0;
    }
    _microgrid_ess_lead_acid_comparator1__state = 0.0f;
    ...
    for (_microgrid_ess_lead_acid_lpf_dc__i = 0; _microgrid_ess_lead_acid_lpf_dc__i < 1; _microgrid_ess_lead_acid_lpf_dc__i++) {
        _microgrid_ess_lead_acid_lpf_dc__states[_microgrid_ess_lead_acid_lpf_dc__i] = 0.0;
    }
    HIL_OutAO(0x4003, 0.0f);
    _microgrid_ess_lead_acid_c_function__SOC = 0.5;
    HIL_OutAO(0x401f, 0.0f);
    HIL_OutAO(0x4004, 0.0f);
    for (_microgrid_ess_lpf_dc2__i = 0; _microgrid_ess_lpf_dc2__i < 1; _microgrid_ess_lpf_dc2__i++) {
        _microgrid_ess_lpf_dc2__states[_microgrid_ess_lpf_dc2__i] = 0.0;
    }
    for (_microgrid_ess_lead_acid_lpf_dc1__i = 0; _microgrid_ess_lead_acid_lpf_dc1__i < 1; _microgrid_ess_lead_acid_lpf_dc1__i++) {
        _microgrid_ess_lead_acid_lpf_dc1__states[_microgrid_ess_lead_acid_lpf_dc1__i] = 0.0;
    }
...
void TimerCounterHandler_0_user_sp_cpu_dev0() {
    ...
    _microgrid_inverter_e_va1__out = (HIL_InFloat(0xc80000 + 0x204));
    // Generated from the component: Microgrid.Inverter.I.Ia1
    _microgrid_inverter_i_ia1__out = (HIL_InFloat(0xc80000 + 0x209));
    // Generated from the component: Microgrid.Inverter.Io.Ia1
    _microgrid_inverter_io_ia1__out = (HIL_InFloat(0xc80000 + 0x20a));
    ...
    // Generated from the component: Microgrid.Inverter.Rate Transition7.Output
    // Generated from the component: Microgrid.Measurement.Ia.Ia1
    _microgrid_measurement_ia_ia1__out = (HIL_InFloat(0xc80000 + 0x20b));
    ...
    _microgrid_measurement_va_va1__out = (HIL_InFloat(0xc80000 + 0x206));
    ...
    _microgrid_inverter_controller_outer_voltage_loop___inner_current_loop_inner_current_control_loop_lpf_dc__delay_line_in = _microgrid_inverter_rate_transition7_output__out - _microgrid_inverter_controller_outer_voltage_loop___inner_current_loop_inner_current_control_loop_lpf_dc__a_sum;
    ...
    _microgrid_inverter_controller_outer_voltage_loop___inner_current_loop_outer_power_loop_product5__out = (_microgrid_inverter_controller_gain22__out * _microgrid_inverter_controller_gain28__out);
    ...
    _microgrid_inverter_controller_outer_voltage_loop___inner_current_loop_outer_power_loop_product3__out = (_microgrid_inverter_controller_gain29__out * _microgrid_inverter_controller_gain22__out);
    ...
    HIL_OutAO(0x4012, (float)_microgrid_inverter_controller_outer_voltage_loop___inner_current_loop_outer_power_loop_signal_switch1__out);
    ...
    HIL_OutAO(0x400d, (float)_microgrid_inverter_controller_outer_voltage_loop___inner_current_loop_outer_power_loop_product1__out);
    ...
    HIL_OutAO(0x400c, (float)_microgrid_inverter_controller_outer_voltage_loop___inner_current_loop_outer_power_loop_product2__out);
...
void TimerCounterHandler_2_user_sp_cpu_dev0() {
    ...
    //////////////////////////////////////////////////////////////////////////
    //@cmp.out.block.start
    // Generated from the component: Microgrid.ESS.Idc.Ia1
    _microgrid_ess_idc_ia1__out = (HIL_InFloat(0xc80000 + 0x208));
    // Generated from the component: Microgrid.ESS.Lead acid.Abs1
    _microgrid_ess_lead_acid_abs1__out = fabs(_microgrid_ess_lead_acid_lpf_dc__out);
    // Generated from the component: Microgrid.ESS.Lead acid.Abs2
    _microgrid_ess_lead_acid_abs2__out = fabs(_microgrid_ess_lead_acid_lpf_dc__out);
    // Generated from the component: Microgrid.ESS.Lead acid.Abs3
    _microgrid_ess_lead_acid_abs3__out = fabs(_microgrid_ess_lead_acid_lpf_dc__out);
    // Generated from the component: Microgrid.ESS.Lead acid.Constant1
    // Generated from the component: Microgrid.ESS.Lead acid.Constant2
    // Generated from the component: Microgrid.ESS.Lead acid.Constant3
    // Generated from the component: Microgrid.ESS.Lead acid.Constant4
    // Generated from the component: Microgrid.ESS.Lead acid.Constant5
    // Generated from the component: Microgrid.ESS.Lead acid.Constant6
    // Generated from the component: Microgrid.ESS.Lead acid.Constant7
    // Generated from the component: Microgrid.ESS.Lead acid.Constant8
    // Generated from the component: Microgrid.ESS.Lead acid.Constant9
    // Generated from the component: Microgrid.ESS.Lead acid.Ibat
    HIL_OutAO(0x4005, (float)_microgrid_ess_lead_acid_lpf_dc__out);
    // Generated from the component: Microgrid.ESS.Lead acid.Unit Delay1
    _microgrid_ess_lead_acid_unit_delay1__out = _microgrid_ess_lead_acid_unit_delay1__state;
    // Generated from the component: Microgrid.ESS.Lead acid.Unit Delay2
    _microgrid_ess_lead_acid_unit_delay2__out = _microgrid_ess_lead_acid_unit_delay2__state;
    // Generated from the component: Microgrid.ESS.Rate Transition7.Input
    _microgrid_ess_rate_transition7_output__out = _microgrid_ess_lpf_dc2__out;
    // Generated from the component: Microgrid.ESS.Rate Transition7.Output
    // Generated from the component: Microgrid.ESS.VDC
    HIL_OutAO(0x4008, (float)_microgrid_ess_lpf_dc2__out);
    // Generated from the component: Microgrid.ESS.LPF_dc1
    _microgrid_ess_lpf_dc1__a_sum = 0.0f;
    _microgrid_ess_lpf_dc1__b_sum = 0.0f;
    _microgrid_ess_lpf_dc1__delay_line_in = 0.0f;
    for (_microgrid_ess_lpf_dc1__i = 0; _microgrid_ess_lpf_dc1__i < 1; _microgrid_ess_lpf_dc1__i++) {
        _microgrid_ess_lpf_dc1__b_sum += _microgrid_ess_lpf_dc1__b_coeff[_microgrid_ess_lpf_dc1__i + 1] * _microgrid_ess_lpf_dc1__states[_microgrid_ess_lpf_dc1__i];
    }
    _microgrid_ess_lpf_dc1__a_sum += _microgrid_ess_lpf_dc1__states[0] * _microgrid_ess_lpf_dc1__a_coeff[1];
    _microgrid_ess_lpf_dc1__delay_line_in = _microgrid_ess_idc_ia1__out - _microgrid_ess_lpf_dc1__a_sum;
    _microgrid_ess_lpf_dc1__b_sum += _microgrid_ess_lpf_dc1__b_coeff[0] * _microgrid_ess_lpf_dc1__delay_line_in;
    _microgrid_ess_lpf_dc1__out = _microgrid_ess_lpf_dc1__b_sum;
    // Generated from the component: Microgrid.ESS.Lead acid.Product1
    _microgrid_ess_lead_acid_product1__out = (_microgrid_ess_lead_acid_abs1__out) * 1.0 / (_microgrid_ess_lead_acid_constant1__out);
    // Generated from the component: Microgrid.ESS.Lead acid.Mathematical function2
    _microgrid_ess_lead_acid_mathematical_function2__out = pow(_microgrid_ess_lead_acid_abs2__out, _microgrid_ess_lead_acid_constant3__out);
    // Generated from the component: Microgrid.ESS.Lead acid.Mathematical function3
    _microgrid_ess_lead_acid_mathematical_function3__out = pow(_microgrid_ess_lead_acid_abs3__out, _microgrid_ess_lead_acid_constant4__out);
    // Generated from the component: Microgrid.ESS.Lead acid.Comparator1
    if (_microgrid_ess_lpf_dc1__out < _microgrid_ess_lead_acid_constant9__out) {
        _microgrid_ess_lead_acid_comparator1__out = 0;
    } else if (_microgrid_ess_lpf_dc1__out > _microgrid_ess_lead_acid_constant9__out) {
        _microgrid_ess_lead_acid_comparator1__out = 1;
    } else {
        _microgrid_ess_lead_acid_comparator1__out = _microgrid_ess_lead_acid_comparator1__state;
    }
    // Generated from the component: Microgrid.ESS.Lead acid.Abs4
    _microgrid_ess_lead_acid_abs4__out = fabs(_microgrid_ess_lead_acid_unit_delay1__out);
    // Generated from the component: Microgrid.ESS.Lead acid.C function1
    _microgrid_ess_lead_acid_c_function1__Ibat = _microgrid_ess_lead_acid_lpf_dc__out;
    _microgrid_ess_lead_acid_c_function1__SOC = _microgrid_ess_lead_acid_unit_delay1__out;
    if (_microgrid_ess_lead_acid_c_function1__Ibat > 0)_microgrid_ess_lead_acid_c_function1__out = 20.73 * (_microgrid_ess_lead_acid_c_function1__SOC - 1) / (_microgrid_ess_lead_acid_c_function1__Ibat / 55.0 + 0.55);
    else _microgrid_ess_lead_acid_c_function1__out = 20.73 * (_microgrid_ess_lead_acid_c_function1__SOC - 1) / (-_microgrid_ess_lead_acid_c_function1__Ibat / 55.0 + 0.55);
    // Generated from the component: Microgrid.ESS.Lead acid.SOC
    HIL_OutAO(0x4006, (float)_microgrid_ess_lead_acid_unit_delay1__out);
    // Generated from the component: Microgrid.ESS.Lead acid.Sum1
    _microgrid_ess_lead_acid_sum1__out = _microgrid_ess_lead_acid_constant6__out - _microgrid_ess_lead_acid_unit_delay1__out;
    // Generated from the component: Microgrid.ESS.Product1
    _microgrid_ess_product1__out = (_microgrid_ess_rate_transition7_output__out * _microgrid_ess_lpf_dc1__out);
    // Generated from the component: Microgrid.Inverter.Rate Transition7.Input
    _microgrid_inverter_rate_transition7_output__out = _microgrid_ess_rate_transition7_output__out;
    // Generated from the component: Microgrid.PV.Rate Transition1.Input
    _microgrid_pv_rate_transition1_output__out = _microgrid_ess_rate_transition7_output__out;
    // Generated from the component: Microgrid.ESS.Lead acid.Mathematical function1
    _microgrid_ess_lead_acid_mathematical_function1__out = pow(_microgrid_ess_lead_acid_product1__out, _microgrid_ess_lead_acid_constant2__out);
    // Generated from the component: Microgrid.ESS.Lead acid.C function2
    _microgrid_ess_lead_acid_c_function2__Idc = _microgrid_ess_lpf_dc1__out;
    _microgrid_ess_lead_acid_c_function2__Vbtt = _microgrid_ess_lead_acid_unit_delay2__out;
    _microgrid_ess_lead_acid_c_function2__charge = _microgrid_ess_lead_acid_comparator1__out;
    if (_microgrid_ess_lead_acid_c_function2__charge > 0)_microgrid_ess_lead_acid_c_function2__Ibat = _microgrid_ess_lead_acid_c_function2__Idc * 1000.0 / _microgrid_ess_lead_acid_c_function2__Vbtt;
    else _microgrid_ess_lead_acid_c_function2__Ibat = _microgrid_ess_lead_acid_c_function2__Idc * 1000.0 / _microgrid_ess_lead_acid_c_function2__Vbtt;
    // Generated from the component: Microgrid.ESS.Lead acid.Charging
    HIL_OutInt32(0xf00400, _microgrid_ess_lead_acid_comparator1__out != 0x0);
    // Generated from the component: Microgrid.ESS.Lead acid.Mathematical function4
    _microgrid_ess_lead_acid_mathematical_function4__out = pow(_microgrid_ess_lead_acid_abs4__out, _microgrid_ess_lead_acid_constant5__out);
    // Generated from the component: Microgrid.ESS.Lead acid.Mathematical function6
    _microgrid_ess_lead_acid_mathematical_function6__out = pow(M_E, _microgrid_ess_lead_acid_c_function1__out);
    // Generated from the component: Microgrid.ESS.Lead acid.Abs5
    _microgrid_ess_lead_acid_abs5__out = fabs(_microgrid_ess_lead_acid_sum1__out);
    // Generated from the component: Microgrid.ESS.P
    HIL_OutAO(0x4007, (float)_microgrid_ess_product1__out);
    // Generated from the component: Microgrid.ESS.Lead acid.LPF_dc
    _microgrid_ess_lead_acid_lpf_dc__a_sum = 0.0f;
    _microgrid_ess_lead_acid_lpf_dc__b_sum = 0.0f;
    _microgrid_ess_lead_acid_lpf_dc__delay_line_in = 0.0f;
    for (_microgrid_ess_lead_acid_lpf_dc__i = 0; _microgrid_ess_lead_acid_lpf_dc__i < 1; _microgrid_ess_lead_acid_lpf_dc__i++) {
        _microgrid_ess_lead_acid_lpf_dc__b_sum += _microgrid_ess_lead_acid_lpf_dc__b_coeff[_microgrid_ess_lead_acid_lpf_dc__i + 1] * _microgrid_ess_lead_acid_lpf_dc__states[_microgrid_ess_lead_acid_lpf_dc__i];
    }
    _microgrid_ess_lead_acid_lpf_dc__a_sum += _microgrid_ess_lead_acid_lpf_dc__states[0] * _microgrid_ess_lead_acid_lpf_dc__a_coeff[1];
    _microgrid_ess_lead_acid_lpf_dc__delay_line_in = _microgrid_ess_lead_acid_c_function2__Ibat - _microgrid_ess_lead_acid_lpf_dc__a_sum;
    _microgrid_ess_lead_acid_lpf_dc__b_sum += _microgrid_ess_lead_acid_lpf_dc__b_coeff[0] * _microgrid_ess_lead_acid_lpf_dc__delay_line_in;
    _microgrid_ess_lead_acid_lpf_dc__out = _microgrid_ess_lead_acid_lpf_dc__b_sum;
    // Generated from the component: Microgrid.ESS.Lead acid.Sum2
    _microgrid_ess_lead_acid_sum2__out = _microgrid_ess_lead_acid_constant8__out - _microgrid_ess_lead_acid_mathematical_function6__out;
    // Generated from the component: Microgrid.ESS.Lead acid.Mathematical function5
    _microgrid_ess_lead_acid_mathematical_function5__out = pow(_microgrid_ess_lead_acid_abs5__out, _microgrid_ess_lead_acid_constant7__out);
    // Generated from the component: Microgrid.ESS.Lead acid.Bus Join1
    _microgrid_ess_lead_acid_bus_join1__out[0] = _microgrid_ess_lead_acid_mathematical_function1__out;
    _microgrid_ess_lead_acid_bus_join1__out[1] = _microgrid_ess_lead_acid_mathematical_function2__out;
    _microgrid_ess_lead_acid_bus_join1__out[2] = _microgrid_ess_lead_acid_mathematical_function5__out;
    _microgrid_ess_lead_acid_bus_join1__out[3] = _microgrid_ess_lead_acid_abs3__out;
    _microgrid_ess_lead_acid_bus_join1__out[4] = _microgrid_ess_lead_acid_mathematical_function3__out;
    _microgrid_ess_lead_acid_bus_join1__out[5] = _microgrid_ess_lead_acid_mathematical_function4__out;
    // Generated from the component: Microgrid.ESS.Lead acid.C function
    _microgrid_ess_lead_acid_c_function__Ceff = _microgrid_ess_lead_acid_sum2__out;
    _microgrid_ess_lead_acid_c_function__Ibat = _microgrid_ess_lead_acid_lpf_dc__out;
    _microgrid_ess_lead_acid_c_function__charge = _microgrid_ess_lead_acid_comparator1__out;
    _microgrid_ess_lead_acid_c_function__x[0] = _microgrid_ess_lead_acid_bus_join1__out[0];
    _microgrid_ess_lead_acid_c_function__x[1] = _microgrid_ess_lead_acid_bus_join1__out[1];
    _microgrid_ess_lead_acid_c_function__x[2] = _microgrid_ess_lead_acid_bus_join1__out[2];
    _microgrid_ess_lead_acid_c_function__x[3] = _microgrid_ess_lead_acid_bus_join1__out[3];
    _microgrid_ess_lead_acid_c_function__x[4] = _microgrid_ess_lead_acid_bus_join1__out[4];
    _microgrid_ess_lead_acid_c_function__x[5] = _microgrid_ess_lead_acid_bus_join1__out[5];
    if (_microgrid_ess_lead_acid_c_function__Ibat > 0) {
        _microgrid_ess_lead_acid_c_function__Vbat = 20.0 * (2 + 0.16 * _microgrid_ess_lead_acid_c_function__SOC) + 20.0 * _microgrid_ess_lead_acid_c_function__Ibat / 550.0 * (6 / (1 + _microgrid_ess_lead_acid_c_function__x[1]) + 0.48 / _microgrid_ess_lead_acid_c_function__x[2] + 0.036) * (1 - 0.025 * (30.0 - 25));
        _microgrid_ess_lead_acid_c_function__SOC = _microgrid_ess_lead_acid_c_function__SOC + (_microgrid_ess_lead_acid_c_function__Ibat / _microgrid_ess_lead_acid_c_function__Cbat) * 1e-3 / 3600.0;
    }
    else {
        _microgrid_ess_lead_acid_c_function__Vbat = 20.0 * (1.965 + 0.12 * _microgrid_ess_lead_acid_c_function__SOC) - 20.0 * _microgrid_ess_lead_acid_c_function__x[3] / 550.0 * (4 / (1 + _microgrid_ess_lead_acid_c_function__x[4]) + 0.27 / _microgrid_ess_lead_acid_c_function__x[5] + 0.02) * (1 - 0.007 * (30.0 - 25));
        _microgrid_ess_lead_acid_c_function__SOC = _microgrid_ess_lead_acid_c_function__SOC + (_microgrid_ess_lead_acid_c_function__Ibat / _microgrid_ess_lead_acid_c_function__Cbat) * 1e-3 / 3600.0;
    }
    if (_microgrid_ess_lead_acid_c_function__SOC < 0.001)_microgrid_ess_lead_acid_c_function__SOC = 0.001;
    if (_microgrid_ess_lead_acid_c_function__SOC > 1)_microgrid_ess_lead_acid_c_function__SOC = 1;
    if (_microgrid_ess_lead_acid_c_function__Vbat < 1)_microgrid_ess_lead_acid_c_function__Vbat = 1;
    if (_microgrid_ess_lead_acid_c_function__Vbat > 1.5e3)_microgrid_ess_lead_acid_c_function__Vbat = 1.5e3;
    _microgrid_ess_lead_acid_c_function__Vbtt = _microgrid_ess_lead_acid_c_function__Vbat + 0.01 * _microgrid_ess_lead_acid_c_function__Ibat;
    if (_microgrid_ess_lead_acid_c_function__charge > 0)_microgrid_ess_lead_acid_c_function__Vdc = 1000.0;
    else _microgrid_ess_lead_acid_c_function__Vdc = 1000.0;
    // Generated from the component: Microgrid.ESS.LPF_dc2
    _microgrid_ess_lpf_dc2__a_sum = 0.0f;
    _microgrid_ess_lpf_dc2__b_sum = 0.0f;
    _microgrid_ess_lpf_dc2__delay_line_in = 0.0f;
    for (_microgrid_ess_lpf_dc2__i = 0; _microgrid_ess_lpf_dc2__i < 1; _microgrid_ess_lpf_dc2__i++) {
        _microgrid_ess_lpf_dc2__b_sum += _microgrid_ess_lpf_dc2__b_coeff[_microgrid_ess_lpf_dc2__i + 1] * _microgrid_ess_lpf_dc2__states[_microgrid_ess_lpf_dc2__i];
    }
    _microgrid_ess_lpf_dc2__a_sum += _microgrid_ess_lpf_dc2__states[0] * _microgrid_ess_lpf_dc2__a_coeff[1];
    _microgrid_ess_lpf_dc2__delay_line_in = _microgrid_ess_lead_acid_c_function__Vdc - _microgrid_ess_lpf_dc2__a_sum;
    _microgrid_ess_lpf_dc2__b_sum += _microgrid_ess_lpf_dc2__b_coeff[0] * _microgrid_ess_lpf_dc2__delay_line_in;
    _microgrid_ess_lpf_dc2__out = _microgrid_ess_lpf_dc2__b_sum;
    // Generated from the component: Microgrid.ESS.Lead acid.LPF_dc1
    _microgrid_ess_lead_acid_lpf_dc1__a_sum = 0.0f;
    _microgrid_ess_lead_acid_lpf_dc1__b_sum = 0.0f;
    _microgrid_ess_lead_acid_lpf_dc1__delay_line_in = 0.0f;
    for (_microgrid_ess_lead_acid_lpf_dc1__i = 0; _microgrid_ess_lead_acid_lpf_dc1__i < 1; _microgrid_ess_lead_acid_lpf_dc1__i++) {
        _microgrid_ess_lead_acid_lpf_dc1__b_sum += _microgrid_ess_lead_acid_lpf_dc1__b_coeff[_microgrid_ess_lead_acid_lpf_dc1__i + 1] * _microgrid_ess_lead_acid_lpf_dc1__states[_microgrid_ess_lead_acid_lpf_dc1__i];
    }
    _microgrid_ess_lead_acid_lpf_dc1__a_sum += _microgrid_ess_lead_acid_lpf_dc1__states[0] * _microgrid_ess_lead_acid_lpf_dc1__a_coeff[1];
    _microgrid_ess_lead_acid_lpf_dc1__delay_line_in = _microgrid_ess_lead_acid_c_function__Vbtt - _microgrid_ess_lead_acid_lpf_dc1__a_sum;
    _microgrid_ess_lead_acid_lpf_dc1__b_sum += _microgrid_ess_lead_acid_lpf_dc1__b_coeff[0] * _microgrid_ess_lead_acid_lpf_dc1__delay_line_in;
    _microgrid_ess_lead_acid_lpf_dc1__out = _microgrid_ess_lead_acid_lpf_dc1__b_sum;
    // Generated from the component: Microgrid.ESS.Vess.Vs1
    HIL_OutFloat(141295616, (float) _microgrid_ess_lead_acid_c_function__Vdc);
    //@cmp.out.block.end
    //////////////////////////////////////////////////////////////////////////
    // Update block
    //////////////////////////////////////////////////////////////////////////
    //@cmp.update.block.start
    // Generated from the component: Microgrid.ESS.Lead acid.Unit Delay1
    _microgrid_ess_lead_acid_unit_delay1__state = _microgrid_ess_lead_acid_c_function__SOC;
    // Generated from the component: Microgrid.ESS.Lead acid.Unit Delay2
    _microgrid_ess_lead_acid_unit_delay2__state = _microgrid_ess_lead_acid_lpf_dc1__out;
    // Generated from the component: Microgrid.ESS.LPF_dc1
    _microgrid_ess_lpf_dc1__states[0] = _microgrid_ess_lpf_dc1__delay_line_in;
    // Generated from the component: Microgrid.ESS.Lead acid.Comparator1
    if (_microgrid_ess_lpf_dc1__out < _microgrid_ess_lead_acid_constant9__out) {
        _microgrid_ess_lead_acid_comparator1__state = 0;
    } else if (_microgrid_ess_lpf_dc1__out > _microgrid_ess_lead_acid_constant9__out) {
        _microgrid_ess_lead_acid_comparator1__state = 1;
    }
    // Generated from the component: Microgrid.ESS.Lead acid.C function1
    // Generated from the component: Microgrid.ESS.Lead acid.C function2
    // Generated from the component: Microgrid.ESS.Lead acid.LPF_dc
    _microgrid_ess_lead_acid_lpf_dc__states[0] = _microgrid_ess_lead_acid_lpf_dc__delay_line_in;
    // Generated from the component: Microgrid.ESS.Lead acid.C function
    _microgrid_ess_lead_acid_c_function__Cbat = 1.67 * 550.0 * (1 + 0.005 * (30.0 - 25)) / (1 + 0.67 * _microgrid_ess_lead_acid_c_function__x[0]);
    // Generated from the component: Microgrid.ESS.LPF_dc2
    _microgrid_ess_lpf_dc2__states[0] = _microgrid_ess_lpf_dc2__delay_line_in;
    // Generated from the component: Microgrid.ESS.Lead acid.LPF_dc1
    _microgrid_ess_lead_acid_lpf_dc1__states[0] = _microgrid_ess_lead_acid_lpf_dc1__delay_line_in;
    //@cmp.update.block.end
}
void TimerCounterHandler_3_user_sp_cpu_dev0() {
    ...
    // Generated from the component: Microgrid.PV.Constant14
    ...
    _microgrid_pv_solar_irradiance_ang_t__out = XIo_InFloat(0x55000104);
    ...
    _microgrid_pv_c_function1__SI = _microgrid_pv_solar_irradiance_sum6__out;
    _microgrid_pv_c_function1__Tamb = _microgrid_pv_constant14__out;
    _microgrid_pv_c_function1__Vdc = _microgrid_pv_rate_transition1_output__out;
    _microgrid_pv_c_function1__Ppv = _microgrid_pv_c_function1__SI * 0.15 * 100;
    _microgrid_pv_c_function1__Ipv = _microgrid_pv_c_function1__Ppv / _microgrid_pv_c_function1__Vdc;
    // Generated from the component: Microgrid.PV.SI
    HIL_OutAO(0x4022, (float)_microgrid_pv_solar_irradiance_sum6__out);
    // Generated from the component: Microgrid.PV.Isp1.Is1
    HIL_OutFloat(141295617, (float) _microgrid_pv_c_function1__Ipv);
    ...
    // Generated from the component: Microgrid.Inverter.Controller.C function3
    // Generated from the component: Microgrid.PV.Solar irradiance.Clock1
    _microgrid_pv_solar_irradiance_clock1__state += 1.0;
    // Generated from the component: Microgrid.PV.Solar irradiance.C function4
    // Generated from the component: Microgrid.PV.Solar irradiance.C function2
