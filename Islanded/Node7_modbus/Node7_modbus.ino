...
OLocalVertex s = OLocalVertex(0x4151C6CB,0,0.0125*D_base,-1.5*base,0.5*base,5,base,7);
//OLocalVertex s = OLocalVertex(0x4151C6CB,0,0,-1.5*base,0.5*base,5,base);
OGraph g = OGraph(&s);
  ...
  if(de == false) {
    ...
    if(a.isSynced()) {
     ...
     // Here is where you need to read the modbus register for the x_i[r]
      ...
      //a.nonleaderFairSplitRatioConsensus(D_base,4);
