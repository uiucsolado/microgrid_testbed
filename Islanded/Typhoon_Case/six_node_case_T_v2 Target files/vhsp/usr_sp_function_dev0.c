...
void TimerCounterHandler_0_user_sp_cpu_dev0() {
    ...
    _modbus4_modbus_device6_comp_holding_out__out = XIo_InFloat(0x5500011c);
    ...
    _modbus4_modbus_device6_comp_coil_out__out = XIo_InFloat(0x55000118);
    ...
    XIo_OutFloat(0x55000168, _modbus4_c_u13__out);
    ...
    XIo_OutFloat(0x55000174, _modbus5_c_u12__out);
    ...
    XIo_OutFloat(0x55000160, _modbus4_c_u11__out);
