...
#ifndef OGraph_SCED_h
#define OGraph_SCED_h
...
class OLocalVertex : public OVertex {
    public:
        ...
        inline float getActiveDemand() { return _SCED; }
        ...
        inline void setActiveDemand(float pd) {_SCED = pd; }
	...
	protected:
        ...
        float _SCED; //per-unit active power demand
...
class OGraph_SCED {
	public:
        /// Constructors
		OGraph_SCED();
        OGraph_SCED(OLocalVertex * s);
        OGraph_SCED(OLocalVertex * s, LinkedList * l);
