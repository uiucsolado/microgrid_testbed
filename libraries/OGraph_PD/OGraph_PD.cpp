...
bool OGraph_PD::addInNeighbor(XBeeAddress64 a) {
    return addInNeighbor(a.getLsb());
}

bool OGraph_PD::addInNeighbor(uint32_t aLsb) {
    return addInNeighbor(aLsb,0,0);
}

bool OGraph_PD::addInNeighbor(XBeeAddress64 a, long lambdaMin, long lambdaMax) {
    return addInNeighbor(a.getLsb(),lambdaMin,lambdaMax);
}

bool OGraph_PD::addInNeighbor(uint32_t aLsb, long lambdaMin, long lambdaMax) {
...
bool OGraph_PD::removeInNeighbor(int index){
...
void OGraph_PD::AdjustVertexArray(int index, int step){
...
bool OGraph_PD::addNonNeighbor(XBeeAddress64 a) {
    return addNonNeighbor(a.getLsb());
}

bool OGraph_PD::addNonNeighbor(uint32_t aLsb) {
    return addNonNeighbor(aLsb,0,0);
}

bool OGraph_PD::addNonNeighbor(XBeeAddress64 a, long lambdaMin, long lambdaMax) {
    return addNonNeighbor(a.getLsb(),lambdaMin,lambdaMax);
}

bool OGraph_PD::addNonNeighbor(uint32_t aLsb, long lambdaMin, long lambdaMax) {
...
void OGraph_PD::clearAllBroadcastLambda() {
...
ORemoteVertex * OGraph_PD::getRemoteVertex(uint8_t i) {
...
bool OGraph_PD::_addRemoteVertex(uint32_t aLsb, long lambdaMin, long lambdaMax, bool inNeighbor) {
