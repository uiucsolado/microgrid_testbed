...
class OAgent_DFC {
	public:
        /// Constructors
		OAgent_DFC();
        OAgent_DFC(XBee * xbee, OGraph_DFC * G, bool leader = false, bool quiet = true);
        OAgent_DFC(XBee * xbee, ZBRxResponse * rx, OGraph_DFC * G, bool leader = false, bool quiet = true);
        //OAgent_DFC(XBee * xbee, ZBRxResponse * rx, OGraph_DFC * G, bool leader = false, bool quiet = true, int RS = 0);
        
        /// Methods
        inline OGraph_DFC * getGraph() { return _G; }
	...
	private:
        ...
        void _prepareOAgent_DFC(XBee * xbee, ZBRxResponse * rx, OGraph_DFC * G, bool leader = false, bool quiet = true);
};
