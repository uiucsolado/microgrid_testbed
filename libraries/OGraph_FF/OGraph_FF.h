...
class OLocalVertex : public OVertex {
    public:
        ...
        inline float getActiveDemand() { return _FF; }
        ...
        inline void setActiveDemand(float pd) {_FF = pd; }
	...
	protected:
        ...
        float _FF; //per-unit active power demand
...
class OGraph_FF {
	public:
        /// Constructors
		OGraph_FF();
        OGraph_FF(OLocalVertex * s);
        OGraph_FF(OLocalVertex * s, LinkedList * l);
