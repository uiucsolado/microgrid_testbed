...
#ifndef OAgent_SCED_h
#define OAgent_SCED_h
...
#define SCHEDULE_SCED_HEADER               0x7340 // schedule coordinate header is ascii s@
#define SCHEDULE_FAIR_SPLIT_HEADER       0x7346 // schedule coordinate header is ascii sF
#define SCHEDULE_SCED_ACK_HEADER           0x7334 // schedule coordinate header is ascii s4
#define SCHEDULE_SCED_ACKACK_HEADER        0x7500 // schedule coordinate header is ascii s4
...
#define SCED_HEADER                        0x7550 // Unicast Primal-dual header is ascii uP
#define SCED_ACK_HEADER                    0x6B50 // Primal-dual acknowledgment header is kP
...
#define SCED_DELAY                         5000   // delay before primal dual algorithm starts
...
class OAgent_SCED {
	public:
        /// Constructors
		OAgent_SCED();
        OAgent_SCED(XBee * xbee, OGraph_SCED * G, bool leader = false, bool quiet = true);
        OAgent_SCED(XBee * xbee, ZBRxResponse * rx, OGraph_SCED * G, bool leader = false, bool quiet = true);
        //OAgent_SCED(XBee * xbee, ZBRxResponse * rx, OGraph_SCED * G, bool leader = false, bool quiet = true, int RS = 0);
        
        /// Methods
        inline OGraph_SCED * getGraph() { return _G; }
        ...
        bool leaderSCED(bool genBus, float alpha, uint8_t iterations);
	...
	private:
        ...
        inline void _broadcastSchedulePrimalDualPacket(unsigned long startTime, uint8_t iterations, uint16_t period) {
            _broadcastSchedulePacket(SCHEDULE_SCED_HEADER,startTime,iterations,period);
        }
        ...
        //inline bool _SCEDPacketAvailable() { return _packetAvailable(SCED_PACKET_HEADER,true); }
        ...
        void _unicastPacket_SCED_P(uint16_t recipientID, float fP, bool flag_SCED);
        void _unicastPacket_SCED_C(uint16_t recipientID, float fP_c, bool flag_SCED, float fP_p);
        ...
        bool _waitForSchedulePacketSCED(int timeout, unsigned long startTime, uint8_t iterations);
        ...
        void _broadcastSchedulePacketSCED(unsigned long startTime, uint8_t numIterations);
        ...
        void _prepareOAgent_SCED(XBee * xbee, ZBRxResponse * rx, OGraph_SCED * G, bool leader = false, bool quiet = true);
};
