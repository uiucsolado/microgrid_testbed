...
class OAgent_PD {
	public:
        /// Constructors
		OAgent_PD();
        OAgent_PD(XBee * xbee, OGraph_PD * G, bool leader = false, bool quiet = true);
        OAgent_PD(XBee * xbee, ZBRxResponse * rx, OGraph_PD * G, bool leader = false, bool quiet = true);
        //OAgent_PD(XBee * xbee, ZBRxResponse * rx, OGraph_PD * G, bool leader = false, bool quiet = true, int RS = 0);
        
        /// Methods
        inline OGraph_PD * getGraph() { return _G; }
	...
	private:
        ...
        void _prepareOAgent_PD(XBee * xbee, ZBRxResponse * rx, OGraph_PD * G, bool leader = false, bool quiet = true);
};
