...
#ifndef OAgent_ODCP_h
#define OAgent_ODCP_h
...
#define SYNC_TIMEOUT                     2000   // time out period to wait for response to HRTS sync_begin broadcast in milliseconds
...
class OAgent_ODCP {
	public:
        /// Constructors
		OAgent_ODCP();
        OAgent_ODCP(XBee * xbee, OGraph_ODCP * G, bool leader = false, bool quiet = true);
        OAgent_ODCP(XBee * xbee, ZBRxResponse * rx, OGraph_ODCP * G, bool leader = false, bool quiet = true);
        
        /// Methods
        inline OGraph_ODCP * getGraph() { return _G; }
        ...
        void fairSplitRatioConsensus1(long y, long z, long M, long m, uint8_t iterations, uint16_t period);
        void fairSplitRatioConsensus2(long *y, long *M, long *m, uint8_t iterations, uint16_t period); 
        long computeFairSplitFinalValue(float gamma);
        void leaderFairSplitRatioConsensus(long y, long z, long M, long m, uint8_t iterations, uint16_t period);
        void leaderFairSplitRatioConsensus2(long *y, long *M, long *m, uint8_t iterations, uint16_t period);
        void leaderFairSplitRatioConsensusWithDyno(Dyno &d, uint8_t iterations, uint16_t period, uint8_t &ledPin);
        void nonleaderFairSplitRatioConsensus(long y, long z, long Malpha, long malpha);
        void nonleaderFairSplitRatioConsensus2(long *y, long *M, long *m);
	...
	private:
        ...
        //// Methods
        /// Fair splitting
        inline void _waitForScheduleFairSplitPacket(unsigned long &startTime, uint8_t &iterations, uint16_t &period, int timeout = -1) {
        ...
        void _initializeFairSplitting(OLocalVertex * s, long y, long z, long M, long m);
        void _initializeFairSplitting2(OLocalVertex * s, long * y, long * M, long * m);
        void _broadcastFairSplitPacket(OLocalVertex * s);
        void _broadcastFairSplitPacket2(OLocalVertex * s);
        long _getMuFromPacket();
        long _getMuFromPacket2(uint8_t i);
        long _getMFromPacket(uint8_t i);
        long _getmFromPacket(uint8_t i);
        long _getMalphaFromPacket();
        long _getmalphaFromPacket();
        long _getSigmaFromPacket();
        long _getSigmaFromPacket2();
        ...
        inline void _waitForSchedulleOptimalDispatchPacket(unsigned long &startTime, uint8_t &iterations, uint16_t &period, int timeout = -1) {
        ...
        void _waitForSchedulePacket(uint16_t header, unsigned long &startTime, uint8_t &iterations, uint16_t &period, int timeout);
        ...
        void _prepareOAgent(XBee * xbee, ZBRxResponse * rx, OGraph_ODCP * G, bool leader = false, bool quiet = true);
};
