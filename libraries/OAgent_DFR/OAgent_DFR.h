...
class OAgent_DFR {
	public:
        /// Constructors
		OAgent_DFR();
        OAgent_DFR(XBee * xbee, OGraph_DFR * G, bool leader = false, bool quiet = true);
        OAgent_DFR(XBee * xbee, ZBRxResponse * rx, OGraph_DFR * G, bool leader = false, bool quiet = true);
        //OAgent_DFR(XBee * xbee, ZBRxResponse * rx, OGraph_DFR * G, bool leader = false, bool quiet = true, int RS = 0);
        
        /// Methods
        inline OGraph_DFR * getGraph() { return _G; }
	...
	private:
        ...
        void _prepareOAgent_DFR(XBee * xbee, ZBRxResponse * rx, OGraph_DFR * G, bool leader = false, bool quiet = true);
};
