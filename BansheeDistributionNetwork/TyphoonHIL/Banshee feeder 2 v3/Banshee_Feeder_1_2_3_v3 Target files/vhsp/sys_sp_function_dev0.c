...
//@cmp.var.start
// variables
float _ess_grid_feeding_inverter__averaged__vrms_vinst_va1__out;
...
float _ess_grid_feeding_inverter__averaged__vrms_rms_calc_fast__var_eff_s;
X_UnInt32 _ess_grid_feeding_inverter__averaged__vrms_rms_calc_fast__period;
float _ess_grid_feeding_inverter__averaged__vrms_rms_calc_slow__var_rms;
...
//@cmp.svar.start
// state variables
float _ess_grid_feeding_inverter__averaged__vrms_rt1_output__out =  0.0;

float _ess_grid_feeding_inverter__averaged__vrms_rt2_output__out =  0.0;
...
float _ess_grid_feeding_inverter__averaged__vrms_rms_calc_fast__v_sq_sum_state;
X_UnInt32 _ess_grid_feeding_inverter__averaged__vrms_rms_calc_fast__pc_cnt_1_state;
float _ess_grid_feeding_inverter__averaged__vrms_rms_calc_fast__var_filt;
...
void ReInit_sys_sp_cpu_dev0() {
    ...
    _ess_grid_feeding_inverter__averaged__vrms_rt1_output__out =  0.0;
    _ess_grid_feeding_inverter__averaged__vrms_rt2_output__out =  0.0;
    ...
    _ess_grid_feeding_inverter__averaged__vrms_rms_calc_fast__var_eff_s = 0;
    _ess_grid_feeding_inverter__averaged__vrms_rms_calc_fast__period = 0;
    _ess_grid_feeding_inverter__averaged__vrms_rms_calc_fast__var_filt = 0.0f;
    _ess_grid_feeding_inverter__averaged__vrms_rms_calc_fast__v_sq_sum_state = 0.0f;
    _ess_grid_feeding_inverter__averaged__vrms_rms_calc_fast__pc_cnt_1_state = 0;
...
void TimerCounterHandler_0_sys_sp_cpu_dev0() {
    ...
    //////////////////////////////////////////////////////////////////////////
    //@cmp.out.block.start
    // Generated from the component: ESS.Grid feeding inverter (averaged).Vrms.Vinst.Va1
    _ess_grid_feeding_inverter__averaged__vrms_vinst_va1__out = (HIL_InFloat(0xc80000 + 0xe14));
    ...
    // Generated from the component: ESS.Grid feeding inverter (averaged).Vrms.rms_calc_fast
    _ess_grid_feeding_inverter__averaged__vrms_rms_calc_fast__v_sq_sum_state = _ess_grid_feeding_inverter__averaged__vrms_rms_calc_fast__v_sq_sum_state + _ess_grid_feeding_inverter__averaged__vrms_vinst_va1__out * _ess_grid_feeding_inverter__averaged__vrms_vinst_va1__out;
    //square sum and period update on period end
    if (333 == _ess_grid_feeding_inverter__averaged__vrms_rms_calc_fast__pc_cnt_1_state) {
        _ess_grid_feeding_inverter__averaged__vrms_rms_calc_fast__var_eff_s = _ess_grid_feeding_inverter__averaged__vrms_rms_calc_fast__v_sq_sum_state;
        _ess_grid_feeding_inverter__averaged__vrms_rms_calc_fast__period = (float)333;
        _ess_grid_feeding_inverter__averaged__vrms_rms_calc_fast__v_sq_sum_state = 0.0f;
    }
    // Generated from the component: ESS.Grid feeding inverter (averaged).Vrms.sys1
    ...
    // Generated from the component: ESS.Grid feeding inverter (averaged).Vrms.rt1.Input
    _ess_grid_feeding_inverter__averaged__vrms_rt1_output__out = _ess_grid_feeding_inverter__averaged__vrms_rms_calc_fast__var_eff_s;
    // Generated from the component: ESS.Grid feeding inverter (averaged).Vrms.rt2.Input
    _ess_grid_feeding_inverter__averaged__vrms_rt2_output__out = _ess_grid_feeding_inverter__averaged__vrms_rms_calc_fast__period;
    // Generated from the component: ESS.Grid feeding inverter (averaged).Vrms.t1
    ...
    _ess_grid_feeding_inverter__averaged__vrms_rms_calc_fast__pc_cnt_1_state ++;
    // Generated from the component: PV.Grid feeding inverter (averaged).Vrms.rms_calc_fast
    if (333 == _pv_grid_feeding_inverter__averaged__vrms_rms_calc_fast__pc_cnt_1_state) {
        _pv_grid_feeding_inverter__averaged__vrms_rms_calc_fast__pc_cnt_1_state = 0;
    }
...
void TimerCounterHandler_1_sys_sp_cpu_dev0() {
    ...
    //////////////////////////////////////////////////////////////////////////
    //@cmp.out.block.start
    // Generated from the component: ESS.Grid feeding inverter (averaged).Vrms.rt1.Output
    // Generated from the component: ESS.Grid feeding inverter (averaged).Vrms.rt2.Output
    ...
    // Generated from the component: ESS.Grid feeding inverter (averaged).Vrms.rms_calc_slow
    if(_ess_grid_feeding_inverter__averaged__vrms_rt2_output__out > 0.0f) {
        _ess_grid_feeding_inverter__averaged__vrms_rms_calc_slow__var_rms = sqrtf(_ess_grid_feeding_inverter__averaged__vrms_rt1_output__out / _ess_grid_feeding_inverter__averaged__vrms_rt2_output__out);
    }
    else {
        _ess_grid_feeding_inverter__averaged__vrms_rms_calc_slow__var_rms = 0.0f;
    }
    ...
    // Generated from the component: ESS.Grid feeding inverter (averaged).Vrms.cpu_trans.Input
    XIo_OutFloat(0x55000100, _ess_grid_feeding_inverter__averaged__vrms_rms_calc_slow__var_rms);
    // Generated from the component: ESS.Grid feeding inverter (averaged).Vrms.rms
    HIL_OutAO(0x4000, _ess_grid_feeding_inverter__averaged__vrms_rms_calc_slow__var_rms);
    // Generated from the component: ESS.Grid feeding inverter (averaged).Vrms.sys2
