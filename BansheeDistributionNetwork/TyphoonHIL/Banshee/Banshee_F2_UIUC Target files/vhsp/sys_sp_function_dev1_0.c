...
void TimerCounterHandler_0_sys_sp_cpu0_dev1() {
    ...
    _vrms_bus204_vinst_va1__out = (HIL_InFloat(0xc80000 + 0x14));
    // Generated from the component: Vrms_bus205.Vinst.Va1
    _vrms_bus205_vinst_va1__out = (HIL_InFloat(0xc80000 + 0x624));
    ...
    _vrms_bus210_vinst_va1__out = (HIL_InFloat(0xc80000 + 0xc16));
