...
void TimerCounterHandler_0_user_sp_cpu0_dev0() {
    ...
    _abc_to_qd_product1__out = (_gain3__out * _abc_to_qd_trigonometric_function3__out);
    // Generated from the component: abc to qd.Product4
    _abc_to_qd_product4__out = (_gain3__out * _abc_to_qd_trigonometric_function5__out);
    ...
    _abc_to_qd_product2__out = (_gain5__out * _abc_to_qd_trigonometric_function2__out);
    // Generated from the component: abc to qd.Product5
    _abc_to_qd_product5__out = (_gain5__out * _abc_to_qd_trigonometric_function6__out);
    // Generated from the component: abc to qd.Product3
    _abc_to_qd_product3__out = (_gain4__out * _abc_to_qd_trigonometric_function4__out);
    // Generated from the component: abc to qd.Product6
    _abc_to_qd_product6__out = (_gain4__out * _abc_to_qd_trigonometric_function7__out);
    ...
    if (!_pll_pid_controller1__av_active) {
        _pll_pid_controller1__integrator_state += 2.0 * _gain6__out * 0.001;
    }
    // Generated from the component: PLL.C function1
    _pll_c_function1__var += (0.001 * _pll_c_function1__in);
    // Generated from the component: PLL.confine phase
