...
float _vrms_bus202_2_vinst_va1__out;
...
float _vrms_bus202_2_rms_calc_fast__var_eff_s;
float _vrms_bus202_2_rms_calc_fast__period;
float _vrms_bus202_2_rms_calc_slow__var_rms;
...
float _vrms_bus202_2_rt1_output__out =  0.0;
float _vrms_bus202_2_rt2_output__out =  0.0;
...
float _vrms_bus202_2_rms_calc_fast__v_sq_sum_state;
X_UnInt32 _vrms_bus202_2_rms_calc_fast__pc_cnt_1_state;
float _vrms_bus202_2_rms_calc_fast__var_filt;
...
void ReInit_sys_sp_cpu0_dev1() {
    ...
    _vrms_bus202_2_rt1_output__out =  0.0;
    _vrms_bus202_2_rt2_output__out =  0.0;
    ...
    _vrms_bus202_2_rms_calc_fast__var_eff_s = 0;
    _vrms_bus202_2_rms_calc_fast__period = 0.0f;
    _vrms_bus202_2_rms_calc_fast__var_filt = 0.0f;
    _vrms_bus202_2_rms_calc_fast__v_sq_sum_state = 0.0f;
    _vrms_bus202_2_rms_calc_fast__pc_cnt_1_state = 0;
...
void TimerCounterHandler_0_sys_sp_cpu0_dev1() {
    ...
    _vrms_bus201_vinst_va1__out = (HIL_InFloat(0xc80000 + 0x600));
    // Generated from the component: Vrms_bus202.Vinst.Va1
    _vrms_bus202_vinst_va1__out = (HIL_InFloat(0xc80000 + 0x16));
    // Generated from the component: Vrms_bus202_2.Vinst.Va1
    _vrms_bus202_2_vinst_va1__out = (HIL_InFloat(0xc80000 + 0x812));
    // Generated from the component: Vrms_bus204.Vinst.Va1
    _vrms_bus204_vinst_va1__out = (HIL_InFloat(0xc80000 + 0x17));
    ...
    // Generated from the component: Vrms_bus202_2.rms_calc_fast
    _vrms_bus202_2_rms_calc_fast__v_sq_sum_state = _vrms_bus202_2_rms_calc_fast__v_sq_sum_state + _vrms_bus202_2_vinst_va1__out * _vrms_bus202_2_vinst_va1__out;
    //square sum and period update on period end
    if (333 == _vrms_bus202_2_rms_calc_fast__pc_cnt_1_state) {
        _vrms_bus202_2_rms_calc_fast__var_eff_s = _vrms_bus202_2_rms_calc_fast__v_sq_sum_state;
        _vrms_bus202_2_rms_calc_fast__period = (float)333;
        _vrms_bus202_2_rms_calc_fast__v_sq_sum_state = 0.0f;
    }
    // Generated from the component: Vrms_bus202_2.sys1
    ...
    // Generated from the component: Vrms_bus202_2.rt1.Input
    _vrms_bus202_2_rt1_output__out = _vrms_bus202_2_rms_calc_fast__var_eff_s;
    // Generated from the component: Vrms_bus202_2.rt2.Input
    _vrms_bus202_2_rt2_output__out = _vrms_bus202_2_rms_calc_fast__period;
    // Generated from the component: Vrms_bus202_2.t1
    ...
    _vrms_bus202_2_rms_calc_fast__pc_cnt_1_state ++;
    // Generated from the component: Vrms_bus204.rms_calc_fast
    if (333 == _vrms_bus204_rms_calc_fast__pc_cnt_1_state) {
        _vrms_bus204_rms_calc_fast__pc_cnt_1_state = 0;
    }
...
void TimerCounterHandler_1_sys_sp_cpu0_dev1() {
    ...
    // Generated from the component: Vrms_bus202_2.rms_calc_slow
    if(_vrms_bus202_2_rt2_output__out > 0.0f) {
        _vrms_bus202_2_rms_calc_slow__var_rms = sqrtf(_vrms_bus202_2_rt1_output__out / _vrms_bus202_2_rt2_output__out);
    }
    else {
        _vrms_bus202_2_rms_calc_slow__var_rms = 0.0f;
    }
    ...
    // Generated from the component: Vrms_bus202_2.rms
    HIL_OutAO(0x4002, _vrms_bus202_2_rms_calc_slow__var_rms);
    // Generated from the component: Vrms_bus202_2.sys2
