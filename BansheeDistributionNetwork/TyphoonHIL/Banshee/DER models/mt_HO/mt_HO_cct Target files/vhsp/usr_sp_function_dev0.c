...
//@cmp.var.start
// variables
double _microturbine_be1_25a_synchronizer_clock1__out;
X_UnInt32 _microturbine_be1_25a_synchronizer_connect_mt__out;
double _microturbine_be1_25a_synchronizer_constant10__out = 10.0;
...
X_Int32 _microturbine_be1_25a_synchronizer_unit_delay1__out;
...
double _microturbine_be1_25a_synchronizer_relational_operator5__out;
X_Int32 _microturbine_be1_25a_synchronizer_product5__out;
...
X_Int32 _microturbine_be1_25a_synchronizer_signal_switch1__out;
...
double _microturbine_be1_25a_synchronizer_gain8__out;
...
//@cmp.svar.start
// state variables
double _microturbine_be1_25a_synchronizer_clock1__state;
X_Int32 _microturbine_be1_25a_synchronizer_unit_delay1__state;
...
void ReInit_user_sp_cpu_dev0() {
    ...
    _microturbine_be1_25a_synchronizer_clock1__state = 0.0f;
    _microturbine_be1_25a_synchronizer_unit_delay1__state = 0.0;
...
void TimerCounterHandler_0_user_sp_cpu_dev0() {
    ...
    //////////////////////////////////////////////////////////////////////////
    //@cmp.out.block.start
    // Generated from the component: Microturbine.BE1-25A Synchronizer.Clock1
    _microturbine_be1_25a_synchronizer_clock1__out = _microturbine_be1_25a_synchronizer_clock1__state;
    ...
    // Generated from the component: Microturbine.BE1-25A Synchronizer.Constant10
    ...
    // Generated from the component: Microturbine.BE1-25A Synchronizer.Unit Delay1
    _microturbine_be1_25a_synchronizer_unit_delay1__out = _microturbine_be1_25a_synchronizer_unit_delay1__state;
    ...
    // Generated from the component: Microturbine.BE1-25A Synchronizer.Relational operator5
    _microturbine_be1_25a_synchronizer_relational_operator5__out = (_microturbine_be1_25a_synchronizer_clock1__out > _microturbine_be1_25a_synchronizer_constant10__out) ? 1 : 0;
    // Generated from the component: Microturbine.BE1-25A Synchronizer.Product5
    _microturbine_be1_25a_synchronizer_product5__out = (_microturbine_be1_25a_synchronizer_connect_mt__out * _microturbine_be1_25a_synchronizer_unit_delay1__out);
    ...
    HIL_OutAO(0x4006, (float)_microturbine_qd0_pu__e_dp_integrator1__out);
    // Generated from the component: Microturbine.qd0(PU).E_qp_M
    HIL_OutAO(0x4007, (float)_microturbine_qd0_pu__e_qp_integrator1__out);
    // Generated from the component: Microturbine.BE1-25A Synchronizer.Current_abc_to_dq3.abc to dq1.abc to alpha beta
    _microturbine_be1_25a_synchronizer_current_abc_to_dq3_abc_to_dq1_abc_to_alpha_beta__alpha = (2.0 * _microturbine_qd0_pu__ea1_va1__out - _microturbine_qd0_pu__eb1_va1__out - _microturbine_qd0_pu__ec1_va1__out) * 0.3333333333333333;
    _microturbine_be1_25a_synchronizer_current_abc_to_dq3_abc_to_dq1_abc_to_alpha_beta__beta = (_microturbine_qd0_pu__eb1_va1__out - _microturbine_qd0_pu__ec1_va1__out) * 0.5773502691896258;
    _microturbine_be1_25a_synchronizer_current_abc_to_dq3_abc_to_dq1_abc_to_alpha_beta__gamma = (_microturbine_qd0_pu__ea1_va1__out + _microturbine_qd0_pu__eb1_va1__out + _microturbine_qd0_pu__ec1_va1__out) * 0.3333333333333333;
    // Generated from the component: Microturbine.qd0(PU).T_m_M
    HIL_OutAO(0x4012, (float)_microturbine_qd0_pu__engine_integrator1__out);
    ...
    HIL_OutAO(0x400e, (float)_microturbine_qd0_pu__phi_1d_a_integrator1__out);
    // Generated from the component: Microturbine.qd0(PU).Phi_2q_a_M
    HIL_OutAO(0x400f, (float)_microturbine_qd0_pu__phi_2q_a_integrator1__out);
    ...
    HIL_OutAO(0x4015, (float)_microturbine_qd0_pu__w_m_integrator1__out);
    // Generated from the component: Microturbine.BE1-25A Synchronizer.Signal switch1
    _microturbine_be1_25a_synchronizer_signal_switch1__out = (_microturbine_be1_25a_synchronizer_product5__out != 1.0) ? _microturbine_be1_25a_synchronizer_unit_delay1__out : _microturbine_be1_25a_synchronizer_connect_mt__out;
    ...
    HIL_OutInt32(0xf00400, _microturbine_be1_25a_synchronizer_signal_switch1__out != 0x0);
    // Generated from the component: Microturbine.BE1-25A Synchronizer.Logical operator2
    _microturbine_be1_25a_synchronizer_logical_operator2__out = !_microturbine_be1_25a_synchronizer_signal_switch1__out;
    // Generated from the component: Microturbine.qd0(PU).S2.CTC_Wrapper
    if (_microturbine_be1_25a_synchronizer_signal_switch1__out == 0x0) {
    ...
    // Generated from the component: Microturbine.BE1-25A Synchronizer.Gain8
    _microturbine_be1_25a_synchronizer_gain8__out = 4.710557197659958e-05 * _microturbine_be1_25a_synchronizer_current_abc_to_dq3_abc_to_dq1_alpha_beta_to_dq__q;
    ...
    HIL_OutAO(0x400d, (float)_microturbine_qd0_pu__governor_exciter_activation_sum1__out);
    ...
    HIL_OutAO(0x4013, (float)_microturbine_be1_25a_synchronizer_gain7__out);
    ...
    _microturbine_be1_25a_synchronizer_product2__out = (_microturbine_be1_25a_synchronizer_gain8__out * _microturbine_be1_25a_synchronizer_gain8__out);
    // Generated from the component: Microturbine.qd0(PU).VqG
    HIL_OutAO(0x4014, (float)_microturbine_be1_25a_synchronizer_gain8__out);
    // Generated from the component: Microturbine.qd0(PU).magnitude.Product5
    _microturbine_qd0_pu__magnitude_product5__out = (_microturbine_be1_25a_synchronizer_gain8__out * _microturbine_be1_25a_synchronizer_gain8__out);
    ...
    _microturbine_be1_25a_synchronizer_trigonometric_function1__out = atan2(_microturbine_be1_25a_synchronizer_gain8__out, _microturbine_be1_25a_synchronizer_limit1__out);
    ...
    HIL_OutAO(0x400c, (float)_microturbine_qd0_pu__governor_exciter_activation_activate_exciter__Activate);
    ...
    HIL_OutAO(0x4016, (float)_microturbine_qd0_pu__magnitude_mathematical_function1__out);
    ...
    HIL_OutAO(0x4011, (float)_microturbine_qd0_pu__phi_q_a_2_sum1__out);
    ...
    HIL_OutAO(0x4008, (float)_microturbine_qd0_pu__exciter_integrator2__out);
    // Generated from the component: Microturbine.qd0(PU).Exciter.V_R_M
    HIL_OutAO(0x4009, (float)_microturbine_qd0_pu__exciter_integrator3__out);
    ...
    HIL_OutAO(0x400a, (float)_microturbine_qd0_pu__exciter_integrator4__out);
    ...
    HIL_OutAO(0x4003, (float)_microturbine_be1_25a_synchronizer_sum2__out);
    ...
    HIL_OutAO(0x4010, (float)_microturbine_qd0_pu__phi_d_a_2_sum1__out);
    ...
    if (_microturbine_be1_25a_synchronizer_be1_25a_synchronizer1__dV >= 0.001) {
        ...
        _microturbine_be1_25a_synchronizer_be1_25a_synchronizer1__del_V = 0.01 * _microturbine_be1_25a_synchronizer_be1_25a_synchronizer1__dV / 0.001;
    }
    else if ((_microturbine_be1_25a_synchronizer_be1_25a_synchronizer1__dV < 0) && (_microturbine_be1_25a_synchronizer_be1_25a_synchronizer1__dV >= -1 * 0.001)) {
        _microturbine_be1_25a_synchronizer_be1_25a_synchronizer1__del_V = 0.01 * _microturbine_be1_25a_synchronizer_be1_25a_synchronizer1__dV / 0.001;
    }
    ...
    HIL_OutAO(0x4004, (float)_microturbine_be1_25a_synchronizer_sum3__out);
    ...
    _microturbine_be1_25a_synchronizer_hold_after_connect1__connect = _microturbine_be1_25a_synchronizer_signal_switch1__out;
    ...
    HIL_OutAO(0x4005, (float)_microturbine_qd0_pu__exciter_pi_limit1__out);
    ...
    if (_microturbine_be1_25a_synchronizer_be1_25a_synchronizer__df >= 0.001) {
        _microturbine_be1_25a_synchronizer_be1_25a_synchronizer__del_w = 0.01;
    }
        ...
        _microturbine_be1_25a_synchronizer_be1_25a_synchronizer__del_w = 0.01 * (_microturbine_be1_25a_synchronizer_be1_25a_synchronizer__df + 1e-4) / 0.001 + (_microturbine_be1_25a_synchronizer_be1_25a_synchronizer__angle_slip);
    }
    else if ((_microturbine_be1_25a_synchronizer_be1_25a_synchronizer__df < 0) && (_microturbine_be1_25a_synchronizer_be1_25a_synchronizer__df > (-0.001))) {
        _microturbine_be1_25a_synchronizer_be1_25a_synchronizer__del_w = 0.01 * (_microturbine_be1_25a_synchronizer_be1_25a_synchronizer__df + 1e-4) / 0.001 + (_microturbine_be1_25a_synchronizer_be1_25a_synchronizer__angle_slip);
    }
    else if (_microturbine_be1_25a_synchronizer_be1_25a_synchronizer__df <= (-1 * 0.001)) {
        _microturbine_be1_25a_synchronizer_be1_25a_synchronizer__del_w = -1 * 0.01;
    }
    ...
    _microturbine_be1_25a_synchronizer_hold_after_connect__connect = _microturbine_be1_25a_synchronizer_signal_switch1__out;
    ...
    _microturbine_be1_25a_synchronizer_logical_operator1__out = _microturbine_be1_25a_synchronizer_relational_operator1__out && _microturbine_be1_25a_synchronizer_relational_operator2__out && _microturbine_be1_25a_synchronizer_relational_operator4__out && _microturbine_be1_25a_synchronizer_relational_operator5__out ;
    ...
    HIL_OutAO(0x400b, (float)_microturbine_qd0_pu__exciter_rate_limit__out);
    ...
    // Generated from the component: Microturbine.BE1-25A Synchronizer.Clock1
    _microturbine_be1_25a_synchronizer_clock1__state += 2e-05;
    // Generated from the component: Microturbine.BE1-25A Synchronizer.Unit Delay1
    _microturbine_be1_25a_synchronizer_unit_delay1__state = _microturbine_be1_25a_synchronizer_logical_operator1__out;
    // Generated from the component: Microturbine.BE1-25A Synchronizer.Unit Delay2
    ...
    else _microturbine_be1_25a_synchronizer_hold_after_connect1__var = 0;
    // Generated from the component: Microturbine.BE1-25A Synchronizer.BE1-25A Synchronizer
    // Generated from the component: Microturbine.qd0(PU).Governor.Discrete Transfer Function1
    ...
    else _microturbine_be1_25a_synchronizer_hold_after_connect__var = 0;
    // Generated from the component: Microturbine.qd0(PU).Exciter.Rate Limit
