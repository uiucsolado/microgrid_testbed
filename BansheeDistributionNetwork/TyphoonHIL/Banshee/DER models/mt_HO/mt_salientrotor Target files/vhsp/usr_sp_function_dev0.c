...
double _microturbine_three_phase_meter1_product2__out;
double _microturbine_three_phase_meter1_product5__out;
double _microturbine_qd0_pu__phi_2q_a_product1__out;
double _microturbine_qd0_pu__phi_q_a_2_gain1__out;
double _microturbine_three_phase_meter1_product3__out;
double _microturbine_three_phase_meter1_product4__out;
...
double _microturbine_three_phase_meter1_sum1__out;
double _microturbine_three_phase_meter1_sum2__out;
...
double _microturbine_qd0_pu__v_qg2_discrete_transfer_function1__b_coeff[2] = {10000.0, -10000.0};
...
double _microturbine_qd0_pu__v_dg2_discrete_transfer_function1__b_coeff[2] = {10000.0, -10000.0};
...
void TimerCounterHandler_0_user_sp_cpu_dev0() {
    ...
    HIL_OutAO(0x4018, (float)_microturbine_qd0_pu__e_qp_integrator1__out);
    // Generated from the component: Microturbine.qd0(PU).w_m.Tm
    HIL_OutAO(0x4030, (float)_microturbine_qd0_pu__engine_integrator1__out);
    ...
    HIL_OutAO(0x4023, (float)_microturbine_qd0_pu__governor_integrator10__out);
    ...
    HIL_OutAO(0x4026, (float)_microturbine_qd0_pu__governor_integrator11__out);
    ...
    HIL_OutAO(0x4024, (float)_microturbine_qd0_pu__governor_integrator12__out);
    // Generated from the component: Microturbine.qd0(PU).Governor.P_a1
    HIL_OutAO(0x4022, (float)_microturbine_qd0_pu__governor_integrator9__out);
    // Generated from the component: Microturbine.qd0(PU).Phi_1d_a_M
    HIL_OutAO(0x402a, (float)_microturbine_qd0_pu__phi_1d_a_integrator1__out);
    // Generated from the component: Microturbine.qd0(PU).Phi_2q_a_M
    HIL_OutAO(0x402b, (float)_microturbine_qd0_pu__phi_2q_a_integrator1__out);
    ...
    HIL_OutInt32(0xf00412, _grid_connect__out != 0x0);
    ...
    HIL_OutAO(0x402e, (float)_microturbine_qd0_pu__gain16__out);
    ...
    HIL_OutInt32(0xf00411, _logical_operator1__out != 0x0);
    ...
    HIL_OutAO(0x4021, (float)_microturbine_qd0_pu__governor_exciter_activation_sum1__out);
    ...
    HIL_OutAO(0x4020, (float)_microturbine_qd0_pu__governor_exciter_activation_activate_exciter__Activate);
    ...
    HIL_OutAO(0x401b, (float)_microturbine_qd0_pu__exciter_integrator1__out);
    ...
    HIL_OutAO(0x401d, (float)_microturbine_qd0_pu__exciter_integrator2__out);
    // Generated from the component: Microturbine.qd0(PU).Exciter.V_R_M
    HIL_OutAO(0x401e, (float)_microturbine_qd0_pu__exciter_integrator3__out);
    // Generated from the component: Microturbine.qd0(PU).Exciter.E_t_M
    HIL_OutAO(0x401c, (float)_microturbine_qd0_pu__exciter_integrator4__out);
    ...
    // Generated from the component: Microturbine.Three-phase Meter1.Product2
    _microturbine_three_phase_meter1_product2__out = (_microturbine_be1_25a_synchronizer_gain5__out * _microturbine_qd0_pu__gain10__out);
    // Generated from the component: Microturbine.Three-phase Meter1.Product5
    _microturbine_three_phase_meter1_product5__out = (_microturbine_be1_25a_synchronizer_gain6__out * _microturbine_qd0_pu__gain10__out);
    // Generated from the component: Microturbine.qd0(PU).I_q_a1
    HIL_OutAO(0x4029, (float)_microturbine_qd0_pu__gain10__out);
    ...
    // Generated from the component: Microturbine.Three-phase Meter1.Product3
    _microturbine_three_phase_meter1_product3__out = (_microturbine_be1_25a_synchronizer_gain6__out * _microturbine_qd0_pu__gain11__out);
    // Generated from the component: Microturbine.Three-phase Meter1.Product4
    _microturbine_three_phase_meter1_product4__out = (_microturbine_be1_25a_synchronizer_gain5__out * _microturbine_qd0_pu__gain11__out);
    ...
    HIL_OutAO(0x4028, (float)_microturbine_qd0_pu__gain11__out);
    ...
    HIL_OutAO(0x4017, (float)_microturbine_qd0_pu__exciter_pi_limit1__out);
    ...
    HIL_OutAO(0x4031, (float)_microturbine_qd0_pu__magnitude_mathematical_function1__out);
    ...
    // Generated from the component: Microturbine.Three-phase Meter1.Sum1
    _microturbine_three_phase_meter1_sum1__out = _microturbine_three_phase_meter1_product2__out - _microturbine_three_phase_meter1_product3__out;
    // Generated from the component: Microturbine.Three-phase Meter1.Sum2
    _microturbine_three_phase_meter1_sum2__out = _microturbine_three_phase_meter1_product4__out + _microturbine_three_phase_meter1_product5__out;
    ...
    _microturbine_qd0_pu__exciter_gain9__out = 10.0 * _microturbine_qd0_pu__exciter_sum5__out;
    // Generated from the component: Microturbine.qd0(PU).|V|
    HIL_OutAO(0x4032, (float)_microturbine_qd0_pu__gain17__out);
    ...
    HIL_OutAO(0x402d, (float)_microturbine_qd0_pu__phi_q_a_2_sum1__out);
    ...
    // Generated from the component: Microturbine.Three-phase Meter1.P_pu
    HIL_OutAO(0x4015, (float)_microturbine_three_phase_meter1_sum1__out);
    // Generated from the component: Microturbine.Three-phase Meter1.Q_pu
    HIL_OutAO(0x4016, (float)_microturbine_three_phase_meter1_sum2__out);
    ...
    HIL_OutAO(0x402c, (float)_microturbine_qd0_pu__phi_d_a_2_sum1__out);
    ...
    HIL_OutAO(0x402f, (float)_microturbine_qd0_pu__w_m_sum1__out);
    ...
    HIL_OutAO(0x401a, (float)_microturbine_qd0_pu__v_qg2_sum2__out);
    ...
    HIL_OutAO(0x4019, (float)_microturbine_qd0_pu__v_dg2_sum2__out);
    ...
    HIL_OutAO(0x4027, (float)_microturbine_qd0_pu__governor_sum7__out);
    ...
    if (_microturbine_qd0_pu__exciter_rate_limit__first_step) {
        ...
        if (_microturbine_qd0_pu__exciter_rate_limit__in_rate > 0.0001) {
            _microturbine_qd0_pu__exciter_rate_limit__out = _microturbine_qd0_pu__exciter_rate_limit__prev_out + (0.0001);
        }
        if (_microturbine_qd0_pu__exciter_rate_limit__in_rate < -0.0001) {
            _microturbine_qd0_pu__exciter_rate_limit__out = _microturbine_qd0_pu__exciter_rate_limit__prev_out + (-0.0001);
        }
    ...
    HIL_OutAO(0x401f, (float)_microturbine_qd0_pu__exciter_rate_limit__out);
    ...
    HIL_OutAO(0x4025, (float)_microturbine_qd0_pu__governor_sum3__out);
    ...
    // Generated from the component: Microturbine.BE1-25A Synchronizer.abc to qd1.confine phase
    // Generated from the component: Microturbine.qd0(PU).C function1
    _microturbine_qd0_pu__c_function1__var += (2e-05 * _microturbine_qd0_pu__c_function1__in);
    // Generated from the component: Microturbine.qd0(PU).abc to qd.confine phase
    // Generated from the component: Microturbine.qd0(PU).qd to abc.confine phase
    // Generated from the component: Microturbine.qd0(PU).Governor.Exciter Activation.Comparator1
    if (_microturbine_qd0_pu__governor_exciter_activation_constant1__out < _microturbine_qd0_pu__governor_exciter_activation_abs1__out) {
