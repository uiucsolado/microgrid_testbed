...
void TimerCounterHandler_0_sys_sp_cpu_dev0() {
    ...
    _vrms_bus101_vinst_va1__out = (HIL_InFloat(0xc80000 + 0xa14));
    ...
    _vrms_bus103_vinst_va1__out = (HIL_InFloat(0xc80000 + 0x1b));
    ...
    _vrms_grid_vinst_va1__out = (HIL_InFloat(0xc80000 + 0xa15));
