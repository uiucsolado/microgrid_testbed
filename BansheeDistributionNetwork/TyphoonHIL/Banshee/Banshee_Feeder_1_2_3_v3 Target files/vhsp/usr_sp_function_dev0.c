...
void TimerCounterHandler_0_user_sp_cpu_dev0() {
    ...
    _f3_relay_udp_stream_device_transition4_output__out[0] = HIL_InFloat(0x1f00260);
    _f3_relay_udp_stream_device_transition4_output__out[1] = HIL_InFloat(0x1f00261);
    _f3_relay_udp_stream_device_transition4_output__out[2] = HIL_InFloat(0x1f00262);
    _f3_relay_udp_stream_device_transition4_output__out[3] = HIL_InFloat(0x1f00263);
    _f3_relay_udp_stream_device_transition4_output__out[4] = HIL_InFloat(0x1f00264);
    _f3_relay_udp_stream_device_transition4_output__out[5] = HIL_InFloat(0x1f00265);
    _f3_relay_udp_stream_device_transition4_output__out[6] = HIL_InFloat(0x1f00266);
    _f3_relay_udp_stream_device_transition4_output__out[7] = HIL_InFloat(0x1f00267);
    _f3_relay_udp_stream_device_transition4_output__out[8] = HIL_InFloat(0x1f00268);
    _f3_relay_udp_stream_device_transition4_output__out[9] = HIL_InFloat(0x1f00269);
    // Generated from the component: F3_RELAY UDP Stream.Device Transition5.Output
    _f3_relay_udp_stream_device_transition5_output__out[0] = HIL_InFloat(0x1f00240);
    _f3_relay_udp_stream_device_transition5_output__out[1] = HIL_InFloat(0x1f00241);
    _f3_relay_udp_stream_device_transition5_output__out[2] = HIL_InFloat(0x1f00242);
    _f3_relay_udp_stream_device_transition5_output__out[3] = HIL_InFloat(0x1f00243);
    _f3_relay_udp_stream_device_transition5_output__out[4] = HIL_InFloat(0x1f00244);
    _f3_relay_udp_stream_device_transition5_output__out[5] = HIL_InFloat(0x1f00245);
    _f3_relay_udp_stream_device_transition5_output__out[6] = HIL_InFloat(0x1f00246);
    _f3_relay_udp_stream_device_transition5_output__out[7] = HIL_InFloat(0x1f00247);
