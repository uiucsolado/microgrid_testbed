...
void TimerCounterHandler_0_user_sp_cpu_dev0() {
    ...
    _microturbine1_synchonous_machine_ia1_ia1__out = (HIL_InFloat(0xc80000 + 0xb));
    // Generated from the component: Microturbine1.Synchonous Machine.Ib1.Ia1
    _microturbine1_synchonous_machine_ib1_ia1__out = (HIL_InFloat(0xc80000 + 0xc));
    // Generated from the component: Microturbine1.Synchonous Machine.Ic1.Ia1
    _microturbine1_synchonous_machine_ic1_ia1__out = (HIL_InFloat(0xc80000 + 0xd));
    ...
    HIL_OutAO(0x401a, (float)_microturbine1_synchonous_machine_e_qp_integrator1__out);
    // Generated from the component: Microturbine1.Synchonous Machine.Phi_1d_a_M
    HIL_OutAO(0x401f, (float)_microturbine1_synchonous_machine_phi_1d_a_integrator1__out);
    // Generated from the component: Microturbine1.Synchonous Machine.Phi_2q_a_M
    HIL_OutAO(0x4020, (float)_microturbine1_synchonous_machine_phi_2q_a_integrator1__out);
    ...
    HIL_OutAO(0x401e, (float)_microturbine1_synchonous_machine_gain10__out);
    ...
    HIL_OutAO(0x401d, (float)_microturbine1_synchonous_machine_gain11__out);
    ...
    HIL_OutAO(0x4022, (float)_microturbine1_synchonous_machine_phi_q_a_2_sum1__out);
    ...
    HIL_OutAO(0x4021, (float)_microturbine1_synchonous_machine_phi_d_a_2_sum1__out);
    ...
    HIL_OutAO(0x401c, (float)_microturbine1_synchonous_machine_v_qg2_sum2__out);
    ...
    HIL_OutAO(0x401b, (float)_microturbine1_synchonous_machine_v_dg2_sum2__out);
...
void TimerCounterHandler_1_user_sp_cpu_dev0() {
    ...
    _microturbine1_cb_control_grid_islanded__out = XIo_InInt32(0x55000100);
    // Generated from the component: Microturbine1.Connect MCB
    _microturbine1_connect_mcb__out = XIo_InFloat(0x55000104);
    // Generated from the component: Microturbine1.Connect MT
    _microturbine1_connect_mt__out = XIo_InFloat(0x55000108);
    ...
    _microturbine1_ea1_va1__out = (HIL_InFloat(0xc80000 + 0x3));
    // Generated from the component: Microturbine1.Eb1.Va1
    _microturbine1_eb1_va1__out = (HIL_InFloat(0xc80000 + 0x4));
    // Generated from the component: Microturbine1.Ec1.Va1
    _microturbine1_ec1_va1__out = (HIL_InFloat(0xc80000 + 0x5));
    ...
    _microturbine1_governor_agc__out = XIo_InFloat(0x5500010c);
    ...
    _microturbine1_three_phase_meter1_ia_ia1__out = (HIL_InFloat(0xc80000 + 0xe));
    // Generated from the component: Microturbine1.Three-phase Meter1.Ib.Ia1
    _microturbine1_three_phase_meter1_ib_ia1__out = (HIL_InFloat(0xc80000 + 0xf));
    // Generated from the component: Microturbine1.Three-phase Meter1.Ic.Ia1
    _microturbine1_three_phase_meter1_ic_ia1__out = (HIL_InFloat(0xc80000 + 0x10));
    // Generated from the component: Microturbine1.Three-phase Meter1.Va_G1.Va1
    _microturbine1_three_phase_meter1_va_g1_va1__out = (HIL_InFloat(0xc80000 + 0x6));
    // Generated from the component: Microturbine1.Three-phase Meter1.Vb_G1.Va1
    _microturbine1_three_phase_meter1_vb_g1_va1__out = (HIL_InFloat(0xc80000 + 0x7));
    // Generated from the component: Microturbine1.Three-phase Meter1.Vc_G1.Va1
    _microturbine1_three_phase_meter1_vc_g1_va1__out = (HIL_InFloat(0xc80000 + 0x8));
    // Generated from the component: Microturbine1.Vref
    _microturbine1_vref__out = XIo_InFloat(0x55000110);
    // Generated from the component: Microturbine1.wref
    _microturbine1_wref__out = XIo_InFloat(0x55000114);
    ...
    HIL_OutAO(0x4009, (float)_microturbine1_be1_25a_synchronizer_unit_delay2__out);
    ...
    HIL_OutAO(0x4018, (float)_microturbine1_governor_integrator1__out);
    ...
    HIL_OutAO(0x4026, (float)_microturbine1_synchonous_machine_rate_transition2_output__out);
    ...
    HIL_OutAO(0x4012, (float)_microturbine1_exciter_integrator1__out);
    ...
    HIL_OutAO(0x4014, (float)_microturbine1_exciter_integrator2__out);
    // Generated from the component: Microturbine1.Exciter.V_R_M
    HIL_OutAO(0x4015, (float)_microturbine1_exciter_integrator3__out);
    // Generated from the component: Microturbine1.Exciter.E_t_M
    HIL_OutAO(0x4013, (float)_microturbine1_exciter_integrator4__out);
    ...
    HIL_OutAO(0x4023, (float)_microturbine1_three_phase_meter1_pq_measure_pq_power_meter1__Pdc);
    // Generated from the component: Microturbine1.Three-phase Meter1.POWER_Q
    HIL_OutAO(0x4024, (float)_microturbine1_three_phase_meter1_pq_measure_pq_power_meter1__Qdc);
    // Generated from the component: Microturbine1.Three-phase Meter1.POWER_S
    HIL_OutAO(0x4025, (float)_microturbine1_three_phase_meter1_pq_measure_pq_power_meter1__apparent);
    ...
    HIL_OutAO(0x4017, (float)_microturbine1_governor_exciter_activation_sum1__out);
    ...
    HIL_OutAO(0x400d, (float)_microturbine1_be1_25a_synchronizer_gain4__out);
    ...
    HIL_OutAO(0x4019, (float)_microturbine1_governor_rate_limiter2__out);
    ...
    HIL_OutAO(0x4016, (float)_microturbine1_exciter_rate_limit__out);
    ...
    HIL_OutAO(0x4002, (float)_microturbine1_be1_25a_synchronizer_gain5__out);
    ...
    HIL_OutAO(0x4003, (float)_microturbine1_be1_25a_synchronizer_gain6__out);
    ...
    HIL_OutAO(0x4000, (float)_microturbine1_be1_25a_synchronizer_gain7__out);
    ...
    HIL_OutAO(0x4001, (float)_microturbine1_be1_25a_synchronizer_gain12__out);
    ...
    HIL_OutAO(0x4008, (float)_microturbine1_be1_25a_synchronizer_pll_pid_controller1__out);
    ...
    HIL_OutAO(0x400e, (float)_microturbine1_be1_25a_synchronizer_gain13__out);
    ...
    HIL_OutAO(0x400b, (float)_microturbine1_be1_25a_synchronizer_gain16__out);
    ...
    HIL_OutAO(0x4007, (float)_microturbine1_be1_25a_synchronizer_sum2__out);
    // Generated from the component: Microturbine1.BE1-25A Synchronizer.|V|
    HIL_OutAO(0x4011, (float)_microturbine1_be1_25a_synchronizer_mathematical_function2__out);
    ...
    HIL_OutAO(0x400a, (float)_microturbine1_be1_25a_synchronizer_gain17__out);
    ...
    HIL_OutAO(0x4010, (float)_microturbine1_be1_25a_synchronizer_magnitude_mathematical_function1__out);
    ...
    HIL_OutAO(0x4004, (float)_microturbine1_be1_25a_synchronizer_confine_phase__out);
    // Generated from the component: Microturbine1.BE1-25A Synchronizer.|E|
    HIL_OutAO(0x400f, (float)_microturbine1_be1_25a_synchronizer_gain18__out);
    ...
    HIL_OutAO(0x400c, (float)_microturbine1_be1_25a_synchronizer_sum3__out);
    ...
    HIL_OutAO(0x4027, (float)_microturbine1_gain17__out);
    ...
    HIL_OutAO(0x4006, (float)_microturbine1_be1_25a_synchronizer_hold_after_connect__out);
    ...
    HIL_OutAO(0x4005, (float)_microturbine1_be1_25a_synchronizer_hold_after_connect1__out);
