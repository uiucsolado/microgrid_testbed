...
void TimerCounterHandler_0_sys_sp_cpu_dev0() {
    ...
    _vrms_bus101_vinst_va1__out = (HIL_InFloat(0xc80000 + 0xa13));
    ...
    _vrms_grid_vinst_va1__out = (HIL_InFloat(0xc80000 + 0xa14));
...
void TimerCounterHandler_1_sys_sp_cpu_dev0() {
    ...
    HIL_OutAO(0x4009, _vrms_grid_rms_calc_slow__var_rms);
