...
double _microturbine1_exciter_red_constant3__out = 0.0;
...
double _microturbine1_governor_integrator13__out;
double _microturbine1_governor_pref__out;
...
double _vbr_variable_load1_in_pref__out;
...
double _microturbine1_exciter_red_integrator4__out;
X_Int32 _microturbine1_exciter_red_logical_operator1__out;
double _microturbine1_exciter_red_pi_integrator1__out;
float _microturbine1_exciter_red_exciter_on__tmp;
double _microturbine1_engine_sum1__out;
double _microturbine1_governor_sum15__out;
...
double _microturbine1_exciter_red_sum5__out;
double _microturbine1_exciter_red_sum6__out;
float _microturbine1_exciter_red_exciter_off__tmp;
double _microturbine1_engine_gain1__out;
double _microturbine1_governor_gain41__out;
double _microturbine1_governor_exciter_activation_sum1__out;
double _microturbine1_governor_sum13__out;
...
double _microturbine1_exciter_red_gain9__out;
double _microturbine1_exciter_red__v_2__out;
double _microturbine1_governor_sum14__out;
double _microturbine1_governor_exciter_activation_abs1__out;
double _microturbine1_governor_rate_limiter3__in_rate;
...
double _microturbine1_exciter_red_rate_limit1__in_rate;
double _microturbine1_governor_gain40__out;
...
double _microturbine1_exciter_red_gain20__out;
double _microturbine1_governor_sum12__out;
...
double _microturbine1_exciter_red_gain19__out;
...
double _microturbine1_exciter_red_pi_ki__out;
double _microturbine1_exciter_red_pi_kp__out;
...
double _microturbine1_exciter_red_pi_sum5__out;
...
double _microturbine1_exciter_red_pi_limit1__out;
...
double _microturbine1_exciter_red_gain18__out;
double _microturbine1_exciter_red_pi_sum6__out;
...
double _microturbine1_exciter_red_pi_kb__out;
...
double _microturbine1_exciter_red_pi_sum7__out;
...
X_Int32 _microturbine1_exciter_red_rate_transition1_output__out = (X_Int32) 0.0;

double _microturbine1_exciter_red_rate_transition3_output__out =  0.0;

double _microturbine1_exciter_red_rate_transition4_output__out =  0.0;

double _microturbine1_governor_integrator13__state;
double _microturbine1_governor_rate_transition2_output__out =  0.0;

double _microturbine1_governor_rate_transition3_output__out =  0.0;

X_Int32 _microturbine1_governor_rate_transition4_output__out = (X_Int32) 0.0;
...
double _microturbine1_exciter_red_integrator4__state;
X_Int32 _microturbine1_exciter_red_integrator4__reset_state;
double _microturbine1_exciter_red_pi_integrator1__state;
X_Int32 _microturbine1_exciter_red_pi_integrator1__reset_state;
...
double _microturbine1_governor_rate_limiter3__prev_out;
double _microturbine1_governor_rate_limiter3__out;
int _microturbine1_governor_rate_limiter3__first_step;
...
double _microturbine1_exciter_red_rate_limit1__prev_out;
double _microturbine1_exciter_red_rate_limit1__out;
int _microturbine1_exciter_red_rate_limit1__first_step;
...
void ReInit_user_sp_cpu_dev0() {
    ...
    _microturbine1_exciter_red_rate_transition1_output__out = (X_Int32) 0.0;
    _microturbine1_exciter_red_rate_transition3_output__out =  0.0;
    _microturbine1_exciter_red_rate_transition4_output__out =  0.0;
    _microturbine1_governor_integrator13__state = 0.0;
    _microturbine1_governor_rate_transition2_output__out =  0.0;
    _microturbine1_governor_rate_transition3_output__out =  0.0;
    _microturbine1_governor_rate_transition4_output__out = (X_Int32) 0.0;
    ...
    _microturbine1_exciter_red_integrator4__state = 0.0;
    _microturbine1_exciter_red_integrator4__reset_state = 2;
    _microturbine1_exciter_red_pi_integrator1__state = 0.0;
    _microturbine1_exciter_red_pi_integrator1__reset_state = 2;
    ...
    _microturbine1_governor_rate_limiter3__first_step = 1;
    ...
    _microturbine1_exciter_red_rate_limit1__first_step = 1;
...
void TimerCounterHandler_0_user_sp_cpu_dev0() {
    ...
    HIL_OutAO(0x4026, (float)_microturbine1_synchonous_machine_e_qp_integrator1__out);
    // Generated from the component: Microturbine1.Synchonous Machine.Phi_1d_a_M
    HIL_OutAO(0x402b, (float)_microturbine1_synchonous_machine_phi_1d_a_integrator1__out);
    // Generated from the component: Microturbine1.Synchonous Machine.Phi_2q_a_M
    HIL_OutAO(0x402c, (float)_microturbine1_synchonous_machine_phi_2q_a_integrator1__out);
    ...
    HIL_OutAO(0x402a, (float)_microturbine1_synchonous_machine_gain10__out);
    ...
    HIL_OutAO(0x4029, (float)_microturbine1_synchonous_machine_gain11__out);
    ...
    HIL_OutAO(0x402e, (float)_microturbine1_synchonous_machine_phi_q_a_2_sum1__out);
    ...
    HIL_OutAO(0x402d, (float)_microturbine1_synchonous_machine_phi_d_a_2_sum1__out);
    ...
    HIL_OutAO(0x4028, (float)_microturbine1_synchonous_machine_v_qg2_sum2__out);
    ...
    HIL_OutAO(0x4027, (float)_microturbine1_synchonous_machine_v_dg2_sum2__out);
...
void TimerCounterHandler_1_user_sp_cpu_dev0() {
    ...
    _vbr_variable_load1_ia_ia1__out = (HIL_InFloat(0xc80000 + 0x643));
    // Generated from the component: VBR Variable Load1.Ib.Ia1
    _vbr_variable_load1_ib_ia1__out = (HIL_InFloat(0xc80000 + 0x644));
    // Generated from the component: VBR Variable Load1.Ic.Ia1
    _vbr_variable_load1_ic_ia1__out = (HIL_InFloat(0xc80000 + 0x645));
    // Generated from the component: VBR Variable Load1.Va.Va1
    _vbr_variable_load1_va_va1__out = (HIL_InFloat(0xc80000 + 0x632));
    // Generated from the component: VBR Variable Load1.Vb.Va1
    _vbr_variable_load1_vb_va1__out = (HIL_InFloat(0xc80000 + 0x633));
    // Generated from the component: VBR Variable Load1.Vc.Va1
    _vbr_variable_load1_vc_va1__out = (HIL_InFloat(0xc80000 + 0x634));
    // Generated from the component: VBR Variable Load1_in.Enable
    _vbr_variable_load1_in_enable__out = XIo_InFloat(0x55000148);
    // Generated from the component: VBR Variable Load1_in.Pref
    _vbr_variable_load1_in_pref__out = XIo_InFloat(0x5500014c);
    // Generated from the component: VBR Variable Load1_in.Qref
    _vbr_variable_load1_in_qref__out = XIo_InFloat(0x55000150);
    ...
    _vbr_variable_load1_in_bus_join1__out[1] = _vbr_variable_load1_in_pref__out;
    ...
    HIL_OutAO(0x4034, (float)_vbr_variable_load1_power_meter1__Pdc);
    // Generated from the component: VBR Variable Load1.Q
    HIL_OutAO(0x4035, (float)_vbr_variable_load1_power_meter1__Qdc);
    // Generated from the component: VBR Variable Load1.S
    HIL_OutAO(0x4036, (float)_vbr_variable_load1_power_meter1__apparent);
    ...
    HIL_OutAO(0x4037, (float)_vbr_variable_load1_power_meter1__k_factor);
    ...
    HIL_OutAO(0x4038, (float)_vbr_variable_load1_out_bus_split1__out);
    // Generated from the component: VBR Variable Load1_out.Q
    HIL_OutAO(0x4039, (float)_vbr_variable_load1_out_bus_split1__out1);
    // Generated from the component: VBR Variable Load1_out.S
    HIL_OutAO(0x403a, (float)_vbr_variable_load1_out_bus_split1__out2);
    // Generated from the component: VBR Variable Load1_out.pf
    HIL_OutAO(0x403b, (float)_vbr_variable_load1_out_bus_split1__out3);
    ...
    HIL_OutFloat(149684224, (float) _vbr_variable_load1_control_dq_to_abc1_alpha_beta_to_abc__A);
    // Generated from the component: VBR Variable Load1.Vi_b.Vs1
    HIL_OutFloat(149684225, (float) _vbr_variable_load1_control_dq_to_abc1_alpha_beta_to_abc__B);
    // Generated from the component: VBR Variable Load1.Vi_c.Vs1
    HIL_OutFloat(149684226, (float) _vbr_variable_load1_control_dq_to_abc1_alpha_beta_to_abc__C);
    //@cmp.out.block.end
    //////////////////////////////////////////////////////////////////////////
    // Update block
    //////////////////////////////////////////////////////////////////////////
...
void TimerCounterHandler_2_user_sp_cpu_dev0() {
    ...
    _f1_cb2_meas1_ia_ia1__out = (HIL_InFloat(0xc80000 + 0x637));
    // Generated from the component: F1_CB2.Meas1.IB.Ia1
    _f1_cb2_meas1_ib_ia1__out = (HIL_InFloat(0xc80000 + 0x638));
    // Generated from the component: F1_CB2.Meas1.IC.Ia1
    _f1_cb2_meas1_ic_ia1__out = (HIL_InFloat(0xc80000 + 0x639));
    // Generated from the component: F1_CB2.Meas1.VA.Va1
    _f1_cb2_meas1_va_va1__out = (HIL_InFloat(0xc80000 + 0x61a));
    // Generated from the component: F1_CB2.Meas1.VB.Va1
    _f1_cb2_meas1_vb_va1__out = (HIL_InFloat(0xc80000 + 0x61b));
    // Generated from the component: F1_CB2.Meas1.VC.Va1
    _f1_cb2_meas1_vc_va1__out = (HIL_InFloat(0xc80000 + 0x61c));
    // Generated from the component: F1_CB2.Meas2.VA.Va1
    _f1_cb2_meas2_va_va1__out = (HIL_InFloat(0xc80000 + 0x61d));
    // Generated from the component: F1_CB2.Meas2.VB.Va1
    _f1_cb2_meas2_vb_va1__out = (HIL_InFloat(0xc80000 + 0x61e));
    // Generated from the component: F1_CB2.Meas2.VC.Va1
    _f1_cb2_meas2_vc_va1__out = (HIL_InFloat(0xc80000 + 0x61f));
    ...
    _f1_cb6_meas1_ia_ia1__out = (HIL_InFloat(0xc80000 + 0x63a));
    // Generated from the component: F1_CB6.Meas1.IB.Ia1
    _f1_cb6_meas1_ib_ia1__out = (HIL_InFloat(0xc80000 + 0x63b));
    // Generated from the component: F1_CB6.Meas1.IC.Ia1
    _f1_cb6_meas1_ic_ia1__out = (HIL_InFloat(0xc80000 + 0x63c));
    // Generated from the component: F1_CB6.Meas1.VA.Va1
    _f1_cb6_meas1_va_va1__out = (HIL_InFloat(0xc80000 + 0x620));
    // Generated from the component: F1_CB6.Meas1.VB.Va1
    _f1_cb6_meas1_vb_va1__out = (HIL_InFloat(0xc80000 + 0x621));
    // Generated from the component: F1_CB6.Meas1.VC.Va1
    _f1_cb6_meas1_vc_va1__out = (HIL_InFloat(0xc80000 + 0x622));
    // Generated from the component: F1_CB6.Meas2.VA.Va1
    _f1_cb6_meas2_va_va1__out = (HIL_InFloat(0xc80000 + 0x623));
    // Generated from the component: F1_CB6.Meas2.VB.Va1
    _f1_cb6_meas2_vb_va1__out = (HIL_InFloat(0xc80000 + 0x624));
    // Generated from the component: F1_CB6.Meas2.VC.Va1
    _f1_cb6_meas2_vc_va1__out = (HIL_InFloat(0xc80000 + 0x625));
    ...
    _f1_cb7_meas1_ia_ia1__out = (HIL_InFloat(0xc80000 + 0x63d));
    // Generated from the component: F1_CB7.Meas1.IB.Ia1
    _f1_cb7_meas1_ib_ia1__out = (HIL_InFloat(0xc80000 + 0x63e));
    // Generated from the component: F1_CB7.Meas1.IC.Ia1
    _f1_cb7_meas1_ic_ia1__out = (HIL_InFloat(0xc80000 + 0x63f));
    // Generated from the component: F1_CB7.Meas1.VA.Va1
    _f1_cb7_meas1_va_va1__out = (HIL_InFloat(0xc80000 + 0x626));
    // Generated from the component: F1_CB7.Meas1.VB.Va1
    _f1_cb7_meas1_vb_va1__out = (HIL_InFloat(0xc80000 + 0x627));
    // Generated from the component: F1_CB7.Meas1.VC.Va1
    _f1_cb7_meas1_vc_va1__out = (HIL_InFloat(0xc80000 + 0x628));
    // Generated from the component: F1_CB7.Meas2.VA.Va1
    _f1_cb7_meas2_va_va1__out = (HIL_InFloat(0xc80000 + 0x629));
    // Generated from the component: F1_CB7.Meas2.VB.Va1
    _f1_cb7_meas2_vb_va1__out = (HIL_InFloat(0xc80000 + 0x62a));
    // Generated from the component: F1_CB7.Meas2.VC.Va1
    _f1_cb7_meas2_vc_va1__out = (HIL_InFloat(0xc80000 + 0x62b));
    ...
    _f1_pcc_meas1_ia_ia1__out = (HIL_InFloat(0xc80000 + 0xa18));
    // Generated from the component: F1_PCC.Meas1.IB.Ia1
    _f1_pcc_meas1_ib_ia1__out = (HIL_InFloat(0xc80000 + 0xa19));
    // Generated from the component: F1_PCC.Meas1.IC.Ia1
    _f1_pcc_meas1_ic_ia1__out = (HIL_InFloat(0xc80000 + 0xa1a));
    // Generated from the component: F1_PCC.Meas1.VA.Va1
    _f1_pcc_meas1_va_va1__out = (HIL_InFloat(0xc80000 + 0xa0d));
    // Generated from the component: F1_PCC.Meas1.VB.Va1
    _f1_pcc_meas1_vb_va1__out = (HIL_InFloat(0xc80000 + 0xa0e));
    // Generated from the component: F1_PCC.Meas1.VC.Va1
    _f1_pcc_meas1_vc_va1__out = (HIL_InFloat(0xc80000 + 0xa0f));
    // Generated from the component: F1_PCC.Meas2.VA.Va1
    _f1_pcc_meas2_va_va1__out = (HIL_InFloat(0xc80000 + 0xa10));
    // Generated from the component: F1_PCC.Meas2.VB.Va1
    _f1_pcc_meas2_vb_va1__out = (HIL_InFloat(0xc80000 + 0xa11));
    // Generated from the component: F1_PCC.Meas2.VC.Va1
    _f1_pcc_meas2_vc_va1__out = (HIL_InFloat(0xc80000 + 0xa12));
    ...
    _f1_vl_cb1_f1_cb7__out = XIo_InInt32(0x5500012c);
    // Generated from the component: F1_VL_CB1.Meas1.IA.Ia1
    _f1_vl_cb1_meas1_ia_ia1__out = (HIL_InFloat(0xc80000 + 0x640));
    // Generated from the component: F1_VL_CB1.Meas1.IB.Ia1
    _f1_vl_cb1_meas1_ib_ia1__out = (HIL_InFloat(0xc80000 + 0x641));
    // Generated from the component: F1_VL_CB1.Meas1.IC.Ia1
    _f1_vl_cb1_meas1_ic_ia1__out = (HIL_InFloat(0xc80000 + 0x642));
    // Generated from the component: F1_VL_CB1.Meas1.VA.Va1
    _f1_vl_cb1_meas1_va_va1__out = (HIL_InFloat(0xc80000 + 0x62c));
    // Generated from the component: F1_VL_CB1.Meas1.VB.Va1
    _f1_vl_cb1_meas1_vb_va1__out = (HIL_InFloat(0xc80000 + 0x62d));
    // Generated from the component: F1_VL_CB1.Meas1.VC.Va1
    _f1_vl_cb1_meas1_vc_va1__out = (HIL_InFloat(0xc80000 + 0x62e));
    // Generated from the component: F1_VL_CB1.Meas2.VA.Va1
    _f1_vl_cb1_meas2_va_va1__out = (HIL_InFloat(0xc80000 + 0x62f));
    // Generated from the component: F1_VL_CB1.Meas2.VB.Va1
    _f1_vl_cb1_meas2_vb_va1__out = (HIL_InFloat(0xc80000 + 0x630));
    // Generated from the component: F1_VL_CB1.Meas2.VC.Va1
    _f1_vl_cb1_meas2_vc_va1__out = (HIL_InFloat(0xc80000 + 0x631));
    ...
    // Generated from the component: Microturbine1.Exciter_red.Constant3
    // Generated from the component: Microturbine1.Exciter_red.Rate Transition1.Output
    // Generated from the component: Microturbine1.Exciter_red.Rate Transition3.Output
    // Generated from the component: Microturbine1.Exciter_red.Rate Transition4.Output
    ...
    // Generated from the component: Microturbine1.Governor.Integrator13
    _microturbine1_governor_integrator13__out = _microturbine1_governor_integrator13__state;
    // Generated from the component: Microturbine1.Governor.Pref
    _microturbine1_governor_pref__out = XIo_InFloat(0x5500013c);
    ...
    _microturbine1_vref__out = XIo_InFloat(0x55000140);
    // Generated from the component: Microturbine1.wref
    _microturbine1_wref__out = XIo_InFloat(0x55000144);
    ...
    HIL_OutAO(0x4018, (float)_microturbine1_be1_25a_synchronizer_unit_delay2__out);
    ...
    // Generated from the component: Microturbine1.Exciter_red.Integrator4
    if (((_microturbine1_exciter_red_rate_transition1_output__out > 0.0) && (_microturbine1_exciter_red_integrator4__reset_state <= 0)) || ((_microturbine1_exciter_red_rate_transition1_output__out <= 0.0) && (_microturbine1_exciter_red_integrator4__reset_state == 1))) {
        _microturbine1_exciter_red_integrator4__state = 0.0;
    }
    _microturbine1_exciter_red_integrator4__out = _microturbine1_exciter_red_integrator4__state;
    // Generated from the component: Microturbine1.Exciter_red.Logical operator1
    _microturbine1_exciter_red_logical_operator1__out = !_microturbine1_exciter_red_rate_transition1_output__out;
    // Generated from the component: Microturbine1.Exciter_red.PI.Integrator1
    if (((_microturbine1_exciter_red_rate_transition1_output__out > 0.0) && (_microturbine1_exciter_red_pi_integrator1__reset_state <= 0)) || ((_microturbine1_exciter_red_rate_transition1_output__out <= 0.0) && (_microturbine1_exciter_red_pi_integrator1__reset_state == 1))) {
        _microturbine1_exciter_red_pi_integrator1__state = 0.0;
    }
    _microturbine1_exciter_red_pi_integrator1__out = _microturbine1_exciter_red_pi_integrator1__state;
    // Generated from the component: Microturbine1.Exciter_red.exciter ON
    HIL_OutInt32(0xf0040e, _microturbine1_exciter_red_rate_transition1_output__out != 0x0);
    // Generated from the component: Microturbine1.Engine.Sum1
    _microturbine1_engine_sum1__out =  - _microturbine1_engine_integrator1__out + _microturbine1_governor_integrator13__out;
    // Generated from the component: Microturbine1.Governor.P_sv
    HIL_OutAO(0x4024, (float)_microturbine1_governor_integrator13__out);
    // Generated from the component: Microturbine1.Governor.Sum15
    _microturbine1_governor_sum15__out = _microturbine1_governor_agc_offset__out + _microturbine1_governor_pref__out;
    // Generated from the component: Microturbine1.Governor.Gain39
    _microturbine1_governor_gain39__out = 0.005305164769729845 * _microturbine1_governor_rate_transition3_output__out;
    // Generated from the component: Microturbine1.Exciter_red.Rate Transition1.Input
    _microturbine1_exciter_red_rate_transition1_output__out = _microturbine1_governor_rate_transition4_output__out;
    ...
    HIL_OutAO(0x4032, (float)_microturbine1_synchonous_machine_rate_transition2_output__out);
    ...
    HIL_OutAO(0x400a, (float)_diesel_mcb_rms_value1__out);
    // Generated from the component: DIESEL_MCB.VB_grid2rms
    HIL_OutAO(0x400b, (float)_diesel_mcb_rms_value2__out);
    // Generated from the component: DIESEL_MCB.VC_grid2rms
    HIL_OutAO(0x400c, (float)_diesel_mcb_rms_value3__out);
    ...
    // Generated from the component: Microturbine1.Exciter_red.E_t_M
    HIL_OutAO(0x4021, (float)_microturbine1_exciter_red_integrator4__out);
    // Generated from the component: Microturbine1.Exciter_red.Sum5
    _microturbine1_exciter_red_sum5__out =  - _microturbine1_exciter_red_integrator4__out + _microturbine1_exciter_red_rate_transition3_output__out;
    // Generated from the component: Microturbine1.Exciter_red.Sum6
    _microturbine1_exciter_red_sum6__out = _microturbine1_exciter_red_rate_transition4_output__out - _microturbine1_exciter_red_integrator4__out;
    // Generated from the component: Microturbine1.Exciter_red.exciter OFF
    HIL_OutInt32(0xf0040d, _microturbine1_exciter_red_logical_operator1__out != 0x0);
    ...
    // Generated from the component: Microturbine1.Governor.Gain41
    _microturbine1_governor_gain41__out = 2.857142857142857e-07 * _microturbine1_governor_sum15__out;
    // Generated from the component: Microturbine1.Governor.Exciter Activation.Sum1
    _microturbine1_governor_exciter_activation_sum1__out = _microturbine1_governor_exciter_activation_constant2__out - _microturbine1_governor_gain39__out;
    // Generated from the component: Microturbine1.Governor.Sum13
    _microturbine1_governor_sum13__out = _microturbine1_governor_rate_transition2_output__out - _microturbine1_governor_gain39__out;
    ...
    HIL_OutAO(0x402f, (float)_microturbine1_three_phase_meter1_pq_measure_pq_power_meter1__Pdc);
    // Generated from the component: Microturbine1.Three-phase Meter1.POWER_Q
    HIL_OutAO(0x4030, (float)_microturbine1_three_phase_meter1_pq_measure_pq_power_meter1__Qdc);
    // Generated from the component: Microturbine1.Three-phase Meter1.POWER_S
    HIL_OutAO(0x4031, (float)_microturbine1_three_phase_meter1_pq_measure_pq_power_meter1__apparent);
    ...
    // Generated from the component: Microturbine1.Exciter_red.Gain9
    _microturbine1_exciter_red_gain9__out = 1000.0 * _microturbine1_exciter_red_sum5__out;
    // Generated from the component: Microturbine1.Exciter_red.|V|2
    _microturbine1_exciter_red__v_2__out = (_microturbine1_exciter_red_rate_transition1_output__out != 1.0) ? _microturbine1_exciter_red_constant3__out : _microturbine1_exciter_red_sum6__out;
    // Generated from the component: Microturbine1.Governor.Sum14
    _microturbine1_governor_sum14__out = _microturbine1_governor_gain41__out - _microturbine1_governor_integrator13__out;
    ...
    HIL_OutAO(0x4023, (float)_microturbine1_governor_exciter_activation_sum1__out);
    // Generated from the component: Microturbine1.Governor.Rate Limiter3
    if (_microturbine1_governor_rate_limiter3__first_step) {
        _microturbine1_governor_rate_limiter3__out = _microturbine1_governor_sum13__out;
    } else {
        _microturbine1_governor_rate_limiter3__out = _microturbine1_governor_sum13__out;
        _microturbine1_governor_rate_limiter3__in_rate = _microturbine1_governor_sum13__out - _microturbine1_governor_rate_limiter3__prev_out;
        if (_microturbine1_governor_rate_limiter3__in_rate > 0.005) {
            _microturbine1_governor_rate_limiter3__out = _microturbine1_governor_rate_limiter3__prev_out + (0.005);
        }
        if (_microturbine1_governor_rate_limiter3__in_rate < -0.005) {
            _microturbine1_governor_rate_limiter3__out = _microturbine1_governor_rate_limiter3__prev_out + (-0.005);
        }
    ...
    HIL_OutAO(0x401c, (float)_microturbine1_be1_25a_synchronizer_gain4__out);
    ...
    _microturbine1_governor_rate_transition3_output__out = _microturbine1_gain18__out;
    // Generated from the component: F1_PCC.P
    HIL_OutAO(0x400d, (float)_f1_pcc_pcc_measurements_power_meter1__Pdc);
    ...
    HIL_OutAO(0x400e, (float)_f1_pcc_pcc_measurements_power_meter1__Qdc);
    ...
    // Generated from the component: Microturbine1.Exciter_red.Rate Limit1
    if (_microturbine1_exciter_red_rate_limit1__first_step) {
        _microturbine1_exciter_red_rate_limit1__out = _microturbine1_exciter_red__v_2__out;
    } else {
        _microturbine1_exciter_red_rate_limit1__out = _microturbine1_exciter_red__v_2__out;
        _microturbine1_exciter_red_rate_limit1__in_rate = _microturbine1_exciter_red__v_2__out - _microturbine1_exciter_red_rate_limit1__prev_out;
        if (_microturbine1_exciter_red_rate_limit1__in_rate > 0.005) {
            _microturbine1_exciter_red_rate_limit1__out = _microturbine1_exciter_red_rate_limit1__prev_out + (0.005);
        }
        if (_microturbine1_exciter_red_rate_limit1__in_rate < -0.005) {
            _microturbine1_exciter_red_rate_limit1__out = _microturbine1_exciter_red_rate_limit1__prev_out + (-0.005);
        }
    }
    // Generated from the component: Microturbine1.Governor.Gain40
    _microturbine1_governor_gain40__out = 0.1 * _microturbine1_governor_sum14__out;
    ...
    HIL_OutAO(0x4025, (float)_microturbine1_governor_rate_limiter3__out);
    ...
    // Generated from the component: Microturbine1.Exciter_red.Gain20
    _microturbine1_exciter_red_gain20__out = 20.0 * _microturbine1_exciter_red_rate_limit1__out;
    // Generated from the component: Microturbine1.Exciter_red.voltage_diff
    HIL_OutAO(0x4022, (float)_microturbine1_exciter_red_rate_limit1__out);
    // Generated from the component: Microturbine1.Governor.Sum12
    _microturbine1_governor_sum12__out = _microturbine1_governor_gain40__out + _microturbine1_governor_rate_limiter3__out;
    ...
    // Generated from the component: Microturbine1.Exciter_red.Gain19
    _microturbine1_exciter_red_gain19__out = 1.0 * _microturbine1_exciter_red_gain20__out;
    // Generated from the component: Microturbine1.Governor.Gain38
    _microturbine1_governor_gain38__out = 7.5 * _microturbine1_governor_sum12__out;
    // Generated from the component: Microturbine1.Governor.Rate Transition4.Input
    _microturbine1_governor_rate_transition4_output__out = _microturbine1_governor_exciter_activation_activate_exciter__Activate;
    ...
    HIL_OutAO(0x4011, (float)_microturbine1_be1_25a_synchronizer_gain5__out);
    ...
    HIL_OutAO(0x4012, (float)_microturbine1_be1_25a_synchronizer_gain6__out);
    // Generated from the component: Microturbine1.Exciter_red.PI.Ki
    _microturbine1_exciter_red_pi_ki__out = 1.19 * _microturbine1_exciter_red_gain19__out;
    // Generated from the component: Microturbine1.Exciter_red.PI.Kp
    _microturbine1_exciter_red_pi_kp__out = 1.16 * _microturbine1_exciter_red_gain19__out;
    ...
    HIL_OutAO(0x400f, (float)_microturbine1_be1_25a_synchronizer_gain7__out);
    ...
    HIL_OutAO(0x4010, (float)_microturbine1_be1_25a_synchronizer_gain12__out);
    ...
    HIL_OutAO(0x4017, (float)_microturbine1_be1_25a_synchronizer_pll_pid_controller1__out);
    ...
    // Generated from the component: Microturbine1.Exciter_red.PI.Sum5
    _microturbine1_exciter_red_pi_sum5__out = _microturbine1_exciter_red_pi_kp__out + _microturbine1_exciter_red_pi_integrator1__out;
    ...
    HIL_OutAO(0x401d, (float)_microturbine1_be1_25a_synchronizer_gain13__out);
    ...
    // Generated from the component: Microturbine1.Exciter_red.PI.Limit1
    if (_microturbine1_exciter_red_pi_sum5__out > 3.0) {
        _microturbine1_exciter_red_pi_limit1__out = 3.0;
    } else if (_microturbine1_exciter_red_pi_sum5__out < -3.0) {
        _microturbine1_exciter_red_pi_limit1__out = -3.0;
    } else {
        _microturbine1_exciter_red_pi_limit1__out = _microturbine1_exciter_red_pi_sum5__out;
    }
    ...
    HIL_OutAO(0x401a, (float)_microturbine1_be1_25a_synchronizer_gain16__out);
    ...
    HIL_OutAO(0x4016, (float)_microturbine1_be1_25a_synchronizer_sum2__out);
    // Generated from the component: Microturbine1.BE1-25A Synchronizer.|V|
    HIL_OutAO(0x4020, (float)_microturbine1_be1_25a_synchronizer_mathematical_function2__out);
    ...
    // Generated from the component: Microturbine1.Exciter_red.Gain18
    _microturbine1_exciter_red_gain18__out = 11267.652816802622 * _microturbine1_exciter_red_pi_limit1__out;
    // Generated from the component: Microturbine1.Exciter_red.PI.Sum6
    _microturbine1_exciter_red_pi_sum6__out =  - _microturbine1_exciter_red_pi_sum5__out + _microturbine1_exciter_red_pi_limit1__out;
    ...
    HIL_OutAO(0x4019, (float)_microturbine1_be1_25a_synchronizer_gain17__out);
    ...
    HIL_OutAO(0x401f, (float)_microturbine1_be1_25a_synchronizer_magnitude_mathematical_function1__out);
    ...
    // Generated from the component: Microturbine1.Exciter_red.Rate Transition3.Input
    _microturbine1_exciter_red_rate_transition3_output__out = _microturbine1_be1_25a_synchronizer_magnitude_mathematical_function1__out;
    ...
    HIL_OutFloat(162267136, (float) _microturbine1_exciter_red_gain18__out);
    // Generated from the component: Microturbine1.Exciter_red.PI.Kb
    _microturbine1_exciter_red_pi_kb__out = 1.0 * _microturbine1_exciter_red_pi_sum6__out;
    ...
    HIL_OutAO(0x4013, (float)_microturbine1_be1_25a_synchronizer_confine_phase__out);
    // Generated from the component: Microturbine1.BE1-25A Synchronizer.|E|
    HIL_OutAO(0x401e, (float)_microturbine1_be1_25a_synchronizer_gain18__out);
    ...
    HIL_OutAO(0x401b, (float)_microturbine1_be1_25a_synchronizer_sum3__out);
    ...
    HIL_OutAO(0x4033, (float)_microturbine1_gain17__out);
    ...
    // Generated from the component: Microturbine1.Exciter_red.PI.Sum7
    _microturbine1_exciter_red_pi_sum7__out = _microturbine1_exciter_red_pi_ki__out + _microturbine1_exciter_red_pi_kb__out;
    ...
    _microturbine1_be1_25a_synchronizer_hold_after_connect1__exc_state = _microturbine1_governor_rate_transition4_output__out;
    ...
    HIL_OutAO(0x4015, (float)_microturbine1_be1_25a_synchronizer_hold_after_connect__out);
    ...
    HIL_OutAO(0x4014, (float)_microturbine1_be1_25a_synchronizer_hold_after_connect1__out);
    ...
    _microturbine1_governor_rate_transition2_output__out = _microturbine1_w__out;
    // Generated from the component: Microturbine1.Exciter_red.Rate Transition4.Input
    _microturbine1_exciter_red_rate_transition4_output__out = _microturbine1__v_3__out;
    //@cmp.out.block.end
    //////////////////////////////////////////////////////////////////////////
    // Update block
    //////////////////////////////////////////////////////////////////////////
    ...
    // Generated from the component: Microturbine1.Governor.Integrator13
    _microturbine1_governor_integrator13__state += _microturbine1_governor_gain38__out * 0.001;
    // Generated from the component: DIESEL_MCB.RMS value1
    ...
    // Generated from the component: Microturbine1.BE1-25A Synchronizer.abc to qd1.confine phase
    // Generated from the component: Microturbine1.Exciter_red.Integrator4
    _microturbine1_exciter_red_integrator4__state += _microturbine1_exciter_red_gain9__out * 0.001;
    if (_microturbine1_exciter_red_rate_transition1_output__out > 0)
        _microturbine1_exciter_red_integrator4__reset_state = 1;
    else if (_microturbine1_exciter_red_rate_transition1_output__out < 0)
        _microturbine1_exciter_red_integrator4__reset_state = -1;
    else
        _microturbine1_exciter_red_integrator4__reset_state = 0;
    // Generated from the component: Microturbine1.Exciter_red.PI.Integrator1
    _microturbine1_exciter_red_pi_integrator1__state += _microturbine1_exciter_red_pi_sum7__out * 0.001;
    if (_microturbine1_exciter_red_rate_transition1_output__out > 0)
        _microturbine1_exciter_red_pi_integrator1__reset_state = 1;
    else if (_microturbine1_exciter_red_rate_transition1_output__out < 0)
        _microturbine1_exciter_red_pi_integrator1__reset_state = -1;
    else
        _microturbine1_exciter_red_pi_integrator1__reset_state = 0;
    // Generated from the component: F1_Motor.Chiller_compressor.C function1
    // Generated from the component: F1_PCC.PCC Measurements.RMS value1
    ...
    // Generated from the component: Microturbine1.Governor.Rate Limiter3
    _microturbine1_governor_rate_limiter3__prev_out = _microturbine1_governor_rate_limiter3__out;
    _microturbine1_governor_rate_limiter3__first_step = 0;
    // Generated from the component: F1_PCC.PCC Measurements.Comparator1
    if (_f1_pcc_pcc_measurements_power_meter1__Pdc < _f1_pcc_pcc_measurements_constant1__out) {
    ...
    // Generated from the component: Microturbine1.Exciter_red.Rate Limit1
    _microturbine1_exciter_red_rate_limit1__prev_out = _microturbine1_exciter_red_rate_limit1__out;
    _microturbine1_exciter_red_rate_limit1__first_step = 0;
    // Generated from the component: Microturbine1.Governor.Exciter Activation.Comparator1
    if (_microturbine1_governor_exciter_activation_constant1__out < _microturbine1_governor_exciter_activation_abs1__out) {
