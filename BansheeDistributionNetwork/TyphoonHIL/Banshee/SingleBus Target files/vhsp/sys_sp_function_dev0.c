...
void TimerCounterHandler_0_sys_sp_cpu_dev0() {
    ...
    _vrms_bus101_vinst_va1__out = (HIL_InFloat(0xc80000 + 0x218));
    ...
    _vrms_grid_vinst_va1__out = (HIL_InFloat(0xc80000 + 0x219));
...
void TimerCounterHandler_1_sys_sp_cpu_dev0() {
    ...
    HIL_OutAO(0x4001, _vrms_bus103_rms_calc_slow__var_rms);
