...
void TimerCounterHandler_0_sys_sp_cpu0_dev1() {
    ...
    _vrms_bus201_vinst_va1__out = (HIL_InFloat(0xc80000 + 0x217));
    ...
    _vrms_bus208_vinst_va1__out = (HIL_InFloat(0xc80000 + 0x218));
    // Generated from the component: Vrms_bus209.Vinst.Va1
    _vrms_bus209_vinst_va1__out = (HIL_InFloat(0xc80000 + 0x219));
