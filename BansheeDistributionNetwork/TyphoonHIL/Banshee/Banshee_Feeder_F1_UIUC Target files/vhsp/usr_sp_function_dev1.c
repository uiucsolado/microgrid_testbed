...
void ReInit_sp_scope_user_sp_cpu_dev1() {
    // initialise SP Scope buffer pointer
}

void init_fmu_objects_dev1(void) {
    return;
}


void terminate_fmu_objects_dev1(void) {
    return;
}
...
void TimerCounterHandler_0_user_sp_cpu_dev1() {
#if DEBUG_MODE
