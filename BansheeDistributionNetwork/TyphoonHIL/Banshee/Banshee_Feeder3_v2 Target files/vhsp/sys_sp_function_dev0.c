...
void TimerCounterHandler_0_sys_sp_cpu_dev0() {
    ...
    _vrms_bus301_vinst_va1__out = (HIL_InFloat(0xc80000 + 0x8));
    // Generated from the component: Vrms_bus302.Vinst.Va1
    _vrms_bus302_vinst_va1__out = (HIL_InFloat(0xc80000 + 0x22c));
    // Generated from the component: Vrms_bus303.Vinst.Va1
    _vrms_bus303_vinst_va1__out = (HIL_InFloat(0xc80000 + 0x22d));
    // Generated from the component: Vrms_bus304.Vinst.Va1
    _vrms_bus304_vinst_va1__out = (HIL_InFloat(0xc80000 + 0x22e));
    ...
    _vrms_grid_vinst_va1__out = (HIL_InFloat(0xc80000 + 0x9));
