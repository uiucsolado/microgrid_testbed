...
OLocalVertex s = OLocalVertex(0x4151C692,0,0.679*D_base,-1.5*base,0.5*base,5,D_base,3);
//OLocalVertex s = OLocalVertex(0x4151C692,0,0,-1.5*base,0.5*base,5,D_base);
OGraph g = OGraph(&s);
  ...
  if(de == false) {
   Serial.println("Still trying to sync");
    ...
    if(a.isSynced()) {
      ...
      //a.nonleaderFairSplitRatioConsensus(D_base,2);
